...
module RebillySdk
  class CustomFieldsApi
    ...
    # @return [CustomField]
    def get_custom_field(resource, name, opts = {})
      data, _status_code, _headers = get_custom_field_with_http_info(resource, name, opts)
      data
    end
    ...
    def get_custom_field_with_http_info(resource, name, opts = {})
      ...
      if @api_client.config.client_side_validation && resource.nil?
        fail ArgumentError, "Missing the required parameter 'resource' when calling CustomFieldsApi.get_custom_field"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['customers', 'payment-instruments', 'subscriptions', 'transactions', 'websites', 'products', 'plans', 'bump-offers'].include?(resource)
        fail ArgumentError, "invalid value for 'resource', must be one of customers, payment-instruments, subscriptions, transactions, websites, products, plans, bump-offers"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling CustomFieldsApi.get_custom_field"
      end
      # resource path
      local_var_path = '/custom-fields/{resource}/{name}'.sub('{' + 'resource' + '}', resource.to_s).sub('{' + 'name' + '}', name.to_s)
      ...
      return_type = opts[:return_type] || 'CustomField' 
    ...
    def get_custom_field_collection(resource, opts = {})
      data, _status_code, _headers = get_custom_field_collection_with_http_info(resource, opts)
      data
    end
    ...
    def get_custom_field_collection_with_http_info(resource, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsApi.get_custom_field_collection ...'
      end
      # verify the required parameter 'resource' is set
      if @api_client.config.client_side_validation && resource.nil?
        fail ArgumentError, "Missing the required parameter 'resource' when calling CustomFieldsApi.get_custom_field_collection"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['customers', 'payment-instruments', 'subscriptions', 'transactions', 'websites', 'products', 'plans', 'bump-offers'].include?(resource)
        fail ArgumentError, "invalid value for 'resource', must be one of customers, payment-instruments, subscriptions, transactions, websites, products, plans, bump-offers"
      ...
      # resource path
      local_var_path = '/custom-fields/{resource}'.sub('{' + 'resource' + '}', resource.to_s)
      ...
      return_type = opts[:return_type] || 'Array<CustomField>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsApi#get_custom_field_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [CustomField]
    def put_custom_field(body, resource, name, opts = {})
      data, _status_code, _headers = put_custom_field_with_http_info(body, resource, name, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(CustomField, Integer, Hash)>] CustomField data, response status code and response headers
    def put_custom_field_with_http_info(body, resource, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsApi.put_custom_field ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CustomFieldsApi.put_custom_field"
      end
      # verify the required parameter 'resource' is set
      if @api_client.config.client_side_validation && resource.nil?
        fail ArgumentError, "Missing the required parameter 'resource' when calling CustomFieldsApi.put_custom_field"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['customers', 'payment-instruments', 'subscriptions', 'transactions', 'websites', 'products', 'plans', 'bump-offers'].include?(resource)
        fail ArgumentError, "invalid value for 'resource', must be one of customers, payment-instruments, subscriptions, transactions, websites, products, plans, bump-offers"
      ...
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling CustomFieldsApi.put_custom_field"
      end
      # resource path
      local_var_path = '/custom-fields/{resource}/{name}'.sub('{' + 'resource' + '}', resource.to_s).sub('{' + 'name' + '}', name.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsApi#put_custom_field\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
