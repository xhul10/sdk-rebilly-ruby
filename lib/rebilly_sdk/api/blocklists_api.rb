...
module RebillySdk
  class BlocklistsApi
    ...
    # @return [nil]
    def delete_blocklist(id, opts = {})
      delete_blocklist_with_http_info(id, opts)
      nil
    end
    ...
    def delete_blocklist_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BlocklistsApi.delete_blocklist ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BlocklistsApi.delete_blocklist"
      end
      # resource path
      local_var_path = '/blocklists/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BlocklistsApi#delete_blocklist\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Blocklist]
    def get_blocklist(id, opts = {})
      data, _status_code, _headers = get_blocklist_with_http_info(id, opts)
      data
    end
    ...
    def get_blocklist_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BlocklistsApi.get_blocklist ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BlocklistsApi.get_blocklist"
      end
      # resource path
      local_var_path = '/blocklists/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      return_type = opts[:return_type] || 'Blocklist' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BlocklistsApi#get_blocklist\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_blocklist_collection(opts = {})
      data, _status_code, _headers = get_blocklist_collection_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :filter The collection items filter requires a special format. Use \&quot;,\&quot; for multiple allowed values.  Use \&quot;;\&quot; for multiple fields. See the [filter guide](https://api-reference.rebilly.com/#section/Using-filter-with-collections) for more options and examples about this format. 
    # @option opts [String] :q The partial search of the text fields.
    # @return [Array<(Array<Blocklist>, Integer, Hash)>] Array<Blocklist> data, response status code and response headers
    def get_blocklist_collection_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BlocklistsApi.get_blocklist_collection ...'
      end
      # resource path
      local_var_path = '/blocklists'
      ...
      return_type = opts[:return_type] || 'Array<Blocklist>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BlocklistsApi#get_blocklist_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a blocklist
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Blocklist]
    def post_blocklist(body, opts = {})
      data, _status_code, _headers = post_blocklist_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(Blocklist, Integer, Hash)>] Blocklist data, response status code and response headers
    def post_blocklist_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BlocklistsApi.post_blocklist ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling BlocklistsApi.post_blocklist"
      end
      # resource path
      local_var_path = '/blocklists'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BlocklistsApi#post_blocklist\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Blocklist]
    def put_blocklist(body, id, opts = {})
      data, _status_code, _headers = put_blocklist_with_http_info(body, id, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(Blocklist, Integer, Hash)>] Blocklist data, response status code and response headers
    def put_blocklist_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BlocklistsApi.put_blocklist ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling BlocklistsApi.put_blocklist"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BlocklistsApi.put_blocklist"
      end
      # resource path
      local_var_path = '/blocklists/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BlocklistsApi#put_blocklist\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
