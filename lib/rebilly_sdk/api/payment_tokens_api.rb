...
module RebillySdk
  class PaymentTokensApi
    ...
    def get_token(token, opts = {})
      data, _status_code, _headers = get_token_with_http_info(token, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(CompositeToken, Integer, Hash)>] CompositeToken data, response status code and response headers
    def get_token_with_http_info(token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentTokensApi.get_token ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling PaymentTokensApi.get_token"
      end
      # resource path
      local_var_path = '/tokens/{token}'.sub('{' + 'token' + '}', token.to_s)
      ...
      return_type = opts[:return_type] || 'CompositeToken' 

      auth_names = opts[:auth_names] || ['PublishableApiKey']
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentTokensApi#get_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<CompositeToken>]
    def get_token_collection(opts = {})
      data, _status_code, _headers = get_token_collection_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :limit The collection items limit.
    # @option opts [Integer] :offset The collection items offset.
    # @return [Array<(Array<CompositeToken>, Integer, Hash)>] Array<CompositeToken> data, response status code and response headers
    def get_token_collection_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentTokensApi.get_token_collection ...'
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'Array<CompositeToken>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentTokensApi#get_token_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_digital_wallet_validation(body, opts = {})
      data, _status_code, _headers = post_digital_wallet_validation_with_http_info(body, opts)
      data
    end
    ...
    # @param body Digital wallet validation request.
    # @param [Hash] opts the optional parameters
    # @return [Array<(DigitalWalletValidation, Integer, Hash)>] DigitalWalletValidation data, response status code and response headers
    def post_digital_wallet_validation_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentTokensApi.post_digital_wallet_validation ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PaymentTokensApi.post_digital_wallet_validation"
      end
      # resource path
      local_var_path = '/digital-wallets/validation'
      ...
      return_type = opts[:return_type] || 'DigitalWalletValidation' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentTokensApi#post_digital_wallet_validation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [CompositeToken]
    def post_token(body, opts = {})
      data, _status_code, _headers = post_token_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(CompositeToken, Integer, Hash)>] CompositeToken data, response status code and response headers
    def post_token_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentTokensApi.post_token ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PaymentTokensApi.post_token"
      end
      # resource path
      local_var_path = '/tokens'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentTokensApi#post_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
