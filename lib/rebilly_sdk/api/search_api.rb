...
module RebillySdk
  class SearchApi
    ...
    # @option opts [String] :q The default search. It will search across resources and many fields.
    # @return [Array<Search>]
    def get_search(opts = {})
    ...
    # @option opts [Integer] :offset The collection items offset.
    # @option opts [String] :q The default search. It will search across resources and many fields.
    # @return [Array<(Array<Search>, Integer, Hash)>] Array<Search> data, response status code and response headers
    def get_search_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Array<Search>' 
