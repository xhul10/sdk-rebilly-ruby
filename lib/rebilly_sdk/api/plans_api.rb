...
module RebillySdk
  class PlansApi
    ...
    def delete_plan(id, opts = {})
      delete_plan_with_http_info(id, opts)
      nil
    end
    ...
    def get_plan_with_http_info(id, opts = {})
      ...
      return_type = opts[:return_type] || 'Plan' 
    ...
    # @return [Array<Plan>]
    def get_plan_collection(opts = {})
      data, _status_code, _headers = get_plan_collection_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :offset The collection items offset.
    # @option opts [String] :q The partial search of the text fields.
    # @return [Array<(Array<Plan>, Integer, Hash)>] Array<Plan> data, response status code and response headers
    def get_plan_collection_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlansApi.get_plan_collection ...'
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'Array<Plan>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlansApi#get_plan_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a plan
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Plan]
    def post_plan(body, opts = {})
      data, _status_code, _headers = post_plan_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(Plan, Integer, Hash)>] Plan data, response status code and response headers
    def post_plan_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlansApi.post_plan ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PlansApi.post_plan"
      end
      # resource path
      local_var_path = '/plans'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlansApi#post_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Plan]
    def put_plan(body, id, opts = {})
      data, _status_code, _headers = put_plan_with_http_info(body, id, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(Plan, Integer, Hash)>] Plan data, response status code and response headers
    def put_plan_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PlansApi.put_plan ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PlansApi.put_plan"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PlansApi.put_plan"
      end
      # resource path
      local_var_path = '/plans/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlansApi#put_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
