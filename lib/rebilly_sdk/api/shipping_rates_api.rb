...
module RebillySdk
  class ShippingRatesApi
    ...
    # @return [nil]
    def delete_shipping_rate(id, opts = {})
      delete_shipping_rate_with_http_info(id, opts)
      nil
    end
    ...
    def delete_shipping_rate_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ShippingRatesApi.delete_shipping_rate ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ShippingRatesApi.delete_shipping_rate"
      end
      # resource path
      local_var_path = '/shipping-rates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ShippingRatesApi#delete_shipping_rate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [ShippingRate]
    def get_shipping_rate(id, opts = {})
      data, _status_code, _headers = get_shipping_rate_with_http_info(id, opts)
      data
    end
    ...
    def get_shipping_rate_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ShippingRatesApi.get_shipping_rate ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ShippingRatesApi.get_shipping_rate"
      end
      # resource path
      local_var_path = '/shipping-rates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      return_type = opts[:return_type] || 'ShippingRate' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ShippingRatesApi#get_shipping_rate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_shipping_rate_collection(opts = {})
      data, _status_code, _headers = get_shipping_rate_collection_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :sort The collection items sort field and order (prefix with \&quot;-\&quot; for descending sort).
    # @option opts [String] :q The partial search of the text fields.
    # @return [Array<(Array<ShippingRate>, Integer, Hash)>] Array<ShippingRate> data, response status code and response headers
    def get_shipping_rate_collection_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ShippingRatesApi.get_shipping_rate_collection ...'
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'Array<ShippingRate>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ShippingRatesApi#get_shipping_rate_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a shipping rate
    # Create a shipping rate. 
    # @param body Shipping rate resource.
    # @param [Hash] opts the optional parameters
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [ShippingRate]
    def post_shipping_rate(body, opts = {})
      data, _status_code, _headers = post_shipping_rate_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(ShippingRate, Integer, Hash)>] ShippingRate data, response status code and response headers
    def post_shipping_rate_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ShippingRatesApi.post_shipping_rate ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ShippingRatesApi.post_shipping_rate"
      end
      # resource path
      local_var_path = '/shipping-rates'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ShippingRatesApi#post_shipping_rate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [ShippingRate]
    def put_shipping_rate(body, id, opts = {})
      data, _status_code, _headers = put_shipping_rate_with_http_info(body, id, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(ShippingRate, Integer, Hash)>] ShippingRate data, response status code and response headers
    def put_shipping_rate_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ShippingRatesApi.put_shipping_rate ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ShippingRatesApi.put_shipping_rate"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ShippingRatesApi.put_shipping_rate"
      end
      # resource path
      local_var_path = '/shipping-rates/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ShippingRatesApi#put_shipping_rate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
