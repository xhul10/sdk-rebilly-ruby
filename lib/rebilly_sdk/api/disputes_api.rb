...
module RebillySdk
  class DisputesApi
    ...
    # @return [Dispute]
    def get_dispute(id, opts = {})
      data, _status_code, _headers = get_dispute_with_http_info(id, opts)
      data
    end
    ...
    def get_dispute_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DisputesApi.get_dispute ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DisputesApi.get_dispute"
      end
      # resource path
      local_var_path = '/disputes/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      return_type = opts[:return_type] || 'Dispute' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DisputesApi#get_dispute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_dispute_collection(opts = {})
      data, _status_code, _headers = get_dispute_collection_with_http_info(opts)
      data
    end
    ...
    def get_dispute_collection_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DisputesApi.get_dispute_collection ...'
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'Array<Dispute>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DisputesApi#get_dispute_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a dispute
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Dispute]
    def post_dispute(body, opts = {})
      data, _status_code, _headers = post_dispute_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(Dispute, Integer, Hash)>] Dispute data, response status code and response headers
    def post_dispute_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DisputesApi.post_dispute ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DisputesApi.post_dispute"
      end
      # resource path
      local_var_path = '/disputes'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DisputesApi#post_dispute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Dispute]
    def put_dispute(body, id, opts = {})
      data, _status_code, _headers = put_dispute_with_http_info(body, id, opts)
      data
    end
    ...
    # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
    # @return [Array<(Dispute, Integer, Hash)>] Dispute data, response status code and response headers
    def put_dispute_with_http_info(body, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DisputesApi.put_dispute ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DisputesApi.put_dispute"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DisputesApi.put_dispute"
      end
      # resource path
      local_var_path = '/disputes/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DisputesApi#put_dispute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
