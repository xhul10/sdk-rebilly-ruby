...
module RebillySdk
  ...
  class AllOfCommonPlanRecurringInterval
    # The unit of time.
    attr_accessor :unit
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::AllOfCommonPlanRecurringInterval` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::AllOfCommonPlanRecurringInterval`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'billing_timing')
        self.billing_timing = attributes[:'billing_timing']
      end
    end
    ...
    def valid?
      ...
      unit_validator = EnumAttributeValidator.new('', ['day', 'week', 'month', 'year'])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('', ['day', 'week', 'month', 'year'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          length == o.length &&
          limit == o.limit &&
          billing_timing == o.billing_timing && super(o)
    end
    ...
    def hash
      [unit, length, limit, billing_timing].hash
    end
