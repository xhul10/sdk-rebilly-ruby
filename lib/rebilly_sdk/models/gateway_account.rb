  ...
  class GatewayAccount
    ...
    def self.openapi_types
      {
        ...
        :'method' => :'Object',
        :'accepted_currencies' => :'Object',
        :'payment_card_schemes' => :'Object',
        :'status' => :'Object',
        :'merchant_category_code' => :'Object',
        :'dcc_markup' => :'Object',
        :'dcc_force_currency' => :'Object',
        :'descriptor' => :'Object',
        :'city_field' => :'Object',
        :'excluded_dcc_quote_currencies' => :'Object',
        :'monthly_limit' => :'Object',
        :'approval_window_ttl' => :'Object',
        :'reconciliation_window_enabled' => :'Object',
        :'reconciliation_window_ttl' => :'Object',
        :'three_d_secure' => :'Object',
        :'dynamic_descriptor' => :'Object',
        :'digital_wallets' => :'Object',
        :'is_down' => :'Object',
        :'additional_filters' => :'Object',
        :'timeout' => :'Object',
        :'token' => :'Object',
        :'sticky' => :'Object',
        :'setup_instruction' => :'Object',
        :'created_time' => :'Object',
        :'updated_time' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::GatewayAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::GatewayAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('Object', ['active', 'inactive', 'pending', 'closed'])
      return false unless status_validator.valid?(@status)
      setup_instruction_validator = EnumAttributeValidator.new('Object', ['authorize', 'authorize-and-void', 'sca', 'do-nothing'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['active', 'inactive', 'pending', 'closed'])
    ...
    def setup_instruction=(setup_instruction)
      validator = EnumAttributeValidator.new('Object', ['authorize', 'authorize-and-void', 'sca', 'do-nothing'])
