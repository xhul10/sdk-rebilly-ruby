...
module RebillySdk
  ...
  class BlueSnapCredentials
    ...
    # BlueSnap merchant's data protection key.
    attr_accessor :data_protection_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::BlueSnapCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::BlueSnapCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_protection_key')
        self.data_protection_key = attributes[:'data_protection_key']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          username == o.username &&
          password == o.password &&
          data_protection_key == o.data_protection_key
    end
    ...
    def hash
      [username, password, data_protection_key].hash
    end
