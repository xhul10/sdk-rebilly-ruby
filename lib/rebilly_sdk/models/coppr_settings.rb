...
module RebillySdk
  ...
  class CopprSettings
    ...
    attr_accessor :rebilly_publishable_key
    ...
    def self.openapi_types
      {
        :'rebilly_publishable_key' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CopprSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CopprSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'rebilly_publishable_key')
        self.rebilly_publishable_key = attributes[:'rebilly_publishable_key']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rebilly_publishable_key == o.rebilly_publishable_key
    end
