  ...
  class Pay4FunCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::Pay4FunCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::Pay4FunCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_secret')
        self.merchant_secret = attributes[:'merchant_secret']
      end
    ...
    def list_invalid_properties
      ...
      if @merchant_secret.nil?
        invalid_properties.push('invalid value for "merchant_secret", merchant_secret cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_secret.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          merchant_secret == o.merchant_secret &&
    ...
    def hash
      [merchant_id, merchant_secret, merchant_key].hash
    end
