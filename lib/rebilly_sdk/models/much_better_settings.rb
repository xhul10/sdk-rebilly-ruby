...
module RebillySdk
  ...
  class MuchBetterSettings
    ...
    def self.openapi_types
      {
        :'brand_name' => :'Object',
        :'has_phone_number_request' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::MuchBetterSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::MuchBetterSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'has_phone_number_request')
        self.has_phone_number_request = attributes[:'has_phone_number_request']
      else
        self.has_phone_number_request = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_phone_number_request == o.has_phone_number_request
    end
    ...
    def hash
      [brand_name, has_phone_number_request].hash
    end
