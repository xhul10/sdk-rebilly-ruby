...
module RebillySdk
  class AddressMatches
    ...
    attr_accessor :word_count_result
    ...
    attr_accessor :unique_words_result
    ...
    def self.openapi_types
      {
        ...
        :'postal_code' => :'Object',
        :'word_count' => :'Object',
        :'word_count_result' => :'Object',
        :'unique_words' => :'Object',
        :'unique_words_result' => :'Object',
        :'date' => :'Object',
        :'phone' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::AddressMatches` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::AddressMatches`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'word_count_result')
        self.word_count_result = attributes[:'word_count_result']
      end

      if attributes.key?(:'unique_words')
        self.unique_words = attributes[:'unique_words']
      end

      if attributes.key?(:'unique_words_result')
        self.unique_words_result = attributes[:'unique_words_result']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          word_count_result == o.word_count_result &&
          unique_words == o.unique_words &&
          unique_words_result == o.unique_words_result &&
          date == o.date &&
          phone == o.phone
    end
    ...
    def hash
      [first_name, last_name, line1, city, region, postal_code, word_count, word_count_result, unique_words, unique_words_result, date, phone].hash
    end
