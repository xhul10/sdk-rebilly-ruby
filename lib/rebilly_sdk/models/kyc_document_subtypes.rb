...
module RebillySdk
  class KycDocumentSubtypes
    PASSPORT = 'passport'.freeze
    ID_CARD = 'id-card'.freeze
    DRIVER_LICENSE = 'driver-license'.freeze
    BIRTH_CERTIFICATE = 'birth-certificate'.freeze
    UTILITY_BILL = 'utility-bill'.freeze
    RENTAL_RECEIPT = 'rental-receipt'.freeze
    LEASE_AGREEMENT = 'lease-agreement'.freeze
    COPY_CREDIT_CARD = 'copy-credit-card'.freeze
    CREDIT_CARD_STATEMENT = 'credit-card-statement'.freeze
    BANK_STATEMENT = 'bank-statement'.freeze
    INHERITANCE_DOCUMENTATION = 'inheritance-documentation'.freeze
    TAX_RETURN = 'tax-return'.freeze
    SALARY_SLIP = 'salary-slip'.freeze
    SALE_OF_ASSETS = 'sale-of-assets'.freeze
    PUBLIC_HEALTH_CARD = 'public-health-card'.freeze
    PROOF_OF_AGE_CARD = 'proof-of-age-card'.freeze
    REVERSE_OF_ID = 'reverse-of-id'.freeze
    PUBLIC_SERVICE = 'public-service'.freeze
    EWALLET_HOLDER_DETAILS = 'ewallet-holder-details'.freeze
    EWALLET_TRANSACTION_STATEMENT = 'ewallet-transaction-statement'.freeze
    OTHER = 'other'.freeze
    ...
    def build_from_hash(value)
      constantValues = KycDocumentSubtypes.constants.select { |c| KycDocumentSubtypes::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #KycDocumentSubtypes" if constantValues.empty?
      value
    end
  end
end
