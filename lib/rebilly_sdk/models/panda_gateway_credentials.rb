  ...
  class PandaGatewayCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PandaGatewayCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PandaGatewayCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'api_code')
        self.api_code = attributes[:'api_code']
      end

      if attributes.key?(:'sign_key')
        self.sign_key = attributes[:'sign_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @api_code.nil?
        invalid_properties.push('invalid value for "api_code", api_code cannot be nil.')
      end

      if @sign_key.nil?
        invalid_properties.push('invalid value for "sign_key", sign_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @api_code.nil?
      return false if @sign_key.nil?
      true
    end
    ...
    def hash
      [merchant_code, api_code, sign_key].hash
    end
