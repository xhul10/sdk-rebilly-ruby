...
module RebillySdk
  ...
  class TWINTSettings
    ...
    attr_accessor :cash_register_type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::TWINTSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::TWINTSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'cash_register_type')
        self.cash_register_type = attributes[:'cash_register_type']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cash_register_type.nil?
        invalid_properties.push('invalid value for "cash_register_type", cash_register_type cannot be nil.')
      end
    ...
    def valid?
      return false if @cash_register_type.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cash_register_type == o.cash_register_type
    end
