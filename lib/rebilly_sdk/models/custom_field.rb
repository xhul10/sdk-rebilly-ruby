...
module RebillySdk
  ...
  class CustomField
    ...
    attr_accessor :additional_schema
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CustomField` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CustomField`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'additional_schema')
        self.additional_schema = attributes[:'additional_schema']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('Object', ['array', 'boolean', 'datetime', 'integer', 'number', 'string', 'monetary'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ['array', 'boolean', 'datetime', 'integer', 'number', 'string', 'monetary'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          additional_schema == o.additional_schema &&
          _links == o._links
    end
    ...
    def hash
      [name, type, description, additional_schema, _links].hash
    end
