  ...
  class SubscriptionReactivation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::SubscriptionReactivation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::SubscriptionReactivation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cancellation_id')
        self.cancellation_id = attributes[:'cancellation_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cancellation_id == o.cancellation_id &&
    ...
    def hash
      [id, subscription_id, cancellation_id, description, effective_time, renewal_time, created_time, _links].hash
    end
