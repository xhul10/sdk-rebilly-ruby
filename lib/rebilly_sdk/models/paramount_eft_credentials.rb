...
module RebillySdk
  ...
  class ParamountEftCredentials
    # Merchant account ID.
    attr_accessor :merchant_id

    # Merchant account password.
    attr_accessor :merchant_pass
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ParamountEftCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ParamountEftCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_pass')
        self.merchant_pass = attributes[:'merchant_pass']
      end
    ...
    def list_invalid_properties
      ...
      if @merchant_pass.nil?
        invalid_properties.push('invalid value for "merchant_pass", merchant_pass cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_pass.nil?
    ...
    def hash
      [merchant_id, merchant_pass, payee].hash
    end
