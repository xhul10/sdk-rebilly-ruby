...
module RebillySdk
  ...
  class UPayCardSettings
    attr_accessor :tolerance_percentage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::UPayCardSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::UPayCardSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'tolerance_percentage')
        self.tolerance_percentage = attributes[:'tolerance_percentage']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tolerance_percentage.nil?
        invalid_properties.push('invalid value for "tolerance_percentage", tolerance_percentage cannot be nil.')
      end
    ...
    def valid?
      return false if @tolerance_percentage.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tolerance_percentage == o.tolerance_percentage
    end
