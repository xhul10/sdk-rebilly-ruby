  ...
  class Directa24Credentials
    ...
    def self.openapi_types
      {
        ...
        :'x_tran_key' => :'Object',
        :'secret_key' => :'Object',
        :'web_pay_login' => :'Object',
        :'web_pay_tran_key' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::Directa24Credentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::Directa24Credentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'x_tran_key')
        self.x_tran_key = attributes[:'x_tran_key']
      end
      ...
      if attributes.key?(:'web_pay_login')
        self.web_pay_login = attributes[:'web_pay_login']
      end

      if attributes.key?(:'web_pay_tran_key')
        self.web_pay_tran_key = attributes[:'web_pay_tran_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @x_tran_key.nil?
        invalid_properties.push('invalid value for "x_tran_key", x_tran_key cannot be nil.')
      end
      ...
      if @web_pay_login.nil?
        invalid_properties.push('invalid value for "web_pay_login", web_pay_login cannot be nil.')
      end

      if @web_pay_tran_key.nil?
        invalid_properties.push('invalid value for "web_pay_tran_key", web_pay_tran_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @x_tran_key.nil?
      return false if @secret_key.nil?
      return false if @web_pay_login.nil?
      return false if @web_pay_tran_key.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          x_login == o.x_login &&
          x_tran_key == o.x_tran_key &&
          secret_key == o.secret_key &&
          web_pay_login == o.web_pay_login &&
          web_pay_tran_key == o.web_pay_tran_key
    end
    ...
    def hash
      [x_login, x_tran_key, secret_key, web_pay_login, web_pay_tran_key].hash
    end
