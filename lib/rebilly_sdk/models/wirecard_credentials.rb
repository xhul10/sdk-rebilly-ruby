...
module RebillySdk
  class WirecardCredentials
    ...
    attr_accessor :business_signature

    # Wirecard Gateway delay.
    attr_accessor :delay

    # Wirecard sftp username.
    attr_accessor :sftp_username
    ...
    def self.openapi_types
      {
        ...
        :'business_signature' => :'Object',
        :'delay' => :'Object',
        :'sftp_username' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::WirecardCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::WirecardCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'business_signature')
        self.business_signature = attributes[:'business_signature']
      end
      ...
      if attributes.key?(:'sftp_username')
        self.sftp_username = attributes[:'sftp_username']
      end

      if attributes.key?(:'sftp_private_key')
        self.sftp_private_key = attributes[:'sftp_private_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @business_signature.nil?
        invalid_properties.push('invalid value for "business_signature", business_signature cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @business_signature.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          business_signature == o.business_signature &&
          delay == o.delay &&
          sftp_username == o.sftp_username &&
          sftp_private_key == o.sftp_private_key
    end
    ...
    def hash
      [merchant_username, merchant_password, business_signature, delay, sftp_username, sftp_private_key].hash
    end
