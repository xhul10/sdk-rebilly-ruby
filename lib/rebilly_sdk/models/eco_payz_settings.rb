...
module RebillySdk
  ...
  class EcoPayzSettings
    # Three letter currency code.
    attr_accessor :valid_currency
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::EcoPayzSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::EcoPayzSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'valid_currency')
        self.valid_currency = attributes[:'valid_currency']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @valid_currency.nil?
        invalid_properties.push('invalid value for "valid_currency", valid_currency cannot be nil.')
      end
    ...
    def valid?
      return false if @valid_currency.nil?
      valid_currency_validator = EnumAttributeValidator.new('Object', ['CAD', 'EUR', 'GBP', 'USD'])
      return false unless valid_currency_validator.valid?(@valid_currency)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] valid_currency Object to be assigned
    def valid_currency=(valid_currency)
      validator = EnumAttributeValidator.new('Object', ['CAD', 'EUR', 'GBP', 'USD'])
      unless validator.valid?(valid_currency)
        fail ArgumentError, "invalid value for \"valid_currency\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          valid_currency == o.valid_currency
    end
