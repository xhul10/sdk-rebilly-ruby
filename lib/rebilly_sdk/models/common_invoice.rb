  ...
  class CommonInvoice
    ...
    def self.openapi_types
      {
        ...
        :'items' => :'Object',
        :'discounts' => :'Object',
        :'autopay_scheduled_time' => :'Object',
        :'autopay_retry_number' => :'Object',
        :'status' => :'Object',
        :'delinquent_collection_period' => :'Object',
        :'collection_period' => :'Object',
        :'abandoned_time' => :'Object',
        :'voided_time' => :'Object',
        :'paid_time' => :'Object',
        :'due_time' => :'Object',
        :'issued_time' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CommonInvoice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CommonInvoice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('Object', ['draft', 'unpaid', 'paid', 'past-due', 'delinquent', 'abandoned', 'voided', 'partially-refunded', 'refunded', 'disputed'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['draft', 'unpaid', 'paid', 'past-due', 'delinquent', 'abandoned', 'voided', 'partially-refunded', 'refunded', 'disputed'])
