...
module RebillySdk
  class Customer
    ...
    attr_accessor :lifetime_revenue
    ...
    def self.openapi_types
      {
        ...
        :'default_payment_instrument' => :'Object',
        :'created_time' => :'Object',
        :'updated_time' => :'Object',
        ...
        :'last_payment_time' => :'Object',
        :'lifetime_revenue' => :'Object',
        :'invoice_count' => :'Object',
        :'tags' => :'Object',
        :'revision' => :'Object',
        :'_links' => :'Object',
        :'_embedded' => :'Object'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::Customer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::Customer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_payment_instrument')
        self.default_payment_instrument = attributes[:'default_payment_instrument']
      end
      ...
      if attributes.key?(:'last_payment_time')
        self.last_payment_time = attributes[:'last_payment_time']
      end

      if attributes.key?(:'lifetime_revenue')
        self.lifetime_revenue = attributes[:'lifetime_revenue']
      end

      if attributes.key?(:'invoice_count')
        self.invoice_count = attributes[:'invoice_count']
      end
    ...
    def hash
      [id, email, first_name, last_name, website_id, payment_token, default_payment_instrument, created_time, updated_time, custom_fields, primary_address, average_value, payment_count, last_payment_time, lifetime_revenue, invoice_count, tags, revision, _links, _embedded].hash
    end
