  ...
  class DataCashCredentials
    ...
    def self.openapi_types
      {
        ...
        :'report_group' => :'Object',
        :'report_user' => :'Object',
        :'report_password' => :'Object',
        :'visa_payouts_client' => :'Object',
        :'visa_payouts_password' => :'Object',
        :'master_card_payouts_client' => :'Object',
        :'master_card_payouts_password' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::DataCashCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::DataCashCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'report_group')
        self.report_group = attributes[:'report_group']
      end

      if attributes.key?(:'report_user')
        self.report_user = attributes[:'report_user']
      end

      if attributes.key?(:'report_password')
        self.report_password = attributes[:'report_password']
      end

      if attributes.key?(:'visa_payouts_client')
        self.visa_payouts_client = attributes[:'visa_payouts_client']
      end

      if attributes.key?(:'visa_payouts_password')
        self.visa_payouts_password = attributes[:'visa_payouts_password']
      end

      if attributes.key?(:'master_card_payouts_client')
        self.master_card_payouts_client = attributes[:'master_card_payouts_client']
      end

      if attributes.key?(:'master_card_payouts_password')
        self.master_card_payouts_password = attributes[:'master_card_payouts_password']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          report_user == o.report_user &&
          report_password == o.report_password &&
          visa_payouts_client == o.visa_payouts_client &&
          visa_payouts_password == o.visa_payouts_password &&
          master_card_payouts_client == o.master_card_payouts_client &&
          master_card_payouts_password == o.master_card_payouts_password
    end
    ...
    def hash
      [client, password, report_group, report_user, report_password, visa_payouts_client, visa_payouts_password, master_card_payouts_client, master_card_payouts_password].hash
    end
