  ...
  class GatewayAccountLimit
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::GatewayAccountLimit` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::GatewayAccountLimit`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @cap.nil?
        invalid_properties.push('invalid value for "cap", cap cannot be nil.')
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('Object', ['monitoring', 'reached'])
      return false unless status_validator.valid?(@status)
      frequency_validator = EnumAttributeValidator.new('Object', ['daily', 'monthly'])
      return false unless frequency_validator.valid?(@frequency)
      type_validator = EnumAttributeValidator.new('Object', ['count', 'money'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['monitoring', 'reached'])
    ...
    def frequency=(frequency)
      validator = EnumAttributeValidator.new('Object', ['daily', 'monthly'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ['count', 'money'])
    ...
    def hash
      [id, status, start_time, end_time, frequency, type, cap, usage, created_time, updated_time, _links].hash
    end
