...
module RebillySdk
  class Directa24Banks
    ...
    def build_from_hash(value)
      constantValues = Directa24Banks.constants.select { |c| Directa24Banks::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #Directa24Banks" if constantValues.empty?
      value
    end
  end
end
