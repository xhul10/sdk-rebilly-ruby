...
module RebillySdk
  class Partial
    ...
    attr_accessor :after_approval_policy
    ...
    def self.attribute_map
      {
        ...
        :'value' => :'value',
        :'type' => :'type',
        :'after_approval_policy' => :'afterApprovalPolicy'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::Partial` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::Partial`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'after_approval_policy')
        self.after_approval_policy = attributes[:'after_approval_policy']
      end
    end
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('', ['none', 'partial'])
      return false unless method_validator.valid?(@method)
      return false if @value.nil?
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('', ['percent', 'fixed'])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('', ['none', 'partial'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('', ['percent', 'fixed'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          value == o.value &&
          type == o.type &&
          after_approval_policy == o.after_approval_policy && super(o)
    end
    ...
    def hash
      [method, value, type, after_approval_policy].hash
    end
