...
module RebillySdk
  class NMISettings
    ...
    attr_accessor :disable_stored_credentials
    ...
    def self.openapi_types
      {
        :'disable_stored_credentials' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::NMISettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::NMISettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'disable_stored_credentials')
        self.disable_stored_credentials = attributes[:'disable_stored_credentials']
      else
        self.disable_stored_credentials = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          disable_stored_credentials == o.disable_stored_credentials
    end
    ...
    def hash
      [disable_stored_credentials].hash
    end
