...
module RebillySdk
  ...
  class CommonSubscriptionOrderRecurringInterval
    attr_accessor :period_anchor_instruction
    ...
    def self.openapi_types
      {
        :'period_anchor_instruction' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CommonSubscriptionOrderRecurringInterval` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CommonSubscriptionOrderRecurringInterval`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'period_anchor_instruction')
        self.period_anchor_instruction = attributes[:'period_anchor_instruction']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          period_anchor_instruction == o.period_anchor_instruction
    end
    ...
    def hash
      [period_anchor_instruction].hash
    end
