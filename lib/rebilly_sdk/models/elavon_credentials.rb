...
module RebillySdk
  ...
  class ElavonCredentials
    # Elavon merchant ID.
    attr_accessor :ssl_merchant_id

    # Elavon user ID.
    attr_accessor :ssl_user_id

    # Elavon pin.
    attr_accessor :ssl_pin
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ElavonCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ElavonCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'ssl_merchant_id')
        self.ssl_merchant_id = attributes[:'ssl_merchant_id']
      end

      if attributes.key?(:'ssl_user_id')
        self.ssl_user_id = attributes[:'ssl_user_id']
      end

      if attributes.key?(:'ssl_pin')
        self.ssl_pin = attributes[:'ssl_pin']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ssl_merchant_id.nil?
        invalid_properties.push('invalid value for "ssl_merchant_id", ssl_merchant_id cannot be nil.')
      end

      if @ssl_user_id.nil?
        invalid_properties.push('invalid value for "ssl_user_id", ssl_user_id cannot be nil.')
      end

      if @ssl_pin.nil?
        invalid_properties.push('invalid value for "ssl_pin", ssl_pin cannot be nil.')
      end
    ...
    def valid?
      return false if @ssl_merchant_id.nil?
      return false if @ssl_user_id.nil?
      return false if @ssl_pin.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ssl_merchant_id == o.ssl_merchant_id &&
          ssl_user_id == o.ssl_user_id &&
          ssl_pin == o.ssl_pin
    end
    ...
    def hash
      [ssl_merchant_id, ssl_user_id, ssl_pin].hash
    end
