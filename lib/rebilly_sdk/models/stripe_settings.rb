...
module RebillySdk
  ...
  class StripeSettings
    ...
    # If `true` the `Charges` API will be used instead of `PaymentIntents` API.
    attr_accessor :disable_payment_intents

    # If `true`, `off_session` param will always be `true` in Stripe requests.
    attr_accessor :enforce_off_session
    ...
    attr_accessor :copy_credentials_from

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'redirect_url' => :'redirectUrl',
        :'disable_payment_intents' => :'disablePaymentIntents',
        :'enforce_off_session' => :'enforceOffSession',
        :'copy_credentials_from' => :'copyCredentialsFrom'
      }
    end
    ...
    def self.openapi_types
      {
        :'redirect_url' => :'Object',
        :'disable_payment_intents' => :'Object',
        :'enforce_off_session' => :'Object',
        :'copy_credentials_from' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::StripeSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::StripeSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'disable_payment_intents')
        self.disable_payment_intents = attributes[:'disable_payment_intents']
      else
        self.disable_payment_intents = false
      end

      if attributes.key?(:'enforce_off_session')
        self.enforce_off_session = attributes[:'enforce_off_session']
      else
        self.enforce_off_session = false
      end

      if attributes.key?(:'copy_credentials_from')
        self.copy_credentials_from = attributes[:'copy_credentials_from']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          disable_payment_intents == o.disable_payment_intents &&
          enforce_off_session == o.enforce_off_session &&
          copy_credentials_from == o.copy_credentials_from
    end
    ...
    def hash
      [redirect_url, disable_payment_intents, enforce_off_session, copy_credentials_from].hash
    end
