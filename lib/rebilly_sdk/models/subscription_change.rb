  ...
  class SubscriptionChange
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::SubscriptionChange` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::SubscriptionChange`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'renewal_policy')
        self.renewal_policy = attributes[:'renewal_policy']
      end
      ...
      if attributes.key?(:'keep_trial')
        self.keep_trial = attributes[:'keep_trial']
      else
        self.keep_trial = false
      end
    end
    ...
    def list_invalid_properties
      ...
      if @renewal_policy.nil?
        invalid_properties.push('invalid value for "renewal_policy", renewal_policy cannot be nil.')
      end

      if @prorated.nil?
        invalid_properties.push('invalid value for "prorated", prorated cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @renewal_policy.nil?
      renewal_policy_validator = EnumAttributeValidator.new('Object', ['reset', 'retain'])
      return false unless renewal_policy_validator.valid?(@renewal_policy)
      return false if @prorated.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] renewal_policy Object to be assigned
    def renewal_policy=(renewal_policy)
      validator = EnumAttributeValidator.new('Object', ['reset', 'retain'])
      unless validator.valid?(renewal_policy)
        fail ArgumentError, "invalid value for \"renewal_policy\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          items == o.items &&
          renewal_policy == o.renewal_policy &&
          prorated == o.prorated &&
          effective_time == o.effective_time &&
          preview == o.preview &&
          keep_trial == o.keep_trial
    end
    ...
    def hash
      [items, renewal_policy, prorated, effective_time, preview, keep_trial].hash
    end
