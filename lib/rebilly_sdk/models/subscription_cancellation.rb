  ...
  class SubscriptionCancellation
    ...
    def self.openapi_types
      {
        ...
        :'prorated_invoice_id' => :'Object',
        :'applied_invoice_id' => :'Object',
        :'canceled_by' => :'Object',
        :'reason' => :'Object',
        :'description' => :'Object',
        :'prorated' => :'Object',
        :'status' => :'Object',
        :'canceled_time' => :'Object',
        :'created_time' => :'Object',
        :'churn_time' => :'Object',
        :'line_items' => :'Object',
        :'line_item_subtotal' => :'Object',
        :'_links' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::SubscriptionCancellation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::SubscriptionCancellation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'prorated_invoice_id')
        self.prorated_invoice_id = attributes[:'prorated_invoice_id']
      end

      if attributes.key?(:'applied_invoice_id')
        self.applied_invoice_id = attributes[:'applied_invoice_id']
      end

      if attributes.key?(:'canceled_by')
        self.canceled_by = attributes[:'canceled_by']
      else
        self.canceled_by = 'customer'
      end
      ...
      if attributes.key?(:'churn_time')
        self.churn_time = attributes[:'churn_time']
      end
    ...
    def list_invalid_properties
      ...
      if @churn_time.nil?
        invalid_properties.push('invalid value for "churn_time", churn_time cannot be nil.')
      end
    ...
    def valid?
      ...
      canceled_by_validator = EnumAttributeValidator.new('Object', ['merchant', 'customer'])
      return false unless canceled_by_validator.valid?(@canceled_by)
      reason_validator = EnumAttributeValidator.new('Object', ['did-not-use', 'did-not-want', 'missing-features', 'bugs-or-problems', 'do-not-remember', 'risk-warning', 'contract-expired', 'too-expensive', 'other', 'billing-failure'])
      return false unless reason_validator.valid?(@reason)
      status_validator = EnumAttributeValidator.new('Object', ['draft', 'confirmed', 'completed', 'revoked'])
      return false unless status_validator.valid?(@status)
      return false if @churn_time.nil?
      true
    end
    ...
    def canceled_by=(canceled_by)
      validator = EnumAttributeValidator.new('Object', ['merchant', 'customer'])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('Object', ['did-not-use', 'did-not-want', 'missing-features', 'bugs-or-problems', 'do-not-remember', 'risk-warning', 'contract-expired', 'too-expensive', 'other', 'billing-failure'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['draft', 'confirmed', 'completed', 'revoked'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          prorated_invoice_id == o.prorated_invoice_id &&
          applied_invoice_id == o.applied_invoice_id &&
    ...
    def hash
      [id, subscription_id, prorated_invoice_id, applied_invoice_id, canceled_by, reason, description, prorated, status, canceled_time, created_time, churn_time, line_items, line_item_subtotal, _links].hash
    end
