...
module RebillySdk
  ...
  class CoinPaymentsCredentials
    attr_accessor :public_key

    attr_accessor :private_key

    attr_accessor :ipn_secret
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CoinPaymentsCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CoinPaymentsCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ipn_secret')
        self.ipn_secret = attributes[:'ipn_secret']
      end
    ...
    def list_invalid_properties
      ...
      if @ipn_secret.nil?
        invalid_properties.push('invalid value for "ipn_secret", ipn_secret cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipn_secret.nil?
      true
    end
    ...
    def hash
      [public_key, private_key, ipn_secret, merchant_id].hash
    end
