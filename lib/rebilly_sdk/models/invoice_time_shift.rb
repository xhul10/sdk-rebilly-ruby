...
module RebillySdk
  ...
  class InvoiceTimeShift
    attr_accessor :issue_time_shift

    attr_accessor :due_time_shift
    ...
    def self.openapi_types
      {
        :'issue_time_shift' => :'Object',
        :'due_time_shift' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::InvoiceTimeShift` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::InvoiceTimeShift`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'issue_time_shift')
        self.issue_time_shift = attributes[:'issue_time_shift']
      end

      if attributes.key?(:'due_time_shift')
        self.due_time_shift = attributes[:'due_time_shift']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          issue_time_shift == o.issue_time_shift &&
          due_time_shift == o.due_time_shift
    end
    ...
    def hash
      [issue_time_shift, due_time_shift].hash
    end
