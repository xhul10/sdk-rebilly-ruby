  ...
  class TransactionBumpOffer
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::TransactionBumpOffer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::TransactionBumpOffer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'presented_offers')
        self.presented_offers = attributes[:'presented_offers']
      end

      if attributes.key?(:'selected_offer')
        self.selected_offer = attributes[:'selected_offer']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          language == o.language &&
          outcome == o.outcome &&
          presented_offers == o.presented_offers &&
          selected_offer == o.selected_offer
    end
    ...
    def hash
      [order, version, language, outcome, presented_offers, selected_offer].hash
    end
