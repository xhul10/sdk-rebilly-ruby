  ...
  class DigitalWalletToken
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::DigitalWalletToken` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::DigitalWalletToken`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'usage_time')
        self.usage_time = attributes[:'usage_time']
      end
    ...
    def list_invalid_properties
      ...
      if @payment_instrument.nil?
        invalid_properties.push('invalid value for "payment_instrument", payment_instrument cannot be nil.')
      end
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('', ['digital-wallet'])
      return false unless method_validator.valid?(@method)
      return false if @payment_instrument.nil?
      true
    end
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('', ['digital-wallet'])
    ...
    def hash
      [id, is_used, method, risk_metadata, lead_source, created_time, updated_time, usage_time, expiration_time, _links, payment_instrument, billing_address].hash
    end
