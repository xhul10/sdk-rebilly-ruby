...
module RebillySdk
  class OrganizationQuestionnaire
    ...
    def self.openapi_types
      {
        :'role' => :'Object',
        :'monthly_transactions' => :'Object',
        :'products' => :'Object',
        :'integration_type' => :'Object',
        :'launch_timing' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::OrganizationQuestionnaire` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::OrganizationQuestionnaire`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'launch_timing')
        self.launch_timing = attributes[:'launch_timing']
      end
    end
    ...
    def hash
      [role, monthly_transactions, products, integration_type, launch_timing].hash
    end
