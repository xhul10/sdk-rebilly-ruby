...
module RebillySdk
  class PriceBasedShippingRate
    ...
    def self.openapi_types
      {
        :'name' => :'Object',
        :'min_order_subtotal' => :'Object',
        :'max_order_subtotal' => :'Object',
        :'price' => :'Object',
        :'currency' => :'Object',
        :'_links' => :'Object'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PriceBasedShippingRate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PriceBasedShippingRate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
