  ...
  class Product
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::Product` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::Product`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      tax_category_id_validator = EnumAttributeValidator.new('', ['00000', '99999', '20010', '40030', '51020', '51010', '31000', '30070'])
      return false unless tax_category_id_validator.valid?(@tax_category_id)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] tax_category_id Object to be assigned
    def tax_category_id=(tax_category_id)
      validator = EnumAttributeValidator.new('', ['00000', '99999', '20010', '40030', '51020', '51010', '31000', '30070'])
      unless validator.valid?(tax_category_id)
        fail ArgumentError, "invalid value for \"tax_category_id\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, name, unit_label, description, requires_shipping, options, custom_fields, created_time, updated_time, tax_category_id, accounting_code, _links].hash
    end
