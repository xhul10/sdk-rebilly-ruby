...
module RebillySdk
  ...
  class PayvisionSettings
    ...
    attr_accessor :merchant_account_type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PayvisionSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PayvisionSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'avs')
      ...
      if attributes.key?(:'merchant_account_type')
        self.merchant_account_type = attributes[:'merchant_account_type']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_account_type.nil?
        invalid_properties.push('invalid value for "merchant_account_type", merchant_account_type cannot be nil.')
      end
    ...
    def valid?
      return false if @merchant_account_type.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          avs == o.avs &&
          delay == o.delay &&
          merchant_account_type == o.merchant_account_type
    end
    ...
    def hash
      [avs, delay, merchant_account_type].hash
    end
