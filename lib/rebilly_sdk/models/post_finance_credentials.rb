...
module RebillySdk
  ...
  class PostFinanceCredentials
    attr_accessor :psp_id
    ...
    attr_accessor :sftp_key_passphrase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PostFinanceCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PostFinanceCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'psp_id')
      ...
      if attributes.key?(:'sftp_key_passphrase')
        self.sftp_key_passphrase = attributes[:'sftp_key_passphrase']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @psp_id.nil?
        invalid_properties.push('invalid value for "psp_id", psp_id cannot be nil.')
      end
      ...
      if @sftp_username.nil?
        invalid_properties.push('invalid value for "sftp_username", sftp_username cannot be nil.')
      end
      ...
      if @key_passphrase.nil?
        invalid_properties.push('invalid value for "key_passphrase", key_passphrase cannot be nil.')
      end

      if @sftp_private_key.nil?
        invalid_properties.push('invalid value for "sftp_private_key", sftp_private_key cannot be nil.')
      end

      if @sftp_key_passphrase.nil?
        invalid_properties.push('invalid value for "sftp_key_passphrase", sftp_key_passphrase cannot be nil.')
      end
    ...
    def valid?
      return false if @psp_id.nil?
      return false if @merchant_id.nil?
      return false if @sftp_username.nil?
      return false if @public_key.nil?
      return false if @private_key.nil?
      return false if @key_passphrase.nil?
      return false if @sftp_private_key.nil?
      return false if @sftp_key_passphrase.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sftp_key_passphrase == o.sftp_key_passphrase
    end
    ...
    def hash
      [psp_id, merchant_id, sftp_username, public_key, private_key, key_passphrase, sftp_private_key, sftp_key_passphrase].hash
    end
