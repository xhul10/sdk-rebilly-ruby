...
module RebillySdk
  ...
  class PayPalSettings
    ...
    attr_accessor :enable_guest_checkout

    # Use Rebilly's hosted PayPal form instead of redirecting customers to PayPal.
    attr_accessor :use_hosted_checkout_form

    # Suppress PayPal payment method when Guest Checkout is available. Only applicable when useHostedCheckoutForm is enabled.
    attr_accessor :force_guest_checkout
    ...
    def self.attribute_map
      {
        ...
        :'use_hosted_checkout_form' => :'useHostedCheckoutForm',
        :'force_guest_checkout' => :'forceGuestCheckout'
      }
    end
    ...
    def self.openapi_types
      {
        :'redirect_url' => :'Object',
        :'enable_guest_checkout' => :'Object',
        :'use_hosted_checkout_form' => :'Object',
        :'force_guest_checkout' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PayPalSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PayPalSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enable_guest_checkout')
        self.enable_guest_checkout = attributes[:'enable_guest_checkout']
      else
        self.enable_guest_checkout = false
      end

      if attributes.key?(:'use_hosted_checkout_form')
        self.use_hosted_checkout_form = attributes[:'use_hosted_checkout_form']
      else
        self.use_hosted_checkout_form = false
      end

      if attributes.key?(:'force_guest_checkout')
        self.force_guest_checkout = attributes[:'force_guest_checkout']
      else
        self.force_guest_checkout = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_guest_checkout == o.enable_guest_checkout &&
          use_hosted_checkout_form == o.use_hosted_checkout_form &&
          force_guest_checkout == o.force_guest_checkout
    end
    ...
    def hash
      [redirect_url, enable_guest_checkout, use_hosted_checkout_form, force_guest_checkout].hash
    end
