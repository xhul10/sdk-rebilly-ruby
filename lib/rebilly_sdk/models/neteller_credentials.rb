...
module RebillySdk
  ...
  class NetellerCredentials
    ...
    def self.openapi_types
      {
        :'paysafe_payments_api_username' => :'Object',
        :'paysafe_payments_api_password' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::NetellerCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::NetellerCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'paysafe_payments_api_username')
        self.paysafe_payments_api_username = attributes[:'paysafe_payments_api_username']
      end

      if attributes.key?(:'paysafe_payments_api_password')
        self.paysafe_payments_api_password = attributes[:'paysafe_payments_api_password']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @paysafe_payments_api_username.nil?
        invalid_properties.push('invalid value for "paysafe_payments_api_username", paysafe_payments_api_username cannot be nil.')
      end

      if @paysafe_payments_api_password.nil?
        invalid_properties.push('invalid value for "paysafe_payments_api_password", paysafe_payments_api_password cannot be nil.')
      end
    ...
    def valid?
      return false if @paysafe_payments_api_username.nil?
      return false if @paysafe_payments_api_password.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          paysafe_payments_api_username == o.paysafe_payments_api_username &&
          paysafe_payments_api_password == o.paysafe_payments_api_password
    end
    ...
    def hash
      [paysafe_payments_api_username, paysafe_payments_api_password].hash
    end
