...
module RebillySdk
  class ZotapayCredentials
    ...
    attr_accessor :merchant_secret_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ZotapayCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ZotapayCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_secret_key')
        self.merchant_secret_key = attributes[:'merchant_secret_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_secret_key.nil?
        invalid_properties.push('invalid value for "merchant_secret_key", merchant_secret_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_secret_key.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          merchant_secret_key == o.merchant_secret_key
    end
    ...
    def hash
      [endpoint_id, merchant_id, merchant_secret_key].hash
    end
