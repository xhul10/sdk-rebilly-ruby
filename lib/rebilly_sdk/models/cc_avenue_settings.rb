...
module RebillySdk
  class CCAvenueSettings
    attr_accessor :use_standing_instruction_api

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'use_standing_instruction_api' => :'useStandingInstructionApi'
      }
    end
    ...
    def self.openapi_types
      {
        :'use_standing_instruction_api' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CCAvenueSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CCAvenueSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'use_standing_instruction_api')
        self.use_standing_instruction_api = attributes[:'use_standing_instruction_api']
      else
        self.use_standing_instruction_api = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          use_standing_instruction_api == o.use_standing_instruction_api
    end
    ...
    def hash
      [use_standing_instruction_api].hash
    end
