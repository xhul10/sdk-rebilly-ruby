...
module RebillySdk
  class PlugnpayCredentials
    # Plugnpay Gateway member id.
    attr_accessor :publisher_name

    # Plugnpay Gateway avs.
    attr_accessor :publisher_password
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PlugnpayCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PlugnpayCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'publisher_name')
        self.publisher_name = attributes[:'publisher_name']
      end

      if attributes.key?(:'publisher_password')
        self.publisher_password = attributes[:'publisher_password']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @publisher_name.nil?
        invalid_properties.push('invalid value for "publisher_name", publisher_name cannot be nil.')
      end

      if @publisher_password.nil?
        invalid_properties.push('invalid value for "publisher_password", publisher_password cannot be nil.')
      end
    ...
    def valid?
      return false if @publisher_name.nil?
      return false if @publisher_password.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          publisher_password == o.publisher_password
    end
    ...
    def hash
      [publisher_name, publisher_password].hash
    end
