...
module RebillySdk
  class ProofOfPurchase
    ...
    attr_accessor :document_matches
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ProofOfPurchase` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ProofOfPurchase`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'document_matches')
        self.document_matches = attributes[:'document_matches']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          settings == o.settings &&
          document_matches == o.document_matches &&
    ...
    def hash
      [customer_id, reviewer_id, reviewer_name, review_start_time, review_time, notes, tags, reason, match_level, settings, document_matches, parsed_data, _links].hash
    end
