...
module RebillySdk
  ...
  class TrustsPayCredentials
    attr_accessor :merchant_no

    attr_accessor :gateway_no
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::TrustsPayCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::TrustsPayCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'merchant_no')
        self.merchant_no = attributes[:'merchant_no']
      end

      if attributes.key?(:'gateway_no')
        self.gateway_no = attributes[:'gateway_no']
      end

      if attributes.key?(:'signkey')
        self.signkey = attributes[:'signkey']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_no.nil?
        invalid_properties.push('invalid value for "merchant_no", merchant_no cannot be nil.')
      end

      if @gateway_no.nil?
        invalid_properties.push('invalid value for "gateway_no", gateway_no cannot be nil.')
      end

      if @signkey.nil?
        invalid_properties.push('invalid value for "signkey", signkey cannot be nil.')
      end
    ...
    def valid?
      return false if @merchant_no.nil?
      return false if @gateway_no.nil?
      return false if @signkey.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          merchant_no == o.merchant_no &&
          gateway_no == o.gateway_no &&
          signkey == o.signkey
    end
    ...
    def hash
      [merchant_no, gateway_no, signkey].hash
    end
