...
module RebillySdk
  class PostFinanceSettings
    attr_accessor :skip_payment_file_upload

    attr_accessor :enable_alias_authentication

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'skip_payment_file_upload' => :'skipPaymentFileUpload',
        :'enable_alias_authentication' => :'enableAliasAuthentication'
      }
    end
    ...
    def self.openapi_types
      {
        :'skip_payment_file_upload' => :'Object',
        :'enable_alias_authentication' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PostFinanceSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PostFinanceSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'skip_payment_file_upload')
        self.skip_payment_file_upload = attributes[:'skip_payment_file_upload']
      else
        self.skip_payment_file_upload = false
      end

      if attributes.key?(:'enable_alias_authentication')
        self.enable_alias_authentication = attributes[:'enable_alias_authentication']
      else
        self.enable_alias_authentication = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          skip_payment_file_upload == o.skip_payment_file_upload &&
          enable_alias_authentication == o.enable_alias_authentication
    end
    ...
    def hash
      [skip_payment_file_upload, enable_alias_authentication].hash
    end
