  ...
  class SubscriptionCancellationState
    ...
    def self.openapi_types
      {
        ...
        :'canceled_by' => :'Object',
        :'cancel_category' => :'Object',
        :'cancel_description' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::SubscriptionCancellationState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::SubscriptionCancellationState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      canceled_by_validator = EnumAttributeValidator.new('Object', ['merchant', 'customer', 'rebilly'])
      return false unless canceled_by_validator.valid?(@canceled_by)
      cancel_category_validator = EnumAttributeValidator.new('Object', ['billing-failure', 'did-not-use', 'did-not-want', 'missing-features', 'bugs-or-problems', 'do-not-remember', 'risk-warning', 'contract-expired', 'too-expensive', 'never-started', 'switched-plan', 'other'])
    ...
    def canceled_by=(canceled_by)
      validator = EnumAttributeValidator.new('Object', ['merchant', 'customer', 'rebilly'])
    ...
    def cancel_category=(cancel_category)
      validator = EnumAttributeValidator.new('Object', ['billing-failure', 'did-not-use', 'did-not-want', 'missing-features', 'bugs-or-problems', 'do-not-remember', 'risk-warning', 'contract-expired', 'too-expensive', 'never-started', 'switched-plan', 'other'])
    ...
    def hash
      [canceled_time, canceled_by, cancel_category, cancel_description].hash
    end
