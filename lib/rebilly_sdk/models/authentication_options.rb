  ...
  class AuthenticationOptions
    ...
    def self.openapi_types
      {
        ...
        :'credential_ttl' => :'Object',
        :'auth_token_ttl' => :'Object',
        :'reset_token_ttl' => :'Object',
        :'otp_required' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::AuthenticationOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::AuthenticationOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'password_pattern')
        self.password_pattern = attributes[:'password_pattern']
      end

      if attributes.key?(:'credential_ttl')
        self.credential_ttl = attributes[:'credential_ttl']
      end

      if attributes.key?(:'auth_token_ttl')
        self.auth_token_ttl = attributes[:'auth_token_ttl']
      end

      if attributes.key?(:'reset_token_ttl')
        self.reset_token_ttl = attributes[:'reset_token_ttl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credential_ttl == o.credential_ttl &&
          auth_token_ttl == o.auth_token_ttl &&
          reset_token_ttl == o.reset_token_ttl &&
    ...
    def hash
      [password_pattern, credential_ttl, auth_token_ttl, reset_token_ttl, otp_required].hash
    end
