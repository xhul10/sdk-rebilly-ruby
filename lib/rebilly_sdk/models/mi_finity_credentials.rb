...
module RebillySdk
  ...
  class MiFinityCredentials
    attr_accessor :api_key

    attr_accessor :mifinity_account_number
    ...
    def self.openapi_types
      {
        :'api_key' => :'Object',
        :'mifinity_account_number' => :'Object',
        :'account_holder_id' => :'Object',
        :'brand_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::MiFinityCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::MiFinityCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mifinity_account_number')
        self.mifinity_account_number = attributes[:'mifinity_account_number']
      end
    ...
    def list_invalid_properties
      ...
      if @mifinity_account_number.nil?
        invalid_properties.push('invalid value for "mifinity_account_number", mifinity_account_number cannot be nil.')
      end

      if @account_holder_id.nil?
        invalid_properties.push('invalid value for "account_holder_id", account_holder_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @mifinity_account_number.nil?
      return false if @account_holder_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          api_key == o.api_key &&
          mifinity_account_number == o.mifinity_account_number &&
    ...
    def hash
      [api_key, mifinity_account_number, account_holder_id, brand_id].hash
    end
