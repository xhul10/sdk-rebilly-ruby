...
module RebillySdk
  ...
  class Stripe3dsServer
    ...
    attr_accessor :enforce_three_d_secure
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::Stripe3dsServer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::Stripe3dsServer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enforce_three_d_secure')
        self.enforce_three_d_secure = attributes[:'enforce_three_d_secure']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          enforce_three_d_secure == o.enforce_three_d_secure && super(o)
    end
    ...
    def hash
      [name, enforce_three_d_secure].hash
    end
