...
module RebillySdk
  class BraintreePaymentsCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::BraintreePaymentsCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::BraintreePaymentsCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_account_id')
        self.merchant_account_id = attributes[:'merchant_account_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_account_id.nil?
        invalid_properties.push('invalid value for "merchant_account_id", merchant_account_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_account_id.nil?
      true
    end
    ...
    def hash
      [public_key, private_key, merchant_id, merchant_account_id].hash
    end
