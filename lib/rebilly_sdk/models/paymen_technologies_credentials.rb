...
module RebillySdk
  class PaymenTechnologiesCredentials
    # PaymenTechnologies Gateway authenticate ID.
    attr_accessor :authenticate_id

    # PaymenTechnologies Gateway authenticate password.
    attr_accessor :authenticate_pw
    ...
    def self.openapi_types
      {
        :'authenticate_id' => :'Object',
        :'authenticate_pw' => :'Object',
        :'public_key' => :'Object',
        :'secret_key' => :'Object',
        :'api_key' => :'Object'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PaymenTechnologiesCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PaymenTechnologiesCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'authenticate_id')
        self.authenticate_id = attributes[:'authenticate_id']
      end

      if attributes.key?(:'authenticate_pw')
        self.authenticate_pw = attributes[:'authenticate_pw']
      end
    ...
    def list_invalid_properties
      ...
      if @authenticate_id.nil?
        invalid_properties.push('invalid value for "authenticate_id", authenticate_id cannot be nil.')
      end

      if @authenticate_pw.nil?
        invalid_properties.push('invalid value for "authenticate_pw", authenticate_pw cannot be nil.')
      end
    ...
    def valid?
      return false if @authenticate_id.nil?
      return false if @authenticate_pw.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          authenticate_id == o.authenticate_id &&
          authenticate_pw == o.authenticate_pw &&
    ...
    def hash
      [authenticate_id, authenticate_pw, public_key, secret_key, api_key].hash
    end
