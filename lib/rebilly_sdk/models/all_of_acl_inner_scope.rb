...
module RebillySdk
  ...
  class AllOfAclInnerScope
    ...
    attr_accessor :custom_field_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::AllOfAclInnerScope` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::AllOfAclInnerScope`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'organization_id')
        if (value = attributes[:'organization_id']).is_a?(Array)
      ...
      if attributes.key?(:'plan_id')
        if (value = attributes[:'plan_id']).is_a?(Array)
          self.plan_id = value
        end
      end

      if attributes.key?(:'custom_field_name')
        if (value = attributes[:'custom_field_name']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          plan_id == o.plan_id &&
          custom_field_name == o.custom_field_name && super(o)
    end
    ...
    def hash
      [organization_id, product_id, plan_id, custom_field_name].hash
    end
