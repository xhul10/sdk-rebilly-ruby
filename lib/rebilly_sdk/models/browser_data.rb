  ...
  class BrowserData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::BrowserData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::BrowserData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_java_enabled')
        self.is_java_enabled = attributes[:'is_java_enabled']
      end
    ...
    def list_invalid_properties
      ...
      if @is_java_enabled.nil?
        invalid_properties.push('invalid value for "is_java_enabled", is_java_enabled cannot be nil.')
      end
      ...
      if @time_zone_offset.nil?
        invalid_properties.push('invalid value for "time_zone_offset", time_zone_offset cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_java_enabled.nil?
      return false if @language.nil?
      return false if @screen_width.nil?
      return false if @screen_height.nil?
      return false if @time_zone_offset.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_java_enabled == o.is_java_enabled &&
          language == o.language &&
    ...
    def hash
      [color_depth, is_java_enabled, language, screen_width, screen_height, time_zone_offset].hash
    end
