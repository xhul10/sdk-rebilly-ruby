...
module RebillySdk
  class InvoiceRetryInstructionAttempts
    attr_accessor :schedule_instruction

    attr_accessor :amount_adjustment_instruction

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'schedule_instruction' => :'scheduleInstruction',
        :'amount_adjustment_instruction' => :'amountAdjustmentInstruction'
      }
    end
    ...
    def self.openapi_types
      {
        :'schedule_instruction' => :'Object',
        :'amount_adjustment_instruction' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::InvoiceRetryInstructionAttempts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::InvoiceRetryInstructionAttempts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'schedule_instruction')
        self.schedule_instruction = attributes[:'schedule_instruction']
      end

      if attributes.key?(:'amount_adjustment_instruction')
        self.amount_adjustment_instruction = attributes[:'amount_adjustment_instruction']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @schedule_instruction.nil?
        invalid_properties.push('invalid value for "schedule_instruction", schedule_instruction cannot be nil.')
      end
    ...
    def valid?
      return false if @schedule_instruction.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          schedule_instruction == o.schedule_instruction &&
          amount_adjustment_instruction == o.amount_adjustment_instruction
    end
    ...
    def hash
      [schedule_instruction, amount_adjustment_instruction].hash
    end
