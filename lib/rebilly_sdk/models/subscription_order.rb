...
module RebillySdk
  class SubscriptionOrder
    ...
    attr_accessor :renewal_reminder_time

    # Number of renewal reminder events triggered.
    attr_accessor :renewal_reminder_number

    # Time renewal reminder event will be triggered.
    attr_accessor :trial_reminder_time

    # Number of renewal reminder events triggered.
    attr_accessor :trial_reminder_number
    ...
    def self.openapi_types
      {
        ...
        :'line_item_subtotal' => :'',
        :'customer_id' => :'',
        :'renewal_reminder_time' => :'',
        :'renewal_reminder_number' => :'',
        :'trial_reminder_time' => :'',
        :'trial_reminder_number' => :''
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::SubscriptionOrder` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::SubscriptionOrder`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'renewal_reminder_time')
        self.renewal_reminder_time = attributes[:'renewal_reminder_time']
      end

      if attributes.key?(:'renewal_reminder_number')
        self.renewal_reminder_number = attributes[:'renewal_reminder_number']
      end

      if attributes.key?(:'trial_reminder_time')
        self.trial_reminder_time = attributes[:'trial_reminder_time']
      end

      if attributes.key?(:'trial_reminder_number')
        self.trial_reminder_number = attributes[:'trial_reminder_number']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          renewal_reminder_time == o.renewal_reminder_time &&
          renewal_reminder_number == o.renewal_reminder_number &&
          trial_reminder_time == o.trial_reminder_time &&
          trial_reminder_number == o.trial_reminder_number && super(o)
    end
    ...
    def hash
      [canceled_time, canceled_by, cancel_category, cancel_description, revision, risk_metadata, custom_fields, created_time, updated_time, _links, _embedded, status, in_trial, trial, is_trial_only, invoice_time_shift, recurring_interval, autopay, start_time, end_time, renewal_time, rebill_number, line_items, line_item_subtotal, customer_id, renewal_reminder_time, renewal_reminder_number, trial_reminder_time, trial_reminder_number].hash
    end
