  ...
  class PanamericanSettings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PanamericanSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PanamericanSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'convert_to_ascii')
        self.convert_to_ascii = attributes[:'convert_to_ascii']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @extra_step.nil?
        invalid_properties.push('invalid value for "extra_step", extra_step cannot be nil.')
      end
    ...
    def valid?
      return false if @extra_step.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          convert_to_ascii == o.convert_to_ascii
    end
    ...
    def hash
      [extra_step, convert_to_ascii].hash
    end
