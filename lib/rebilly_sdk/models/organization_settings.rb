...
module RebillySdk
  class OrganizationSettings
    attr_accessor :default_tax_calculator
    ...
    def self.attribute_map
      {
        :'default_tax_calculator' => :'defaultTaxCalculator',
        :'kyc' => :'kyc'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::OrganizationSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::OrganizationSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'default_tax_calculator')
        self.default_tax_calculator = attributes[:'default_tax_calculator']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          default_tax_calculator == o.default_tax_calculator &&
          kyc == o.kyc
    end
    ...
    def hash
      [default_tax_calculator, kyc].hash
    end
