  ...
  class UpcomingInvoiceItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::UpcomingInvoiceItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::UpcomingInvoiceItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unit_price_amount')
        self.unit_price_amount = attributes[:'unit_price_amount']
      end

      if attributes.key?(:'unit_price_currency')
        self.unit_price_currency = attributes[:'unit_price_currency']
      end
    ...
    def list_invalid_properties
      ...
      if @unit_price_amount.nil?
        invalid_properties.push('invalid value for "unit_price_amount", unit_price_amount cannot be nil.')
      end

      if @unit_price_currency.nil?
        invalid_properties.push('invalid value for "unit_price_currency", unit_price_currency cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('Object', ['debit', 'credit'])
      return false unless type_validator.valid?(@type)
      return false if @unit_price_amount.nil?
      return false if @unit_price_currency.nil?
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ['debit', 'credit'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unit_price_amount == o.unit_price_amount &&
    ...
    def hash
      [type, description, unit_price_amount, unit_price_currency, quantity, period_start_time, period_end_time, created_time].hash
    end
