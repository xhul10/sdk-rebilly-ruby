  ...
  class IpayOptionsSettings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::IpayOptionsSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::IpayOptionsSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'extra_step')
        self.extra_step = attributes[:'extra_step']
      end
    ...
    def valid?
      subdomain_validator = EnumAttributeValidator.new('Object', ['miglite', 'w88asiapay'])
      return false unless subdomain_validator.valid?(@subdomain)
      platform_validator = EnumAttributeValidator.new('Object', ['SOAP', 'TxHandler', 'SecureHosted'])
      return false unless platform_validator.valid?(@platform)
      card_type_validator = EnumAttributeValidator.new('Object', ['ideal', 'idealqr', 'sofort'])
      return false unless card_type_validator.valid?(@card_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] subdomain Object to be assigned
    def subdomain=(subdomain)
      validator = EnumAttributeValidator.new('Object', ['miglite', 'w88asiapay'])
      unless validator.valid?(subdomain)
        fail ArgumentError, "invalid value for \"subdomain\", must be one of #{validator.allowable_values}."
      end
      @subdomain = subdomain
    end
    ...
    def platform=(platform)
      validator = EnumAttributeValidator.new('Object', ['SOAP', 'TxHandler', 'SecureHosted'])
    ...
    def card_type=(card_type)
      validator = EnumAttributeValidator.new('Object', ['ideal', 'idealqr', 'sofort'])
    ...
    def hash
      [extra_step, subdomain, platform, card_type].hash
    end
