...
module RebillySdk
  ...
  class EcoPayzCredentials
    # ecoPayz payment page ID.
    attr_accessor :payment_page_id
    ...
    def self.openapi_types
      {
        :'payment_page_id' => :'Object',
        :'merchant_account_number' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::EcoPayzCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::EcoPayzCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'payment_page_id')
        self.payment_page_id = attributes[:'payment_page_id']
      end

      if attributes.key?(:'merchant_account_number')
        self.merchant_account_number = attributes[:'merchant_account_number']
      end
    ...
    def list_invalid_properties
      ...
      if @payment_page_id.nil?
        invalid_properties.push('invalid value for "payment_page_id", payment_page_id cannot be nil.')
      end

      if @merchant_account_number.nil?
        invalid_properties.push('invalid value for "merchant_account_number", merchant_account_number cannot be nil.')
      end
    ...
    def valid?
      return false if @payment_page_id.nil?
      return false if @merchant_account_number.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          payment_page_id == o.payment_page_id &&
    ...
    def hash
      [payment_page_id, merchant_account_number, merchant_password].hash
    end
