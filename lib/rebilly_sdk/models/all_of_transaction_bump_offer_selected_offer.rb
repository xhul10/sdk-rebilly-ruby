...
module RebillySdk
  ...
  class AllOfTransactionBumpOfferSelectedOffer
    # Offer ID.
    ...
    # Bump amount.
    attr_accessor :bump_amount

    # Bump amount in USD.
    attr_accessor :bump_amount_in_usd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::AllOfTransactionBumpOfferSelectedOffer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::AllOfTransactionBumpOfferSelectedOffer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bump_amount')
        self.bump_amount = attributes[:'bump_amount']
      end

      if attributes.key?(:'bump_amount_in_usd')
        self.bump_amount_in_usd = attributes[:'bump_amount_in_usd']
      end
    ...
    def list_invalid_properties
      ...
      if @bump_amount.nil?
        invalid_properties.push('invalid value for "bump_amount", bump_amount cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bump_amount.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bump_amount == o.bump_amount &&
          bump_amount_in_usd == o.bump_amount_in_usd &&
          custom_fields == o.custom_fields && super(o)
    end
    ...
    def hash
      [offer_id, offer_type, bump_amount, bump_amount_in_usd, custom_fields].hash
    end
