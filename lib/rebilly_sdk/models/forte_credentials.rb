  ...
  class ForteCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ForteCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ForteCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'api_access_id')
        self.api_access_id = attributes[:'api_access_id']
      end

      if attributes.key?(:'api_secret_key')
        self.api_secret_key = attributes[:'api_secret_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @api_access_id.nil?
        invalid_properties.push('invalid value for "api_access_id", api_access_id cannot be nil.')
      end

      if @api_secret_key.nil?
        invalid_properties.push('invalid value for "api_secret_key", api_secret_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @api_access_id.nil?
      return false if @api_secret_key.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          api_access_id == o.api_access_id &&
          api_secret_key == o.api_secret_key
    end
    ...
    def hash
      [account_id, location_id, api_access_id, api_secret_key].hash
    end
