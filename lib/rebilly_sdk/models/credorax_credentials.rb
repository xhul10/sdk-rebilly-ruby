  ...
  class CredoraxCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CredoraxCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CredoraxCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_md5_signature')
        self.merchant_md5_signature = attributes[:'merchant_md5_signature']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_md5_signature.nil?
        invalid_properties.push('invalid value for "merchant_md5_signature", merchant_md5_signature cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_md5_signature.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          merchant_md5_signature == o.merchant_md5_signature
    end
    ...
    def hash
      [merchant_id, merchant_md5_signature].hash
    end
