...
module RebillySdk
  class PaymentMethod
    PAYMENT_CARD = 'payment-card'.freeze
    ACH = 'ach'.freeze
    CASH = 'cash'.freeze
    CHECK = 'check'.freeze
    ...
    BOLETO_2 = 'Boleto-2'.freeze
    BOLETO_3 = 'Boleto-3'.freeze
    ...
    INTERAC_EXPRESS_CONNECT = 'Interac-express-connect'.freeze
    ...
    LPG_ONLINE = 'LPG-online'.freeze
    LPG_PAYMENT_CARD = 'LPG-payment-card'.freeze
