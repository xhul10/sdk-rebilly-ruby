...
module RebillySdk
  ...
  class IlixiumSettings
    ...
    def self.openapi_types
      {
        :'use_ip_frame' => :'Object',
        :'use_credit_endpoint' => :'Object',
        :'use_standalone_credit_endpoint' => :'Object',
        :'platform' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::IlixiumSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::IlixiumSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'use_ip_frame')
        self.use_ip_frame = attributes[:'use_ip_frame']
      end

      if attributes.key?(:'use_credit_endpoint')
        self.use_credit_endpoint = attributes[:'use_credit_endpoint']
      end

      if attributes.key?(:'use_standalone_credit_endpoint')
        self.use_standalone_credit_endpoint = attributes[:'use_standalone_credit_endpoint']
      end
    ...
    def valid?
      platform_validator = EnumAttributeValidator.new('Object', ['itix', 'tpg'])
    ...
    def platform=(platform)
      validator = EnumAttributeValidator.new('Object', ['itix', 'tpg'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          use_ip_frame == o.use_ip_frame &&
          use_credit_endpoint == o.use_credit_endpoint &&
          use_standalone_credit_endpoint == o.use_standalone_credit_endpoint &&
          platform == o.platform
    end
    ...
    def hash
      [use_ip_frame, use_credit_endpoint, use_standalone_credit_endpoint, platform].hash
    end
