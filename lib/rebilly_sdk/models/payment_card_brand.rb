...
module RebillySdk
  class PaymentCardBrand
    ...
    def build_from_hash(value)
      constantValues = PaymentCardBrand.constants.select { |c| PaymentCardBrand::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #PaymentCardBrand" if constantValues.empty?
      value
    end
  end
end
