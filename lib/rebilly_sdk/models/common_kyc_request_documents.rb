...
module RebillySdk
  class CommonKycRequestDocuments
    ...
    attr_accessor :face_proof_required
    ...
    def self.attribute_map
      {
        ...
        :'face_proof_required' => :'faceProofRequired'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CommonKycRequestDocuments` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CommonKycRequestDocuments`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'face_proof_required')
        self.face_proof_required = attributes[:'face_proof_required']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          face_proof_required == o.face_proof_required
    end
    ...
    def hash
      [type, subtypes, max_attempts, face_proof_required].hash
    end
