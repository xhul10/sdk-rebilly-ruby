...
module RebillySdk
  ...
  class ApplePayValidation
    ...
    attr_accessor :validation_request
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ApplePayValidation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ApplePayValidation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'validation_request')
        self.validation_request = attributes[:'validation_request']
      end

      if attributes.key?(:'validation_response')
        self.validation_response = attributes[:'validation_response']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @validation_request.nil?
        invalid_properties.push('invalid value for "validation_request", validation_request cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @validation_request.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          validation_request == o.validation_request &&
          validation_response == o.validation_response && super(o)
    end
    ...
    def hash
      [type, validation_request, validation_response].hash
    end
