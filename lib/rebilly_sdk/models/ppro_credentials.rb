...
module RebillySdk
  # PPRO credentials object.
  class PPROCredentials
    # PPRO merchant's api username.
    attr_accessor :login

    # PPRO merchant's api password.
    attr_accessor :password

    # PPRO Contract id, used for api credentials.
    ...
    # CA certificate provided by PPRO.
    attr_accessor :server_certificate

    # Secret used for IPN urls.
    attr_accessor :notification_secret

    # Secret used for redirect urls.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::PPROCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::PPROCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'notification_secret')
        self.notification_secret = attributes[:'notification_secret']
      end
    ...
    def list_invalid_properties
      ...
      if @notification_secret.nil?
        invalid_properties.push('invalid value for "notification_secret", notification_secret cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @notification_secret.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          notification_secret == o.notification_secret &&
    ...
    def hash
      [login, password, contract_id, private_key, private_key_password, client_certificate, server_certificate, notification_secret, shared_secret].hash
    end
