...
module RebillySdk
  ...
  class EMSCredentials
    ...
    attr_accessor :client_certificate_password
    ...
    def self.openapi_types
      {
        ...
        :'client_certificate_password' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::EMSCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::EMSCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'client_certificate_password')
        self.client_certificate_password = attributes[:'client_certificate_password']
      end
    ...
    def list_invalid_properties
      ...
      if @client_certificate_password.nil?
        invalid_properties.push('invalid value for "client_certificate_password", client_certificate_password cannot be nil.')
      end

      if @server_certificate.nil?
        invalid_properties.push('invalid value for "server_certificate", server_certificate cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @client_certificate_password.nil?
      return false if @server_certificate.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          client_certificate_password == o.client_certificate_password &&
    ...
    def hash
      [store_id, user_id, password, private_key, private_key_password, client_certificate, client_certificate_password, server_certificate, merchant_name, sftp_private_key].hash
    end
