  ...
  class AllOfShippingZoneRatesItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::AllOfShippingZoneRatesItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::AllOfShippingZoneRatesItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'min_order_subtotal')
        self.min_order_subtotal = attributes[:'min_order_subtotal']
      else
        self.min_order_subtotal = 0
      end

      if attributes.key?(:'max_order_subtotal')
        self.max_order_subtotal = attributes[:'max_order_subtotal']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          min_order_subtotal == o.min_order_subtotal &&
          max_order_subtotal == o.max_order_subtotal &&
          price == o.price &&
          currency == o.currency &&
    ...
    def hash
      [name, min_order_subtotal, max_order_subtotal, price, currency, _links].hash
    end
