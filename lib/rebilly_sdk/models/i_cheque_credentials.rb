...
module RebillySdk
  class IChequeCredentials
    ...
    attr_accessor :api_security_token
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::IChequeCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::IChequeCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'secret_word')
        self.secret_word = attributes[:'secret_word']
      end

      if attributes.key?(:'api_user_id')
        self.api_user_id = attributes[:'api_user_id']
      end

      if attributes.key?(:'api_security_token')
        self.api_security_token = attributes[:'api_security_token']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @secret_word.nil?
        invalid_properties.push('invalid value for "secret_word", secret_word cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @secret_word.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          secret_word == o.secret_word &&
          api_user_id == o.api_user_id &&
          api_security_token == o.api_security_token
    end
    ...
    def hash
      [client_id, secret_word, api_user_id, api_security_token].hash
    end
