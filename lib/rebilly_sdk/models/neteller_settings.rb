...
module RebillySdk
  class NetellerSettings
    ...
    attr_accessor :populate_customer_email
    ...
    def self.openapi_types
      {
        :'populate_customer_email' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::NetellerSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::NetellerSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'populate_customer_email')
        self.populate_customer_email = attributes[:'populate_customer_email']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          populate_customer_email == o.populate_customer_email
    end
