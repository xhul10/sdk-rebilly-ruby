...
module RebillySdk
  ...
  class ExtraData
    ...
    attr_accessor :kount_fraud_session_id

    # MerchantSessionID as generated by the PayPal Fraudnet SDK.
    attr_accessor :pay_pal_merchant_session_id

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'kount_fraud_session_id' => :'kountFraudSessionId',
        :'pay_pal_merchant_session_id' => :'payPalMerchantSessionId'
      }
    end
    ...
    def self.openapi_types
      {
        :'kount_fraud_session_id' => :'Object',
        :'pay_pal_merchant_session_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ExtraData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ExtraData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'kount_fraud_session_id')
        self.kount_fraud_session_id = attributes[:'kount_fraud_session_id']
      end

      if attributes.key?(:'pay_pal_merchant_session_id')
        self.pay_pal_merchant_session_id = attributes[:'pay_pal_merchant_session_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          kount_fraud_session_id == o.kount_fraud_session_id &&
          pay_pal_merchant_session_id == o.pay_pal_merchant_session_id
    end
    ...
    def hash
      [kount_fraud_session_id, pay_pal_merchant_session_id].hash
    end
