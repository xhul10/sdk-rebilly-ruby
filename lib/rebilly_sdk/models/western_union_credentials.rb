  ...
  class WesternUnionCredentials
    ...
    def self.openapi_types
      {
        ...
        :'certificate_serial_number' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::WesternUnionCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::WesternUnionCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'certificate_serial_number')
    ...
    def list_invalid_properties
      ...
      if @certificate_common_name.nil?
        invalid_properties.push('invalid value for "certificate_common_name", certificate_common_name cannot be nil.')
      end

      if @certificate_serial_number.nil?
        invalid_properties.push('invalid value for "certificate_serial_number", certificate_serial_number cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @certificate_common_name.nil?
      return false if @certificate_serial_number.nil?
      true
    end
    ...
    def hash
      [client_id, certificate_common_name, certificate_serial_number].hash
    end
