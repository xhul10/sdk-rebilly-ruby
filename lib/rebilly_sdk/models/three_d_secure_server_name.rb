...
module RebillySdk
  class ThreeDSecureServerName
    PAYVISION3DS_SERVER = 'Payvision3dsServer'.freeze
    WIRECARD3DS_SERVER = 'Wirecard3dsServer'.freeze
    ILIXIUM3DS_SERVER = 'Ilixium3dsServer'.freeze
    DATA_CASH3DS_SERVER = 'DataCash3dsServer'.freeze
    PAYSAFE3DS_SERVER = 'Paysafe3dsServer'.freeze
    INGENICO3DS_SERVER = 'Ingenico3dsServer'.freeze
    PANAMERICAN3DS_SERVER = 'Panamerican3dsServer'.freeze
    E_MERCHANT_PAY3DS_SERVER = 'eMerchantPay3dsServer'.freeze
    SECURE_TRADING3DS_SERVER = 'SecureTrading3dsServer'.freeze
    CLEARHAUS3DS_SERVER = 'Clearhaus3dsServer'.freeze
    OTHER = 'Other'.freeze
    THREE_D_SECURE_IO3DS_SERVER = 'ThreeDSecureIO3dsServer'.freeze
    WORLDLINE_ATOS_FRANKFURT3DS_SERVER = 'WorldlineAtosFrankfurt3dsServer'.freeze
    PIASTRIX3DS_SERVER = 'Piastrix3dsServer'.freeze
    N_GENIUS3DS_SERVER = 'NGenius3dsServer'.freeze
    STRIPE3DS_SERVER = 'Stripe3dsServer'.freeze

    # Builds the enum from string
    # @param [String] The enum value in the form of the string
    # @return [String] The enum value
    def build_from_hash(value)
      constantValues = ThreeDSecureServerName.constants.select { |c| ThreeDSecureServerName::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ThreeDSecureServerName" if constantValues.empty?
      value
    end
  end
end
