...
module RebillySdk
  ...
  class CouponRedemption
    ...
    attr_accessor :additional_restrictions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CouponRedemption` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CouponRedemption`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'additional_restrictions')
        if (value = attributes[:'additional_restrictions']).is_a?(Array)
          self.additional_restrictions = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          additional_restrictions == o.additional_restrictions &&
    ...
    def hash
      [id, coupon_id, customer_id, additional_restrictions, created_time, canceled_time, _links].hash
    end
