...
module RebillySdk
  class CommonOrderItems
    ...
    attr_accessor :is_grandfathered
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CommonOrderItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CommonOrderItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_modified')
        self.is_modified = attributes[:'is_modified']
      end

      if attributes.key?(:'is_grandfathered')
        self.is_grandfathered = attributes[:'is_grandfathered']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_grandfathered == o.is_grandfathered
    end
    ...
    def hash
      [plan_id, quantity, plan, revision, is_modified, is_grandfathered].hash
    end
