...
module RebillySdk
  ...
  class WorldlineAtosFrankfurt
    ...
    attr_accessor :three_d_secure_server
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::WorldlineAtosFrankfurt` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::WorldlineAtosFrankfurt`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'three_d_secure_server')
        self.three_d_secure_server = attributes[:'three_d_secure_server']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _links == o._links &&
          three_d_secure_server == o.three_d_secure_server &&
