  ...
  class RealexCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::RealexCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::RealexCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rebate_password')
        self.rebate_password = attributes[:'rebate_password']
      end
    ...
    def list_invalid_properties
      ...
      if @rebate_password.nil?
        invalid_properties.push('invalid value for "rebate_password", rebate_password cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @rebate_password.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rebate_password == o.rebate_password &&
          account == o.account
    end
    ...
    def hash
      [merchant_id, secret_key, rebate_password, account].hash
    end
