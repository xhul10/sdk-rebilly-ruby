  ...
  class IngenicoCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::IngenicoCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::IngenicoCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'skip_fraud_service')
        self.skip_fraud_service = attributes[:'skip_fraud_service']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          skip_fraud_service == o.skip_fraud_service
    end
    ...
    def hash
      [merchant_id, api_key_id, api_secret_key, skip_fraud_service].hash
    end
