...
module RebillySdk
  ...
  class InvoiceRetryInstruction
    attr_accessor :attempts

    # The policy on the attempt finishes.
    attr_accessor :after_attempt_policies

    # The policy on the retry ends.
    attr_accessor :after_retry_end_policies
    ...
    def self.openapi_types
      {
        :'attempts' => :'Object',
        :'after_attempt_policies' => :'Object',
        :'after_retry_end_policies' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::InvoiceRetryInstruction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::InvoiceRetryInstruction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'after_attempt_policies')
        if (value = attributes[:'after_attempt_policies']).is_a?(Array)
          self.after_attempt_policies = value
        end
      end

      if attributes.key?(:'after_retry_end_policies')
        if (value = attributes[:'after_retry_end_policies']).is_a?(Array)
          self.after_retry_end_policies = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @after_attempt_policies.nil?
        invalid_properties.push('invalid value for "after_attempt_policies", after_attempt_policies cannot be nil.')
      end

      if @after_retry_end_policies.nil?
        invalid_properties.push('invalid value for "after_retry_end_policies", after_retry_end_policies cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @after_attempt_policies.nil?
      return false if @after_retry_end_policies.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          attempts == o.attempts &&
          after_attempt_policies == o.after_attempt_policies &&
          after_retry_end_policies == o.after_retry_end_policies
    end
    ...
    def hash
      [attempts, after_attempt_policies, after_retry_end_policies].hash
    end
