...
module RebillySdk
  class CashToCodeSettings
    # Skip amount selection screen.
    attr_accessor :skip_amount_selection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::CashToCodeSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::CashToCodeSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'skip_amount_selection')
        self.skip_amount_selection = attributes[:'skip_amount_selection']
      else
        self.skip_amount_selection = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          skip_amount_selection == o.skip_amount_selection &&
          amounts == o.amounts
    end
    ...
    def hash
      [skip_amount_selection, amounts].hash
    end
