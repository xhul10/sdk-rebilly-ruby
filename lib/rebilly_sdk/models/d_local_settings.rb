...
module RebillySdk
  ...
  class DLocalSettings
    # Create installment plan and use it for payment.
    attr_accessor :create_installment_plan
    ...
    def self.openapi_types
      {
        :'create_installment_plan' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::DLocalSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::DLocalSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'create_installment_plan')
        self.create_installment_plan = attributes[:'create_installment_plan']
      else
        self.create_installment_plan = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          create_installment_plan == o.create_installment_plan
    end
