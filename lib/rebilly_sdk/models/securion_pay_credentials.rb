  ...
  class SecurionPayCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::SecurionPayCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::SecurionPayCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'secret_api_key')
        self.secret_api_key = attributes[:'secret_api_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @secret_api_key.nil?
        invalid_properties.push('invalid value for "secret_api_key", secret_api_key cannot be nil.')
      end
    ...
    def valid?
      return false if @secret_api_key.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          secret_api_key == o.secret_api_key
    end
