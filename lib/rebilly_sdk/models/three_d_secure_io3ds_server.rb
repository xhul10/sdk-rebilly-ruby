...
module RebillySdk
  ...
  class ThreeDSecureIO3dsServer
    ...
    # Visa Acquirer BIN.
    attr_accessor :merchant_acquirer_bin_visa

    # Mastercard Acquirer BIN.
    attr_accessor :merchant_acquirer_bin_mastercard
    ...
    attr_accessor :use3ds_for_merchant_initiated

    # 01 - Recurring transaction 02 - Instalment transaction 03 - Add card 04 - Maintain card information 05 - Account verification 06 - Split/delayed shipment 07 - Top-up 08 - Mail Order 09 - Telephone Order 10 - Whitelist status check 11 - Other payment  Indicates the type of 3RI request. Values 06 - 11 are only supported in 3D2 2.2.0. 
    ...
    def self.attribute_map
      {
        ...
        :'use3ds_for_merchant_initiated' => :'use3dsForMerchantInitiated',
    ...
    def self.openapi_types
      {
        ...
        :'merchant_id' => :'',
        :'merchant_name' => :'',
        :'merchant_acquirer_bin_visa' => :'',
        :'merchant_acquirer_bin_mastercard' => :'',
        :'merchant_country' => :'',
        :'merchant_url' => :'',
        :'v1' => :'',
        :'v2' => :'',
        :'transaction_type' => :'',
        :'use3ds_for_merchant_initiated' => :'',
        :'three_ri_ind' => :''
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ThreeDSecureIO3dsServer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ThreeDSecureIO3dsServer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merchant_acquirer_bin_visa')
        self.merchant_acquirer_bin_visa = attributes[:'merchant_acquirer_bin_visa']
      end

      if attributes.key?(:'merchant_acquirer_bin_mastercard')
        self.merchant_acquirer_bin_mastercard = attributes[:'merchant_acquirer_bin_mastercard']
      end
      ...
      if attributes.key?(:'use3ds_for_merchant_initiated')
        self.use3ds_for_merchant_initiated = attributes[:'use3ds_for_merchant_initiated']
      else
        self.use3ds_for_merchant_initiated = false
      end

      if attributes.key?(:'three_ri_ind')
        self.three_ri_ind = attributes[:'three_ri_ind']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_acquirer_bin_visa.nil?
        invalid_properties.push('invalid value for "merchant_acquirer_bin_visa", merchant_acquirer_bin_visa cannot be nil.')
      end

      if @merchant_acquirer_bin_mastercard.nil?
        invalid_properties.push('invalid value for "merchant_acquirer_bin_mastercard", merchant_acquirer_bin_mastercard cannot be nil.')
      end

      if @merchant_country.nil?
        invalid_properties.push('invalid value for "merchant_country", merchant_country cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_acquirer_bin_visa.nil?
      return false if @merchant_acquirer_bin_mastercard.nil?
      return false if @merchant_country.nil?
      return false if @merchant_url.nil?
      transaction_type_validator = EnumAttributeValidator.new('', ['01', '03', '10', '11', '28'])
      return false unless transaction_type_validator.valid?(@transaction_type)
      three_ri_ind_validator = EnumAttributeValidator.new('', ['01', '02', '03', '04', '05', '06', '07', '8', '9', '10', '11'])
      return false unless three_ri_ind_validator.valid?(@three_ri_ind)
      true
    end
    ...
    def transaction_type=(transaction_type)
      validator = EnumAttributeValidator.new('', ['01', '03', '10', '11', '28'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] three_ri_ind Object to be assigned
    def three_ri_ind=(three_ri_ind)
      validator = EnumAttributeValidator.new('', ['01', '02', '03', '04', '05', '06', '07', '8', '9', '10', '11'])
      unless validator.valid?(three_ri_ind)
        fail ArgumentError, "invalid value for \"three_ri_ind\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          merchant_acquirer_bin_visa == o.merchant_acquirer_bin_visa &&
          merchant_acquirer_bin_mastercard == o.merchant_acquirer_bin_mastercard &&
          merchant_country == o.merchant_country &&
          merchant_url == o.merchant_url &&
          v1 == o.v1 &&
          v2 == o.v2 &&
          transaction_type == o.transaction_type &&
          use3ds_for_merchant_initiated == o.use3ds_for_merchant_initiated &&
          three_ri_ind == o.three_ri_ind && super(o)
    end
    ...
    def hash
      [name, merchant_id, merchant_name, merchant_acquirer_bin_visa, merchant_acquirer_bin_mastercard, merchant_country, merchant_url, v1, v2, transaction_type, use3ds_for_merchant_initiated, three_ri_ind].hash
    end
