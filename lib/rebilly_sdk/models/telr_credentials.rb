...
module RebillySdk
  # Telr credentials object.
  class TelrCredentials
    # Hosted payment page V2 store identifier.
    attr_accessor :store_id

    # Hosted payment page V2 authentication key.
    attr_accessor :hosted_page_authentication_key

    # Service API merchant identifier.
    ...
    def self.attribute_map
      {
        :'store_id' => :'storeId',
        :'hosted_page_authentication_key' => :'hostedPageAuthenticationKey',
    ...
    def self.openapi_types
      {
        :'store_id' => :'Object',
        :'hosted_page_authentication_key' => :'Object',
        :'merchant_id' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::TelrCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::TelrCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hosted_page_authentication_key')
        self.hosted_page_authentication_key = attributes[:'hosted_page_authentication_key']
      end
      ...
      if attributes.key?(:'service_api_key')
        self.service_api_key = attributes[:'service_api_key']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @hosted_page_authentication_key.nil?
        invalid_properties.push('invalid value for "hosted_page_authentication_key", hosted_page_authentication_key cannot be nil.')
      end
      ...
      if @service_api_key.nil?
        invalid_properties.push('invalid value for "service_api_key", service_api_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @hosted_page_authentication_key.nil?
      return false if @merchant_id.nil?
      return false if @service_api_key.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          store_id == o.store_id &&
          hosted_page_authentication_key == o.hosted_page_authentication_key &&
          merchant_id == o.merchant_id &&
          service_api_key == o.service_api_key
    end
    ...
    def hash
      [store_id, hosted_page_authentication_key, merchant_id, service_api_key].hash
    end
