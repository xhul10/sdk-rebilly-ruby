  ...
  class ChaseCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::ChaseCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::ChaseCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'co_number')
        self.co_number = attributes[:'co_number']
      end
      ...
      if attributes.key?(:'partial_auth')
    ...
    def list_invalid_properties
      ...
      if @co_number.nil?
        invalid_properties.push('invalid value for "co_number", co_number cannot be nil.')
      end
      ...
      if @partial_auth.nil?
        invalid_properties.push('invalid value for "partial_auth", partial_auth cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @co_number.nil?
      return false if @division_id.nil?
      return false if @partial_auth.nil?
      true
    end
    ...
    def hash
      [username, password, co_number, division_id, partial_auth].hash
    end
