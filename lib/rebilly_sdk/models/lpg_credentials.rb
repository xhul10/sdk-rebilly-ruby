...
module RebillySdk
  ...
  class LPGCredentials
    ...
    attr_accessor :payout_username

    # LPG payout account password.
    attr_accessor :payout_password
    ...
    def self.openapi_types
      {
        :'public_key' => :'Object',
        :'secure_key' => :'Object',
        :'payout_username' => :'Object',
        :'payout_password' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RebillySdk::LPGCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RebillySdk::LPGCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'secure_key')
        self.secure_key = attributes[:'secure_key']
      end

      if attributes.key?(:'payout_username')
        self.payout_username = attributes[:'payout_username']
      end

      if attributes.key?(:'payout_password')
        self.payout_password = attributes[:'payout_password']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @secure_key.nil?
        invalid_properties.push('invalid value for "secure_key", secure_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @secure_key.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          secure_key == o.secure_key &&
          payout_username == o.payout_username &&
          payout_password == o.payout_password
    end
    ...
    def hash
      [public_key, secure_key, payout_username, payout_password].hash
    end
