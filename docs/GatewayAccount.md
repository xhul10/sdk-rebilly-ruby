# RebillySdk::GatewayAccount

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**id** | [**AllOfGatewayAccountId**](AllOfGatewayAccountId.md) | The gateway identifier string. | [optional] 
**gateway_name** | [**GatewayName**](GatewayName.md) |  | 
**acquirer_name** | [**AllOfGatewayAccountAcquirerName**](AllOfGatewayAccountAcquirerName.md) |  | [optional] 
...
**created_time** | [**AllOfGatewayAccountCreatedTime**](AllOfGatewayAccountCreatedTime.md) | Gateway Account created time. | [optional] 
**updated_time** | [**AllOfGatewayAccountUpdatedTime**](AllOfGatewayAccountUpdatedTime.md) | Gateway Account updated time. | [optional] 
**organization_id** | [**AllOfGatewayAccountOrganizationId**](AllOfGatewayAccountOrganizationId.md) | Organization ID. | [optional] 
**_links** | [**Array&lt;AnyOfGatewayAccountLinksItems&gt;**](.md) | The links related to resource. | [optional] 
