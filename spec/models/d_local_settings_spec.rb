...
# Unit tests for RebillySdk::DLocalSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DLocalSettings' do
  before do
    # run before each test
    @instance = RebillySdk::DLocalSettings.new
  end
  ...
  describe 'test an instance of DLocalSettings' do
    it 'should create an instance of DLocalSettings' do
      expect(@instance).to be_instance_of(RebillySdk::DLocalSettings)
    end
  end
  describe 'test attribute "create_installment_plan"' do
    it 'should work' do
