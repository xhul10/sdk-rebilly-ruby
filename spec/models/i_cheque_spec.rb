...
# Unit tests for RebillySdk::ICheque
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICheque' do
  before do
    # run before each test
    @instance = RebillySdk::ICheque.new
  end
  ...
  describe 'test an instance of ICheque' do
    it 'should create an instance of ICheque' do
      expect(@instance).to be_instance_of(RebillySdk::ICheque)
    end
  end
