...
# Unit tests for RebillySdk::Redsys
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Redsys' do
  before do
    # run before each test
    @instance = RebillySdk::Redsys.new
  end
  ...
  describe 'test an instance of Redsys' do
    it 'should create an instance of Redsys' do
      expect(@instance).to be_instance_of(RebillySdk::Redsys)
    end
  end
