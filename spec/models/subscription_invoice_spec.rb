...
# Unit tests for RebillySdk::SubscriptionInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionInvoice' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionInvoice.new
  end
  ...
  describe 'test an instance of SubscriptionInvoice' do
    it 'should create an instance of SubscriptionInvoice' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionInvoice)
    end
  end
