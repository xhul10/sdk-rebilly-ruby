...
# Unit tests for RebillySdk::AllOfCommonTransaction3ds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonTransaction3ds' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonTransaction3ds.new
  end
  ...
  describe 'test an instance of AllOfCommonTransaction3ds' do
    it 'should create an instance of AllOfCommonTransaction3ds' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonTransaction3ds)
    end
  end
  ...
  describe 'test attribute "enrolled"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yes", "no", "invalid card/timeout", "unavailable"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.enrolled = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "authenticated"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yes", "no", "not applicable", "attempted"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.authenticated = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "liability"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["protected", "not protected", "protected (attempt)"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.liability = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "is_downgraded"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
