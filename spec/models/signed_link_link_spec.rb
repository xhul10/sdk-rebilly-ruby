...
# Unit tests for RebillySdk::SignedLinkLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignedLinkLink' do
  before do
    # run before each test
    @instance = RebillySdk::SignedLinkLink.new
  end
  ...
  describe 'test an instance of SignedLinkLink' do
    it 'should create an instance of SignedLinkLink' do
      expect(@instance).to be_instance_of(RebillySdk::SignedLinkLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["signedLink"])
