...
# Unit tests for RebillySdk::AllOfPayPalTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfPayPalTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfPayPalTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfPayPalTokenBillingAddress' do
    it 'should create an instance of AllOfPayPalTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfPayPalTokenBillingAddress)
    end
  end
