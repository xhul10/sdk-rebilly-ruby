...
# Unit tests for RebillySdk::PaymentAsiaCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentAsiaCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentAsiaCredentials.new
  end
  ...
  describe 'test an instance of PaymentAsiaCredentials' do
    it 'should create an instance of PaymentAsiaCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentAsiaCredentials)
    end
  end
