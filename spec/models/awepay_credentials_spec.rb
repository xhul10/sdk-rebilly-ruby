...
# Unit tests for RebillySdk::AwepayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwepayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AwepayCredentials.new
  end
  ...
  describe 'test an instance of AwepayCredentials' do
    it 'should create an instance of AwepayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AwepayCredentials)
    end
  end
