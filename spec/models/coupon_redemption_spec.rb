...
# Unit tests for RebillySdk::CouponRedemption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponRedemption' do
  before do
    # run before each test
    @instance = RebillySdk::CouponRedemption.new
  end
  ...
  describe 'test an instance of CouponRedemption' do
    it 'should create an instance of CouponRedemption' do
      expect(@instance).to be_instance_of(RebillySdk::CouponRedemption)
    end
  end
  ...
  describe 'test attribute "additional_restrictions"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
