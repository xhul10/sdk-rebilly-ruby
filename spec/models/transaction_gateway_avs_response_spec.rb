...
# Unit tests for RebillySdk::TransactionGatewayAvsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionGatewayAvsResponse' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionGatewayAvsResponse.new
  end
  ...
  describe 'test an instance of TransactionGatewayAvsResponse' do
    it 'should create an instance of TransactionGatewayAvsResponse' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionGatewayAvsResponse)
    end
  end
