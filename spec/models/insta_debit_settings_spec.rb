...
# Unit tests for RebillySdk::InstaDebitSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstaDebitSettings' do
  before do
    # run before each test
    @instance = RebillySdk::InstaDebitSettings.new
  end
  ...
  describe 'test an instance of InstaDebitSettings' do
    it 'should create an instance of InstaDebitSettings' do
      expect(@instance).to be_instance_of(RebillySdk::InstaDebitSettings)
    end
  end
