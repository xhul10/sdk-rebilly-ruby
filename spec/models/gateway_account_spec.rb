...
# Unit tests for RebillySdk::GatewayAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GatewayAccount' do
  before do
    # run before each test
    @instance = RebillySdk::GatewayAccount.new
  end
  ...
  describe 'test an instance of GatewayAccount' do
    it 'should create an instance of GatewayAccount' do
      expect(@instance).to be_instance_of(RebillySdk::GatewayAccount)
    end
  end
