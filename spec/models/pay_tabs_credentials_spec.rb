...
# Unit tests for RebillySdk::PayTabsCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayTabsCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayTabsCredentials.new
  end
  ...
  describe 'test an instance of PayTabsCredentials' do
    it 'should create an instance of PayTabsCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayTabsCredentials)
    end
  end
  ...
  describe 'test attribute "server_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
