...
# Unit tests for RebillySdk::AchPlaidFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AchPlaidFeature' do
  before do
    # run before each test
    @instance = RebillySdk::AchPlaidFeature.new
  end
  ...
  describe 'test an instance of AchPlaidFeature' do
    it 'should create an instance of AchPlaidFeature' do
      expect(@instance).to be_instance_of(RebillySdk::AchPlaidFeature)
    end
  end
