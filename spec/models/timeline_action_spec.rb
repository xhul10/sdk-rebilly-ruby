...
# Unit tests for RebillySdk::TimelineAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineAction' do
  before do
    # run before each test
    @instance = RebillySdk::TimelineAction.new
  end
  ...
  describe 'test an instance of TimelineAction' do
    it 'should create an instance of TimelineAction' do
      expect(@instance).to be_instance_of(RebillySdk::TimelineAction)
    end
  end
