...
# Unit tests for RebillySdk::CoinPaymentsCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoinPaymentsCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CoinPaymentsCredentials.new
  end
  ...
  describe 'test an instance of CoinPaymentsCredentials' do
    it 'should create an instance of CoinPaymentsCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CoinPaymentsCredentials)
    end
  end
  ...
  describe 'test attribute "ipn_secret"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
