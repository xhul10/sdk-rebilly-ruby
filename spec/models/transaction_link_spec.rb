...
# Unit tests for RebillySdk::TransactionLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionLink' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionLink.new
  end
  ...
  describe 'test an instance of TransactionLink' do
    it 'should create an instance of TransactionLink' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionLink)
    end
  end
