...
# Unit tests for RebillySdk::DynamicIpnLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DynamicIpnLink' do
  before do
    # run before each test
    @instance = RebillySdk::DynamicIpnLink.new
  end
  ...
  describe 'test an instance of DynamicIpnLink' do
    it 'should create an instance of DynamicIpnLink' do
      expect(@instance).to be_instance_of(RebillySdk::DynamicIpnLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["dynamicIpnUrl"])
