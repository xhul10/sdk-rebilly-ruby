...
# Unit tests for RebillySdk::DimocoCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DimocoCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::DimocoCredentials.new
  end
  ...
  describe 'test an instance of DimocoCredentials' do
    it 'should create an instance of DimocoCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::DimocoCredentials)
    end
  end
