...
# Unit tests for RebillySdk::UPayCardSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UPayCardSettings' do
  before do
    # run before each test
    @instance = RebillySdk::UPayCardSettings.new
  end
  ...
  describe 'test an instance of UPayCardSettings' do
    it 'should create an instance of UPayCardSettings' do
      expect(@instance).to be_instance_of(RebillySdk::UPayCardSettings)
    end
  end
