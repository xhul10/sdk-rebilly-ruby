...
# Unit tests for RebillySdk::UPayCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UPayCard' do
  before do
    # run before each test
    @instance = RebillySdk::UPayCard.new
  end
  ...
  describe 'test an instance of UPayCard' do
    it 'should create an instance of UPayCard' do
      expect(@instance).to be_instance_of(RebillySdk::UPayCard)
    end
  end
