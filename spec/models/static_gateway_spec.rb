...
# Unit tests for RebillySdk::StaticGateway
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticGateway' do
  before do
    # run before each test
    @instance = RebillySdk::StaticGateway.new
  end
  ...
  describe 'test an instance of StaticGateway' do
    it 'should create an instance of StaticGateway' do
      expect(@instance).to be_instance_of(RebillySdk::StaticGateway)
    end
  end
