...
# Unit tests for RebillySdk::RecentInvoiceEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecentInvoiceEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::RecentInvoiceEmbed.new
  end
  ...
  describe 'test an instance of RecentInvoiceEmbed' do
    it 'should create an instance of RecentInvoiceEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::RecentInvoiceEmbed)
    end
  end
  describe 'test attribute "recent_invoice"' do
    it 'should work' do
