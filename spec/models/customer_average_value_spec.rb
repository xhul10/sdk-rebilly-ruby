...
# Unit tests for RebillySdk::CustomerAverageValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerAverageValue' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerAverageValue.new
  end
  ...
  describe 'test an instance of CustomerAverageValue' do
    it 'should create an instance of CustomerAverageValue' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerAverageValue)
    end
  end
