...
# Unit tests for RebillySdk::DocumentedProblem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocumentedProblem' do
  before do
    # run before each test
    @instance = RebillySdk::DocumentedProblem.new
  end
  ...
  describe 'test an instance of DocumentedProblem' do
    it 'should create an instance of DocumentedProblem' do
      expect(@instance).to be_instance_of(RebillySdk::DocumentedProblem)
    end
  end
