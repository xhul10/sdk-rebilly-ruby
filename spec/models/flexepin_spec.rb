...
# Unit tests for RebillySdk::Flexepin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Flexepin' do
  before do
    # run before each test
    @instance = RebillySdk::Flexepin.new
  end
  ...
  describe 'test an instance of Flexepin' do
    it 'should create an instance of Flexepin' do
      expect(@instance).to be_instance_of(RebillySdk::Flexepin)
    end
  end
