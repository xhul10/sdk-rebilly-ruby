...
# Unit tests for RebillySdk::ToditoCash
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ToditoCash' do
  before do
    # run before each test
    @instance = RebillySdk::ToditoCash.new
  end
  ...
  describe 'test an instance of ToditoCash' do
    it 'should create an instance of ToditoCash' do
      expect(@instance).to be_instance_of(RebillySdk::ToditoCash)
    end
  end
