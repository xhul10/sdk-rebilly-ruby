...
# Unit tests for RebillySdk::OrganizationSettingsDefaultTaxCalculator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationSettingsDefaultTaxCalculator' do
  before do
    # run before each test
    @instance = RebillySdk::OrganizationSettingsDefaultTaxCalculator.new
  end
  ...
  describe 'test an instance of OrganizationSettingsDefaultTaxCalculator' do
    it 'should create an instance of OrganizationSettingsDefaultTaxCalculator' do
      expect(@instance).to be_instance_of(RebillySdk::OrganizationSettingsDefaultTaxCalculator)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["taxjar", "flat"])
