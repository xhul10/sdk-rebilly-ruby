...
# Unit tests for RebillySdk::RedemptionRestriction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedemptionRestriction' do
  before do
    # run before each test
    @instance = RebillySdk::RedemptionRestriction.new
  end
  ...
  describe 'test an instance of RedemptionRestriction' do
    it 'should create an instance of RedemptionRestriction' do
      expect(@instance).to be_instance_of(RebillySdk::RedemptionRestriction)
    end
  end
