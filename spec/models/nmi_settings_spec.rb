...
# Unit tests for RebillySdk::NMISettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NMISettings' do
  before do
    # run before each test
    @instance = RebillySdk::NMISettings.new
  end
  ...
  describe 'test an instance of NMISettings' do
    it 'should create an instance of NMISettings' do
      expect(@instance).to be_instance_of(RebillySdk::NMISettings)
    end
  end
  describe 'test attribute "disable_stored_credentials"' do
    it 'should work' do
