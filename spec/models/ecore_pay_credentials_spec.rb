...
# Unit tests for RebillySdk::EcorePayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EcorePayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EcorePayCredentials.new
  end
  ...
  describe 'test an instance of EcorePayCredentials' do
    it 'should create an instance of EcorePayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EcorePayCredentials)
    end
  end
  ...
  describe 'test attribute "account_auth"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
