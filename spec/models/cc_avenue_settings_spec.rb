...
# Unit tests for RebillySdk::CCAvenueSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CCAvenueSettings' do
  before do
    # run before each test
    @instance = RebillySdk::CCAvenueSettings.new
  end
  ...
  describe 'test an instance of CCAvenueSettings' do
    it 'should create an instance of CCAvenueSettings' do
      expect(@instance).to be_instance_of(RebillySdk::CCAvenueSettings)
    end
  end
  describe 'test attribute "use_standing_instruction_api"' do
    it 'should work' do
