...
# Unit tests for RebillySdk::GlobalOneCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GlobalOneCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::GlobalOneCredentials.new
  end
  ...
  describe 'test an instance of GlobalOneCredentials' do
    it 'should create an instance of GlobalOneCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::GlobalOneCredentials)
    end
  end
