...
# Unit tests for RebillySdk::AllOfTransactionBumpOfferSelectedOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfTransactionBumpOfferSelectedOffer' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfTransactionBumpOfferSelectedOffer.new
  end
  ...
  describe 'test an instance of AllOfTransactionBumpOfferSelectedOffer' do
    it 'should create an instance of AllOfTransactionBumpOfferSelectedOffer' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfTransactionBumpOfferSelectedOffer)
    end
  end
  ...
  describe 'test attribute "bump_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "bump_amount_in_usd"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
