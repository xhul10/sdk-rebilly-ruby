...
# Unit tests for RebillySdk::Cashflows
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Cashflows' do
  before do
    # run before each test
    @instance = RebillySdk::Cashflows.new
  end
  ...
  describe 'test an instance of Cashflows' do
    it 'should create an instance of Cashflows' do
      expect(@instance).to be_instance_of(RebillySdk::Cashflows)
    end
  end
