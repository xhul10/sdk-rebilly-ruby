...
# Unit tests for RebillySdk::WorldpaySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorldpaySettings' do
  before do
    # run before each test
    @instance = RebillySdk::WorldpaySettings.new
  end
  ...
  describe 'test an instance of WorldpaySettings' do
    it 'should create an instance of WorldpaySettings' do
      expect(@instance).to be_instance_of(RebillySdk::WorldpaySettings)
    end
  end
  ...
  describe 'test attribute "enable_stored_credentials"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "merchant_initiated_reason"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["UNSCHEDULED", "RECURRING", "INSTALMENT", "REAUTH", "DELAYED", "INCREMENTAL", "RESUBMISSION", "NOSHOW"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.merchant_initiated_reason = value }.not_to raise_error
      # end
    end
  end
