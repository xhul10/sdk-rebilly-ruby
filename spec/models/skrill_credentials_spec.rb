...
# Unit tests for RebillySdk::SkrillCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SkrillCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SkrillCredentials.new
  end
  ...
  describe 'test an instance of SkrillCredentials' do
    it 'should create an instance of SkrillCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SkrillCredentials)
    end
  end
  ...
  describe 'test attribute "mqi_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
