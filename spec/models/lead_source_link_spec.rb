...
# Unit tests for RebillySdk::LeadSourceLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LeadSourceLink' do
  before do
    # run before each test
    @instance = RebillySdk::LeadSourceLink.new
  end
  ...
  describe 'test an instance of LeadSourceLink' do
    it 'should create an instance of LeadSourceLink' do
      expect(@instance).to be_instance_of(RebillySdk::LeadSourceLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["leadSource"])
