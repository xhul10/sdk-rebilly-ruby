...
# Unit tests for RebillySdk::Ilixium
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ilixium' do
  before do
    # run before each test
    @instance = RebillySdk::Ilixium.new
  end
  ...
  describe 'test an instance of Ilixium' do
    it 'should create an instance of Ilixium' do
      expect(@instance).to be_instance_of(RebillySdk::Ilixium)
    end
  end
