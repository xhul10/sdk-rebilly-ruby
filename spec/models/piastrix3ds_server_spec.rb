...
# Unit tests for RebillySdk::Piastrix3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Piastrix3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Piastrix3dsServer.new
  end
  ...
  describe 'test an instance of Piastrix3dsServer' do
    it 'should create an instance of Piastrix3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Piastrix3dsServer)
    end
  end
