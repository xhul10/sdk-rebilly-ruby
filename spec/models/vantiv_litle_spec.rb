...
# Unit tests for RebillySdk::VantivLitle
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VantivLitle' do
  before do
    # run before each test
    @instance = RebillySdk::VantivLitle.new
  end
  ...
  describe 'test an instance of VantivLitle' do
    it 'should create an instance of VantivLitle' do
      expect(@instance).to be_instance_of(RebillySdk::VantivLitle)
    end
  end
