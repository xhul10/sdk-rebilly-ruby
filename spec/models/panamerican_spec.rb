...
# Unit tests for RebillySdk::Panamerican
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Panamerican' do
  before do
    # run before each test
    @instance = RebillySdk::Panamerican.new
  end
  ...
  describe 'test an instance of Panamerican' do
    it 'should create an instance of Panamerican' do
      expect(@instance).to be_instance_of(RebillySdk::Panamerican)
    end
  end
