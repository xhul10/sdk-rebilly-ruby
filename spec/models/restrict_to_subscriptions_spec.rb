...
# Unit tests for RebillySdk::RestrictToSubscriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestrictToSubscriptions' do
  before do
    # run before each test
    @instance = RebillySdk::RestrictToSubscriptions.new
  end
  ...
  describe 'test an instance of RestrictToSubscriptions' do
    it 'should create an instance of RestrictToSubscriptions' do
      expect(@instance).to be_instance_of(RebillySdk::RestrictToSubscriptions)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["discounts-per-redemption", "minimum-order-amount", "restrict-to-invoices", "restrict-to-plans", "restrict-to-subscriptions", "restrict-to-products", "paid-by-time"])
