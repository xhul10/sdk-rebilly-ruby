...
# Unit tests for RebillySdk::BamboraCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BamboraCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::BamboraCredentials.new
  end
  ...
  describe 'test an instance of BamboraCredentials' do
    it 'should create an instance of BamboraCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::BamboraCredentials)
    end
  end
  ...
  describe 'test attribute "api_passcode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
