...
# Unit tests for RebillySdk::EcoPayzCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EcoPayzCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EcoPayzCredentials.new
  end
  ...
  describe 'test an instance of EcoPayzCredentials' do
    it 'should create an instance of EcoPayzCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EcoPayzCredentials)
    end
  end
  describe 'test attribute "payment_page_id"' do
    it 'should work' do
