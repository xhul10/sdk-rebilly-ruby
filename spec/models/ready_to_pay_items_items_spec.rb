...
# Unit tests for RebillySdk::ReadyToPayItemsItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayItemsItems' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayItemsItems.new
  end
  ...
  describe 'test an instance of ReadyToPayItemsItems' do
    it 'should create an instance of ReadyToPayItemsItems' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayItemsItems)
    end
  end
