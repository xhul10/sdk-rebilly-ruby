...
# Unit tests for RebillySdk::DigitalWalletValidation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DigitalWalletValidation' do
  before do
    # run before each test
    @instance = RebillySdk::DigitalWalletValidation.new
  end
  ...
  describe 'test an instance of DigitalWalletValidation' do
    it 'should create an instance of DigitalWalletValidation' do
      expect(@instance).to be_instance_of(RebillySdk::DigitalWalletValidation)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Apple Pay"])
