...
# Unit tests for RebillySdk::SmartInvoice3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartInvoice3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::SmartInvoice3dsServer.new
  end
  ...
  describe 'test an instance of SmartInvoice3dsServer' do
    it 'should create an instance of SmartInvoice3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::SmartInvoice3dsServer)
    end
  end
