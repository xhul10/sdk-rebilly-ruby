...
# Unit tests for RebillySdk::TransactionAllocationsLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionAllocationsLink' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionAllocationsLink.new
  end
  ...
  describe 'test an instance of TransactionAllocationsLink' do
    it 'should create an instance of TransactionAllocationsLink' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionAllocationsLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["transactionAllocations"])
