...
# Unit tests for RebillySdk::TwoColumns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TwoColumns' do
  before do
    # run before each test
    @instance = RebillySdk::TwoColumns.new
  end
  ...
  describe 'test an instance of TwoColumns' do
    it 'should create an instance of TwoColumns' do
      expect(@instance).to be_instance_of(RebillySdk::TwoColumns)
    end
  end
