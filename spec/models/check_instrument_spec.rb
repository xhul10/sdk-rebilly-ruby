...
# Unit tests for RebillySdk::CheckInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CheckInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::CheckInstrument.new
  end
  ...
  describe 'test an instance of CheckInstrument' do
    it 'should create an instance of CheckInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::CheckInstrument)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cash"])
