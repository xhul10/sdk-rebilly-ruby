...
# Unit tests for RebillySdk::WorldlineAtosFrankfurt3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorldlineAtosFrankfurt3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::WorldlineAtosFrankfurt3dsServers.new
  end
  ...
  describe 'test an instance of WorldlineAtosFrankfurt3dsServers' do
    it 'should create an instance of WorldlineAtosFrankfurt3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::WorldlineAtosFrankfurt3dsServers)
    end
  end
