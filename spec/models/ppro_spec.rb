...
# Unit tests for RebillySdk::PPRO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PPRO' do
  before do
    # run before each test
    @instance = RebillySdk::PPRO.new
  end
  ...
  describe 'test an instance of PPRO' do
    it 'should create an instance of PPRO' do
      expect(@instance).to be_instance_of(RebillySdk::PPRO)
    end
  end
