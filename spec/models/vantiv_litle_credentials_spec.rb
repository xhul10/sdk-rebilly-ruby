...
# Unit tests for RebillySdk::VantivLitleCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VantivLitleCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::VantivLitleCredentials.new
  end
  ...
  describe 'test an instance of VantivLitleCredentials' do
    it 'should create an instance of VantivLitleCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::VantivLitleCredentials)
    end
  end
