...
# Unit tests for RebillySdk::AllOfTransactionDccBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfTransactionDccBase' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfTransactionDccBase.new
  end
  ...
  describe 'test an instance of AllOfTransactionDccBase' do
    it 'should create an instance of AllOfTransactionDccBase' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfTransactionDccBase)
    end
  end
