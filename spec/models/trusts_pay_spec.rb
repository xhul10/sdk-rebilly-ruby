...
# Unit tests for RebillySdk::TrustsPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustsPay' do
  before do
    # run before each test
    @instance = RebillySdk::TrustsPay.new
  end
  ...
  describe 'test an instance of TrustsPay' do
    it 'should create an instance of TrustsPay' do
      expect(@instance).to be_instance_of(RebillySdk::TrustsPay)
    end
  end
