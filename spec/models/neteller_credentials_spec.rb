...
# Unit tests for RebillySdk::NetellerCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetellerCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::NetellerCredentials.new
  end
  ...
  describe 'test an instance of NetellerCredentials' do
    it 'should create an instance of NetellerCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::NetellerCredentials)
    end
  end
  describe 'test attribute "paysafe_payments_api_username"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "paysafe_payments_api_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
