...
# Unit tests for RebillySdk::FinTecSystemsSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinTecSystemsSettings' do
  before do
    # run before each test
    @instance = RebillySdk::FinTecSystemsSettings.new
  end
  ...
  describe 'test an instance of FinTecSystemsSettings' do
    it 'should create an instance of FinTecSystemsSettings' do
      expect(@instance).to be_instance_of(RebillySdk::FinTecSystemsSettings)
    end
  end
  ...
  describe 'test attribute "recipient_country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["AT", "CH", "DE"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.recipient_country = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "recipient_holder"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
