...
# Unit tests for RebillySdk::JetonCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JetonCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::JetonCredentials.new
  end
  ...
  describe 'test an instance of JetonCredentials' do
    it 'should create an instance of JetonCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::JetonCredentials)
    end
  end
