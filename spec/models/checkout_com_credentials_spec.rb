...
# Unit tests for RebillySdk::CheckoutComCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CheckoutComCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CheckoutComCredentials.new
  end
  ...
  describe 'test an instance of CheckoutComCredentials' do
    it 'should create an instance of CheckoutComCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CheckoutComCredentials)
    end
  end
