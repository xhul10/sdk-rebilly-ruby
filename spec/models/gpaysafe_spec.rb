...
# Unit tests for RebillySdk::Gpaysafe
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Gpaysafe' do
  before do
    # run before each test
    @instance = RebillySdk::Gpaysafe.new
  end
  ...
  describe 'test an instance of Gpaysafe' do
    it 'should create an instance of Gpaysafe' do
      expect(@instance).to be_instance_of(RebillySdk::Gpaysafe)
    end
  end
