...
# Unit tests for RebillySdk::Ilixium3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ilixium3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Ilixium3dsServer.new
  end
  ...
  describe 'test an instance of Ilixium3dsServer' do
    it 'should create an instance of Ilixium3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Ilixium3dsServer)
    end
  end
