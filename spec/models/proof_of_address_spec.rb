...
# Unit tests for RebillySdk::ProofOfAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfAddress' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfAddress.new
  end
  ...
  describe 'test an instance of ProofOfAddress' do
    it 'should create an instance of ProofOfAddress' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfAddress)
    end
  end
