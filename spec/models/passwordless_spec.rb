...
# Unit tests for RebillySdk::Passwordless
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Passwordless' do
  before do
    # run before each test
    @instance = RebillySdk::Passwordless.new
  end
  ...
  describe 'test an instance of Passwordless' do
    it 'should create an instance of Passwordless' do
      expect(@instance).to be_instance_of(RebillySdk::Passwordless)
    end
  end
  describe 'test attribute "expired_time"' do
    it 'should work' do
  ...
  describe 'test attribute "mode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["password", "passwordless"])
