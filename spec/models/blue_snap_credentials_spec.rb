...
# Unit tests for RebillySdk::BlueSnapCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlueSnapCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::BlueSnapCredentials.new
  end
  ...
  describe 'test an instance of BlueSnapCredentials' do
    it 'should create an instance of BlueSnapCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::BlueSnapCredentials)
    end
  end
  ...
  describe 'test attribute "data_protection_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
