...
# Unit tests for RebillySdk::TransactionUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionUpdate' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionUpdate.new
  end
  ...
  describe 'test an instance of TransactionUpdate' do
    it 'should create an instance of TransactionUpdate' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionUpdate)
    end
  end
  describe 'test attribute "result"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["abandoned", "approved", "canceled", "declined"])
