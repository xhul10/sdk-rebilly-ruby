...
# Unit tests for RebillySdk::Ingenico
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ingenico' do
  before do
    # run before each test
    @instance = RebillySdk::Ingenico.new
  end
  ...
  describe 'test an instance of Ingenico' do
    it 'should create an instance of Ingenico' do
      expect(@instance).to be_instance_of(RebillySdk::Ingenico)
    end
  end
