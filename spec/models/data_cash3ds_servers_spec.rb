...
# Unit tests for RebillySdk::DataCash3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataCash3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::DataCash3dsServers.new
  end
  ...
  describe 'test an instance of DataCash3dsServers' do
    it 'should create an instance of DataCash3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::DataCash3dsServers)
    end
  end
