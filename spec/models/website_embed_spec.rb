...
# Unit tests for RebillySdk::WebsiteEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebsiteEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::WebsiteEmbed.new
  end
  ...
  describe 'test an instance of WebsiteEmbed' do
    it 'should create an instance of WebsiteEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::WebsiteEmbed)
    end
  end
