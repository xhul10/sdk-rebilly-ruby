...
# Unit tests for RebillySdk::InvoicesLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicesLink' do
  before do
    # run before each test
    @instance = RebillySdk::InvoicesLink.new
  end
  ...
  describe 'test an instance of InvoicesLink' do
    it 'should create an instance of InvoicesLink' do
      expect(@instance).to be_instance_of(RebillySdk::InvoicesLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invoices"])
