...
# Unit tests for RebillySdk::AsiaPaymentGatewayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AsiaPaymentGatewayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AsiaPaymentGatewayCredentials.new
  end
  ...
  describe 'test an instance of AsiaPaymentGatewayCredentials' do
    it 'should create an instance of AsiaPaymentGatewayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AsiaPaymentGatewayCredentials)
    end
  end
