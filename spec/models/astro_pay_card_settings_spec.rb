...
# Unit tests for RebillySdk::AstroPayCardSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AstroPayCardSettings' do
  before do
    # run before each test
    @instance = RebillySdk::AstroPayCardSettings.new
  end
  ...
  describe 'test an instance of AstroPayCardSettings' do
    it 'should create an instance of AstroPayCardSettings' do
      expect(@instance).to be_instance_of(RebillySdk::AstroPayCardSettings)
    end
  end
  describe 'test attribute "one_touch_api"' do
    it 'should work' do
  ...
  describe 'test attribute "merchant_logo_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
