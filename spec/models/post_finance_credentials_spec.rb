...
# Unit tests for RebillySdk::PostFinanceCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostFinanceCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PostFinanceCredentials.new
  end
  ...
  describe 'test an instance of PostFinanceCredentials' do
    it 'should create an instance of PostFinanceCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PostFinanceCredentials)
    end
  end
  describe 'test attribute "psp_id"' do
    it 'should work' do
  ...
  describe 'test attribute "sftp_key_passphrase"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
