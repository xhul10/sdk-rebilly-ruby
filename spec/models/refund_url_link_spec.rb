...
# Unit tests for RebillySdk::RefundUrlLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundUrlLink' do
  before do
    # run before each test
    @instance = RebillySdk::RefundUrlLink.new
  end
  ...
  describe 'test an instance of RefundUrlLink' do
    it 'should create an instance of RefundUrlLink' do
      expect(@instance).to be_instance_of(RebillySdk::RefundUrlLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["refundUrl"])
