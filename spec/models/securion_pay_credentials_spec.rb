...
# Unit tests for RebillySdk::SecurionPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecurionPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SecurionPayCredentials.new
  end
  ...
  describe 'test an instance of SecurionPayCredentials' do
    it 'should create an instance of SecurionPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SecurionPayCredentials)
    end
  end
  describe 'test attribute "secret_api_key"' do
    it 'should work' do
