...
# Unit tests for RebillySdk::ProofOfAddressDocumentMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfAddressDocumentMatches' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfAddressDocumentMatches.new
  end
  ...
  describe 'test an instance of ProofOfAddressDocumentMatches' do
    it 'should create an instance of ProofOfAddressDocumentMatches' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfAddressDocumentMatches)
    end
  end
