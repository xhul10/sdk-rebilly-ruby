...
# Unit tests for RebillySdk::FullPaymentCardToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FullPaymentCardToken' do
  before do
    # run before each test
    @instance = RebillySdk::FullPaymentCardToken.new
  end
  ...
  describe 'test an instance of FullPaymentCardToken' do
    it 'should create an instance of FullPaymentCardToken' do
      expect(@instance).to be_instance_of(RebillySdk::FullPaymentCardToken)
    end
  end
