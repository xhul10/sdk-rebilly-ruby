...
# Unit tests for RebillySdk::SaltarPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SaltarPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SaltarPayCredentials.new
  end
  ...
  describe 'test an instance of SaltarPayCredentials' do
    it 'should create an instance of SaltarPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SaltarPayCredentials)
    end
  end
