...
# Unit tests for RebillySdk::VCreditosCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VCreditosCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::VCreditosCredentials.new
  end
  ...
  describe 'test an instance of VCreditosCredentials' do
    it 'should create an instance of VCreditosCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::VCreditosCredentials)
    end
  end
