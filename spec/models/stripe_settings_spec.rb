...
# Unit tests for RebillySdk::StripeSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StripeSettings' do
  before do
    # run before each test
    @instance = RebillySdk::StripeSettings.new
  end
  ...
  describe 'test an instance of StripeSettings' do
    it 'should create an instance of StripeSettings' do
      expect(@instance).to be_instance_of(RebillySdk::StripeSettings)
    end
  end
  ...
  describe 'test attribute "disable_payment_intents"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "enforce_off_session"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "copy_credentials_from"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
