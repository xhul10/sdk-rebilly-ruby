...
# Unit tests for RebillySdk::PlanPriceFormula
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanPriceFormula' do
  before do
    # run before each test
    @instance = RebillySdk::PlanPriceFormula.new
  end
  ...
  describe 'test an instance of PlanPriceFormula' do
    it 'should create an instance of PlanPriceFormula' do
      expect(@instance).to be_instance_of(RebillySdk::PlanPriceFormula)
    end
  end
  describe 'test attribute "formula"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fixed-fee", "flat-rate", "stairstep", "tiered", "volume"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.formula = value }.not_to raise_error
      # end
    end
  end
