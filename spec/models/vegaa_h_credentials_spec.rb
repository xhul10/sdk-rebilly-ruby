...
# Unit tests for RebillySdk::VegaaHCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VegaaHCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::VegaaHCredentials.new
  end
  ...
  describe 'test an instance of VegaaHCredentials' do
    it 'should create an instance of VegaaHCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::VegaaHCredentials)
    end
  end
