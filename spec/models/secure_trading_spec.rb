...
# Unit tests for RebillySdk::SecureTrading
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecureTrading' do
  before do
    # run before each test
    @instance = RebillySdk::SecureTrading.new
  end
  ...
  describe 'test an instance of SecureTrading' do
    it 'should create an instance of SecureTrading' do
      expect(@instance).to be_instance_of(RebillySdk::SecureTrading)
    end
  end
