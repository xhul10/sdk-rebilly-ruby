...
# Unit tests for RebillySdk::Credorax
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Credorax' do
  before do
    # run before each test
    @instance = RebillySdk::Credorax.new
  end
  ...
  describe 'test an instance of Credorax' do
    it 'should create an instance of Credorax' do
      expect(@instance).to be_instance_of(RebillySdk::Credorax)
    end
  end
