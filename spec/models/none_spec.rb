...
# Unit tests for RebillySdk::None
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'None' do
  before do
    # run before each test
    @instance = RebillySdk::None.new
  end
  ...
  describe 'test an instance of None' do
    it 'should create an instance of None' do
      expect(@instance).to be_instance_of(RebillySdk::None)
    end
  end
