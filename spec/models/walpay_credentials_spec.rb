...
# Unit tests for RebillySdk::WalpayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WalpayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::WalpayCredentials.new
  end
  ...
  describe 'test an instance of WalpayCredentials' do
    it 'should create an instance of WalpayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::WalpayCredentials)
    end
  end
  ...
  describe 'test attribute "merchant_pin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
