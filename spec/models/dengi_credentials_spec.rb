...
# Unit tests for RebillySdk::DengiCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DengiCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::DengiCredentials.new
  end
  ...
  describe 'test an instance of DengiCredentials' do
    it 'should create an instance of DengiCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::DengiCredentials)
    end
  end
  ...
  describe 'test attribute "refund_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
