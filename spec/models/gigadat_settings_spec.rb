...
# Unit tests for RebillySdk::GigadatSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GigadatSettings' do
  before do
    # run before each test
    @instance = RebillySdk::GigadatSettings.new
  end
  ...
  describe 'test an instance of GigadatSettings' do
    it 'should create an instance of GigadatSettings' do
      expect(@instance).to be_instance_of(RebillySdk::GigadatSettings)
    end
  end
