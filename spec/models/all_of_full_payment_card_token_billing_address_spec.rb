...
# Unit tests for RebillySdk::AllOfFullPaymentCardTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfFullPaymentCardTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfFullPaymentCardTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfFullPaymentCardTokenBillingAddress' do
    it 'should create an instance of AllOfFullPaymentCardTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfFullPaymentCardTokenBillingAddress)
    end
  end
