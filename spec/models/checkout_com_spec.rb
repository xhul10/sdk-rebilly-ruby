...
# Unit tests for RebillySdk::CheckoutCom
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CheckoutCom' do
  before do
    # run before each test
    @instance = RebillySdk::CheckoutCom.new
  end
  ...
  describe 'test an instance of CheckoutCom' do
    it 'should create an instance of CheckoutCom' do
      expect(@instance).to be_instance_of(RebillySdk::CheckoutCom)
    end
  end
