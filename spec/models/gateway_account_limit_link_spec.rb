...
# Unit tests for RebillySdk::GatewayAccountLimitLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GatewayAccountLimitLink' do
  before do
    # run before each test
    @instance = RebillySdk::GatewayAccountLimitLink.new
  end
  ...
  describe 'test an instance of GatewayAccountLimitLink' do
    it 'should create an instance of GatewayAccountLimitLink' do
      expect(@instance).to be_instance_of(RebillySdk::GatewayAccountLimitLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["gatewayAccountLimit"])
