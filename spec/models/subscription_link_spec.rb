...
# Unit tests for RebillySdk::SubscriptionLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionLink' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionLink.new
  end
  ...
  describe 'test an instance of SubscriptionLink' do
    it 'should create an instance of SubscriptionLink' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionLink)
    end
  end
