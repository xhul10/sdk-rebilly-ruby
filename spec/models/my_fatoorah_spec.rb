...
# Unit tests for RebillySdk::MyFatoorah
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MyFatoorah' do
  before do
    # run before each test
    @instance = RebillySdk::MyFatoorah.new
  end
  ...
  describe 'test an instance of MyFatoorah' do
    it 'should create an instance of MyFatoorah' do
      expect(@instance).to be_instance_of(RebillySdk::MyFatoorah)
    end
  end
