...
# Unit tests for RebillySdk::DiscountAmountRemaining
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DiscountAmountRemaining' do
  before do
    # run before each test
    @instance = RebillySdk::DiscountAmountRemaining.new
  end
  ...
  describe 'test an instance of DiscountAmountRemaining' do
    it 'should create an instance of DiscountAmountRemaining' do
      expect(@instance).to be_instance_of(RebillySdk::DiscountAmountRemaining)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["discount-amount-remaining"])
