...
# Unit tests for RebillySdk::TransactionDcc
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionDcc' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionDcc.new
  end
  ...
  describe 'test an instance of TransactionDcc' do
    it 'should create an instance of TransactionDcc' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionDcc)
    end
  end
  ...
  describe 'test attribute "usd_markup"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "outcome"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["rejected", "selected", "unknown"])
