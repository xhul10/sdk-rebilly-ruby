...
# Unit tests for RebillySdk::SeamlessChexCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SeamlessChexCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SeamlessChexCredentials.new
  end
  ...
  describe 'test an instance of SeamlessChexCredentials' do
    it 'should create an instance of SeamlessChexCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SeamlessChexCredentials)
    end
  end
