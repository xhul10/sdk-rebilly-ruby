...
# Unit tests for RebillySdk::Panamerican3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Panamerican3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Panamerican3dsServers.new
  end
  ...
  describe 'test an instance of Panamerican3dsServers' do
    it 'should create an instance of Panamerican3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Panamerican3dsServers)
    end
  end
