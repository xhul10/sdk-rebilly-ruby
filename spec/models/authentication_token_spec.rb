...
# Unit tests for RebillySdk::AuthenticationToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthenticationToken' do
  before do
    # run before each test
    @instance = RebillySdk::AuthenticationToken.new
  end
  ...
  describe 'test an instance of AuthenticationToken' do
    it 'should create an instance of AuthenticationToken' do
      expect(@instance).to be_instance_of(RebillySdk::AuthenticationToken)
    end
  end
