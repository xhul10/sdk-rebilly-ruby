...
# Unit tests for RebillySdk::Payvision
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Payvision' do
  before do
    # run before each test
    @instance = RebillySdk::Payvision.new
  end
  ...
  describe 'test an instance of Payvision' do
    it 'should create an instance of Payvision' do
      expect(@instance).to be_instance_of(RebillySdk::Payvision)
    end
  end
