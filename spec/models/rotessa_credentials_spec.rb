...
# Unit tests for RebillySdk::RotessaCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RotessaCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::RotessaCredentials.new
  end
  ...
  describe 'test an instance of RotessaCredentials' do
    it 'should create an instance of RotessaCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::RotessaCredentials)
    end
  end
