...
# Unit tests for RebillySdk::Khelocard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Khelocard' do
  before do
    # run before each test
    @instance = RebillySdk::Khelocard.new
  end
  ...
  describe 'test an instance of Khelocard' do
    it 'should create an instance of Khelocard' do
      expect(@instance).to be_instance_of(RebillySdk::Khelocard)
    end
  end
