...
# Unit tests for RebillySdk::AuthenticationTokenMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthenticationTokenMetadata' do
  before do
    # run before each test
    @instance = RebillySdk::AuthenticationTokenMetadata.new
  end
  ...
  describe 'test an instance of AuthenticationTokenMetadata' do
    it 'should create an instance of AuthenticationTokenMetadata' do
      expect(@instance).to be_instance_of(RebillySdk::AuthenticationTokenMetadata)
    end
  end
