...
# Unit tests for RebillySdk::CashInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CashInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::CashInstrument.new
  end
  ...
  describe 'test an instance of CashInstrument' do
    it 'should create an instance of CashInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::CashInstrument)
    end
  end
