...
# Unit tests for RebillySdk::ICanPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICanPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ICanPayCredentials.new
  end
  ...
  describe 'test an instance of ICanPayCredentials' do
    it 'should create an instance of ICanPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ICanPayCredentials)
    end
  end
