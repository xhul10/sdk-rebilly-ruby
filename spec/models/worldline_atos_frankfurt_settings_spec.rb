...
# Unit tests for RebillySdk::WorldlineAtosFrankfurtSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorldlineAtosFrankfurtSettings' do
  before do
    # run before each test
    @instance = RebillySdk::WorldlineAtosFrankfurtSettings.new
  end
  ...
  describe 'test an instance of WorldlineAtosFrankfurtSettings' do
    it 'should create an instance of WorldlineAtosFrankfurtSettings' do
      expect(@instance).to be_instance_of(RebillySdk::WorldlineAtosFrankfurtSettings)
    end
  end
  describe 'test attribute "card_acceptor_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "card_acceptor_location"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "card_acceptor_country_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
