...
# Unit tests for RebillySdk::FinraxCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinraxCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::FinraxCredentials.new
  end
  ...
  describe 'test an instance of FinraxCredentials' do
    it 'should create an instance of FinraxCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::FinraxCredentials)
    end
  end
