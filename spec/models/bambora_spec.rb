...
# Unit tests for RebillySdk::Bambora
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Bambora' do
  before do
    # run before each test
    @instance = RebillySdk::Bambora.new
  end
  ...
  describe 'test an instance of Bambora' do
    it 'should create an instance of Bambora' do
      expect(@instance).to be_instance_of(RebillySdk::Bambora)
    end
  end
