...
# Unit tests for RebillySdk::PandaGateway
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PandaGateway' do
  before do
    # run before each test
    @instance = RebillySdk::PandaGateway.new
  end
  ...
  describe 'test an instance of PandaGateway' do
    it 'should create an instance of PandaGateway' do
      expect(@instance).to be_instance_of(RebillySdk::PandaGateway)
    end
  end
