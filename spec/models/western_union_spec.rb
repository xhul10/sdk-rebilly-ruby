...
# Unit tests for RebillySdk::WesternUnion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WesternUnion' do
  before do
    # run before each test
    @instance = RebillySdk::WesternUnion.new
  end
  ...
  describe 'test an instance of WesternUnion' do
    it 'should create an instance of WesternUnion' do
      expect(@instance).to be_instance_of(RebillySdk::WesternUnion)
    end
  end
