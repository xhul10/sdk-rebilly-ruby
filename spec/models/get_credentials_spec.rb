...
# Unit tests for RebillySdk::GETCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::GETCredentials.new
  end
  ...
  describe 'test an instance of GETCredentials' do
    it 'should create an instance of GETCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::GETCredentials)
    end
  end
