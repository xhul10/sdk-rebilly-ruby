...
# Unit tests for RebillySdk::PostFinance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostFinance' do
  before do
    # run before each test
    @instance = RebillySdk::PostFinance.new
  end
  ...
  describe 'test an instance of PostFinance' do
    it 'should create an instance of PostFinance' do
      expect(@instance).to be_instance_of(RebillySdk::PostFinance)
    end
  end
