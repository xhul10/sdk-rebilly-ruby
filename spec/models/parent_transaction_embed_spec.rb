...
# Unit tests for RebillySdk::ParentTransactionEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParentTransactionEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::ParentTransactionEmbed.new
  end
  ...
  describe 'test an instance of ParentTransactionEmbed' do
    it 'should create an instance of ParentTransactionEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::ParentTransactionEmbed)
    end
  end
  describe 'test attribute "parent_transaction"' do
    it 'should work' do
