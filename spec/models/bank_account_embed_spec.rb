...
# Unit tests for RebillySdk::BankAccountEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankAccountEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::BankAccountEmbed.new
  end
  ...
  describe 'test an instance of BankAccountEmbed' do
    it 'should create an instance of BankAccountEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::BankAccountEmbed)
    end
  end
