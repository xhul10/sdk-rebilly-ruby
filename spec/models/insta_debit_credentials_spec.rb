...
# Unit tests for RebillySdk::InstaDebitCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstaDebitCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::InstaDebitCredentials.new
  end
  ...
  describe 'test an instance of InstaDebitCredentials' do
    it 'should create an instance of InstaDebitCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::InstaDebitCredentials)
    end
  end
