...
# Unit tests for RebillySdk::ApcoPaySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApcoPaySettings' do
  before do
    # run before each test
    @instance = RebillySdk::ApcoPaySettings.new
  end
  ...
  describe 'test an instance of ApcoPaySettings' do
    it 'should create an instance of ApcoPaySettings' do
      expect(@instance).to be_instance_of(RebillySdk::ApcoPaySettings)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["AFTERPAY", "BANCONTACT", "CREDITCLICK", "FLEXEPIN", "IDEAL", "JPAY", "OCTAPAY", "ONLINEUBERWEISEN", "ORIENTALWALLET", "VENUSPOINT", "ZIMPLER"])
