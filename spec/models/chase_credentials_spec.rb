...
# Unit tests for RebillySdk::ChaseCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChaseCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ChaseCredentials.new
  end
  ...
  describe 'test an instance of ChaseCredentials' do
    it 'should create an instance of ChaseCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ChaseCredentials)
    end
  end
  ...
  describe 'test attribute "co_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
