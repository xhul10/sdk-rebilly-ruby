...
# Unit tests for RebillySdk::TransactionQuery
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionQuery' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionQuery.new
  end
  ...
  describe 'test an instance of TransactionQuery' do
    it 'should create an instance of TransactionQuery' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionQuery)
    end
  end
