...
# Unit tests for RebillySdk::AllOfPartialPaymentCardTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfPartialPaymentCardTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfPartialPaymentCardTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfPartialPaymentCardTokenBillingAddress' do
    it 'should create an instance of AllOfPartialPaymentCardTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfPartialPaymentCardTokenBillingAddress)
    end
  end
