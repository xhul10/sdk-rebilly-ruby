...
# Unit tests for RebillySdk::PaymentsOSCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentsOSCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentsOSCredentials.new
  end
  ...
  describe 'test an instance of PaymentsOSCredentials' do
    it 'should create an instance of PaymentsOSCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentsOSCredentials)
    end
  end
