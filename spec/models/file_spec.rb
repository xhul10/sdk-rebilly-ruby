...
# Unit tests for RebillySdk::File
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'File' do
  before do
    # run before each test
    @instance = RebillySdk::File.new
  end
  ...
  describe 'test an instance of File' do
    it 'should create an instance of File' do
      expect(@instance).to be_instance_of(RebillySdk::File)
    end
  end
  ...
  describe 'test attribute "mime"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["image/png", "image/jpeg", "image/gif", "application/pdf", "audio/mpeg"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.mime = value }.not_to raise_error
      # end
    end
  end
