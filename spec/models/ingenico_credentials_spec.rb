...
# Unit tests for RebillySdk::IngenicoCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IngenicoCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::IngenicoCredentials.new
  end
  ...
  describe 'test an instance of IngenicoCredentials' do
    it 'should create an instance of IngenicoCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::IngenicoCredentials)
    end
  end
  ...
  describe 'test attribute "api_secret_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "skip_fraud_service"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
