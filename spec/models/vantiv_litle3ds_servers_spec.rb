...
# Unit tests for RebillySdk::VantivLitle3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VantivLitle3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::VantivLitle3dsServers.new
  end
  ...
  describe 'test an instance of VantivLitle3dsServers' do
    it 'should create an instance of VantivLitle3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::VantivLitle3dsServers)
    end
  end
