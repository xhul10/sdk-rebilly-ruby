...
# Unit tests for RebillySdk::SubscriptionChange
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionChange' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionChange.new
  end
  ...
  describe 'test an instance of SubscriptionChange' do
    it 'should create an instance of SubscriptionChange' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionChange)
    end
  end
  ...
  describe 'test attribute "renewal_policy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["reset", "retain"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.renewal_policy = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "keep_trial"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
