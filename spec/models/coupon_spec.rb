...
# Unit tests for RebillySdk::Coupon
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Coupon' do
  before do
    # run before each test
    @instance = RebillySdk::Coupon.new
  end
  ...
  describe 'test an instance of Coupon' do
    it 'should create an instance of Coupon' do
      expect(@instance).to be_instance_of(RebillySdk::Coupon)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["draft", "issued", "expired"])
