...
# Unit tests for RebillySdk::SagepayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SagepayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SagepayCredentials.new
  end
  ...
  describe 'test an instance of SagepayCredentials' do
    it 'should create an instance of SagepayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SagepayCredentials)
    end
  end
  describe 'test attribute "m_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "m_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
