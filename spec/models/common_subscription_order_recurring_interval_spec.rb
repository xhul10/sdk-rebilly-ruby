...
# Unit tests for RebillySdk::CommonSubscriptionOrderRecurringInterval
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonSubscriptionOrderRecurringInterval' do
  before do
    # run before each test
    @instance = RebillySdk::CommonSubscriptionOrderRecurringInterval.new
  end
  ...
  describe 'test an instance of CommonSubscriptionOrderRecurringInterval' do
    it 'should create an instance of CommonSubscriptionOrderRecurringInterval' do
      expect(@instance).to be_instance_of(RebillySdk::CommonSubscriptionOrderRecurringInterval)
    end
  end
  describe 'test attribute "period_anchor_instruction"' do
    it 'should work' do
