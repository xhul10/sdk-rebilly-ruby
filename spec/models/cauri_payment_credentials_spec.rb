...
# Unit tests for RebillySdk::CauriPaymentCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CauriPaymentCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CauriPaymentCredentials.new
  end
  ...
  describe 'test an instance of CauriPaymentCredentials' do
    it 'should create an instance of CauriPaymentCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CauriPaymentCredentials)
    end
  end
