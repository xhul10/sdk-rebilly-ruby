...
# Unit tests for RebillySdk::XPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::XPayCredentials.new
  end
  ...
  describe 'test an instance of XPayCredentials' do
    it 'should create an instance of XPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::XPayCredentials)
    end
  end
