...
# Unit tests for RebillySdk::KycDocumentRejection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycDocumentRejection' do
  before do
    # run before each test
    @instance = RebillySdk::KycDocumentRejection.new
  end
  ...
  describe 'test an instance of KycDocumentRejection' do
    it 'should create an instance of KycDocumentRejection' do
      expect(@instance).to be_instance_of(RebillySdk::KycDocumentRejection)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["document-unreadable", "document-expired", "document-not-matching", "underage-person", "other"])
