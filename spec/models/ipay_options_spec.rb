...
# Unit tests for RebillySdk::IpayOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpayOptions' do
  before do
    # run before each test
    @instance = RebillySdk::IpayOptions.new
  end
  ...
  describe 'test an instance of IpayOptions' do
    it 'should create an instance of IpayOptions' do
      expect(@instance).to be_instance_of(RebillySdk::IpayOptions)
    end
  end
