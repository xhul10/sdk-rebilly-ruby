...
# Unit tests for RebillySdk::PartialPaymentCardTokenPaymentInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartialPaymentCardTokenPaymentInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::PartialPaymentCardTokenPaymentInstrument.new
  end
  ...
  describe 'test an instance of PartialPaymentCardTokenPaymentInstrument' do
    it 'should create an instance of PartialPaymentCardTokenPaymentInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::PartialPaymentCardTokenPaymentInstrument)
    end
  end
