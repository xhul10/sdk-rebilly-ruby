...
# Unit tests for RebillySdk::ReadyToPayGenericMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayGenericMethod' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayGenericMethod.new
  end
  ...
  describe 'test an instance of ReadyToPayGenericMethod' do
    it 'should create an instance of ReadyToPayGenericMethod' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayGenericMethod)
    end
  end
