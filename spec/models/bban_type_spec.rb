...
# Unit tests for RebillySdk::BBANType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BBANType' do
  before do
    # run before each test
    @instance = RebillySdk::BBANType.new
  end
  ...
  describe 'test an instance of BBANType' do
    it 'should create an instance of BBANType' do
      expect(@instance).to be_instance_of(RebillySdk::BBANType)
    end
  end
  ...
  describe 'test attribute "account_number_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["IBAN", "BBAN"])
      # validator.allowable_values.each do |value|
