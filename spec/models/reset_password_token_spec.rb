...
# Unit tests for RebillySdk::ResetPasswordToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResetPasswordToken' do
  before do
    # run before each test
    @instance = RebillySdk::ResetPasswordToken.new
  end
  ...
  describe 'test an instance of ResetPasswordToken' do
    it 'should create an instance of ResetPasswordToken' do
      expect(@instance).to be_instance_of(RebillySdk::ResetPasswordToken)
    end
  end
