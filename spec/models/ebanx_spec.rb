...
# Unit tests for RebillySdk::EBANX
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EBANX' do
  before do
    # run before each test
    @instance = RebillySdk::EBANX.new
  end
  ...
  describe 'test an instance of EBANX' do
    it 'should create an instance of EBANX' do
      expect(@instance).to be_instance_of(RebillySdk::EBANX)
    end
  end
