...
# Unit tests for RebillySdk::Chase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Chase' do
  before do
    # run before each test
    @instance = RebillySdk::Chase.new
  end
  ...
  describe 'test an instance of Chase' do
    it 'should create an instance of Chase' do
      expect(@instance).to be_instance_of(RebillySdk::Chase)
    end
  end
