...
# Unit tests for RebillySdk::EMerchantPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMerchantPay' do
  before do
    # run before each test
    @instance = RebillySdk::EMerchantPay.new
  end
  ...
  describe 'test an instance of EMerchantPay' do
    it 'should create an instance of EMerchantPay' do
      expect(@instance).to be_instance_of(RebillySdk::EMerchantPay)
    end
  end
