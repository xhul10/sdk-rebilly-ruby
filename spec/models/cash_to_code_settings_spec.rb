...
# Unit tests for RebillySdk::CashToCodeSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CashToCodeSettings' do
  before do
    # run before each test
    @instance = RebillySdk::CashToCodeSettings.new
  end
  ...
  describe 'test an instance of CashToCodeSettings' do
    it 'should create an instance of CashToCodeSettings' do
      expect(@instance).to be_instance_of(RebillySdk::CashToCodeSettings)
    end
  end
  describe 'test attribute "skip_amount_selection"' do
    it 'should work' do
