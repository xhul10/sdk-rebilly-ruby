...
# Unit tests for RebillySdk::RedsysCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedsysCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::RedsysCredentials.new
  end
  ...
  describe 'test an instance of RedsysCredentials' do
    it 'should create an instance of RedsysCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::RedsysCredentials)
    end
  end
