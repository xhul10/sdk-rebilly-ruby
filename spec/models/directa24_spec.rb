...
# Unit tests for RebillySdk::Directa24
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Directa24' do
  before do
    # run before each test
    @instance = RebillySdk::Directa24.new
  end
  ...
  describe 'test an instance of Directa24' do
    it 'should create an instance of Directa24' do
      expect(@instance).to be_instance_of(RebillySdk::Directa24)
    end
  end
