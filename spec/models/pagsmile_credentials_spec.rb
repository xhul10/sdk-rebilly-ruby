...
# Unit tests for RebillySdk::PagsmileCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagsmileCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PagsmileCredentials.new
  end
  ...
  describe 'test an instance of PagsmileCredentials' do
    it 'should create an instance of PagsmileCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PagsmileCredentials)
    end
  end
