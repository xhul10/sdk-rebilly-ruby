...
# Unit tests for RebillySdk::InvoiceRetryInstructionAttempts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceRetryInstructionAttempts' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceRetryInstructionAttempts.new
  end
  ...
  describe 'test an instance of InvoiceRetryInstructionAttempts' do
    it 'should create an instance of InvoiceRetryInstructionAttempts' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceRetryInstructionAttempts)
    end
  end
  describe 'test attribute "schedule_instruction"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "amount_adjustment_instruction"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
