...
# Unit tests for RebillySdk::InvoiceTransactionAllocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceTransactionAllocation' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceTransactionAllocation.new
  end
  ...
  describe 'test an instance of InvoiceTransactionAllocation' do
    it 'should create an instance of InvoiceTransactionAllocation' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceTransactionAllocation)
    end
  end
