...
# Unit tests for RebillySdk::CommonOrderPreviewTaxes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrderPreviewTaxes' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrderPreviewTaxes.new
  end
  ...
  describe 'test an instance of CommonOrderPreviewTaxes' do
    it 'should create an instance of CommonOrderPreviewTaxes' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrderPreviewTaxes)
    end
  end
