...
# Unit tests for RebillySdk::Panamerican3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Panamerican3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Panamerican3dsServer.new
  end
  ...
  describe 'test an instance of Panamerican3dsServer' do
    it 'should create an instance of Panamerican3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Panamerican3dsServer)
    end
  end
