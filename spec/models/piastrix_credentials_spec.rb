...
# Unit tests for RebillySdk::PiastrixCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PiastrixCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PiastrixCredentials.new
  end
  ...
  describe 'test an instance of PiastrixCredentials' do
    it 'should create an instance of PiastrixCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PiastrixCredentials)
    end
  end
