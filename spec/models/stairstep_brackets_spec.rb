...
# Unit tests for RebillySdk::StairstepBrackets
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StairstepBrackets' do
  before do
    # run before each test
    @instance = RebillySdk::StairstepBrackets.new
  end
  ...
  describe 'test an instance of StairstepBrackets' do
    it 'should create an instance of StairstepBrackets' do
      expect(@instance).to be_instance_of(RebillySdk::StairstepBrackets)
    end
  end
