...
# Unit tests for RebillySdk::PaymentInstrumentUpdateToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInstrumentUpdateToken' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentInstrumentUpdateToken.new
  end
  ...
  describe 'test an instance of PaymentInstrumentUpdateToken' do
    it 'should create an instance of PaymentInstrumentUpdateToken' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentInstrumentUpdateToken)
    end
  end
