...
# Unit tests for RebillySdk::CommonOrderItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrderItems' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrderItems.new
  end
  ...
  describe 'test an instance of CommonOrderItems' do
    it 'should create an instance of CommonOrderItems' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrderItems)
    end
  end
  ...
  describe 'test attribute "is_modified"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_grandfathered"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
