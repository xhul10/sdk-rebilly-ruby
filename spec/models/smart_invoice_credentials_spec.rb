...
# Unit tests for RebillySdk::SmartInvoiceCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartInvoiceCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SmartInvoiceCredentials.new
  end
  ...
  describe 'test an instance of SmartInvoiceCredentials' do
    it 'should create an instance of SmartInvoiceCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SmartInvoiceCredentials)
    end
  end
