...
# Unit tests for RebillySdk::SecurionPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecurionPay' do
  before do
    # run before each test
    @instance = RebillySdk::SecurionPay.new
  end
  ...
  describe 'test an instance of SecurionPay' do
    it 'should create an instance of SecurionPay' do
      expect(@instance).to be_instance_of(RebillySdk::SecurionPay)
    end
  end
