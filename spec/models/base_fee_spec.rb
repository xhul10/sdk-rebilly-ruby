...
# Unit tests for RebillySdk::BaseFee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseFee' do
  before do
    # run before each test
    @instance = RebillySdk::BaseFee.new
  end
  ...
  describe 'test an instance of BaseFee' do
    it 'should create an instance of BaseFee' do
      expect(@instance).to be_instance_of(RebillySdk::BaseFee)
    end
  end
