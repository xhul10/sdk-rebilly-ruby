...
# Unit tests for RebillySdk::GlobalOne
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GlobalOne' do
  before do
    # run before each test
    @instance = RebillySdk::GlobalOne.new
  end
  ...
  describe 'test an instance of GlobalOne' do
    it 'should create an instance of GlobalOne' do
      expect(@instance).to be_instance_of(RebillySdk::GlobalOne)
    end
  end
