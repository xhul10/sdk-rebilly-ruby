...
# Unit tests for RebillySdk::Stripe3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stripe3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Stripe3dsServer.new
  end
  ...
  describe 'test an instance of Stripe3dsServer' do
    it 'should create an instance of Stripe3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Stripe3dsServer)
    end
  end
  ...
  describe 'test attribute "enforce_three_d_secure"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
