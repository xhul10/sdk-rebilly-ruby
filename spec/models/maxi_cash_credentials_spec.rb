...
# Unit tests for RebillySdk::MaxiCashCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaxiCashCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::MaxiCashCredentials.new
  end
  ...
  describe 'test an instance of MaxiCashCredentials' do
    it 'should create an instance of MaxiCashCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::MaxiCashCredentials)
    end
  end
