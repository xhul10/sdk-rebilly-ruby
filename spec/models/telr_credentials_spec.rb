...
# Unit tests for RebillySdk::TelrCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TelrCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::TelrCredentials.new
  end
  ...
  describe 'test an instance of TelrCredentials' do
    it 'should create an instance of TelrCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::TelrCredentials)
    end
  end
  ...
  describe 'test attribute "hosted_page_authentication_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "service_api_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
