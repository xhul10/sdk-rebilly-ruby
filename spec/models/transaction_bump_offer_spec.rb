...
# Unit tests for RebillySdk::TransactionBumpOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionBumpOffer' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionBumpOffer.new
  end
  ...
  describe 'test an instance of TransactionBumpOffer' do
    it 'should create an instance of TransactionBumpOffer' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionBumpOffer)
    end
  end
  ...
  describe 'test attribute "presented_offers"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "selected_offer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
