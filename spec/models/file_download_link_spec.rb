...
# Unit tests for RebillySdk::FileDownloadLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileDownloadLink' do
  before do
    # run before each test
    @instance = RebillySdk::FileDownloadLink.new
  end
  ...
  describe 'test an instance of FileDownloadLink' do
    it 'should create an instance of FileDownloadLink' do
      expect(@instance).to be_instance_of(RebillySdk::FileDownloadLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["download"])
