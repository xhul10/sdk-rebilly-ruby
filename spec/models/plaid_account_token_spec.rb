...
# Unit tests for RebillySdk::PlaidAccountToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlaidAccountToken' do
  before do
    # run before each test
    @instance = RebillySdk::PlaidAccountToken.new
  end
  ...
  describe 'test an instance of PlaidAccountToken' do
    it 'should create an instance of PlaidAccountToken' do
      expect(@instance).to be_instance_of(RebillySdk::PlaidAccountToken)
    end
  end
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["plaid-account"])
