...
# Unit tests for RebillySdk::OneTimeOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneTimeOrder' do
  before do
    # run before each test
    @instance = RebillySdk::OneTimeOrder.new
  end
  ...
  describe 'test an instance of OneTimeOrder' do
    it 'should create an instance of OneTimeOrder' do
      expect(@instance).to be_instance_of(RebillySdk::OneTimeOrder)
    end
  end
