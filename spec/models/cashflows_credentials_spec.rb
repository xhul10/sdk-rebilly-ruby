...
# Unit tests for RebillySdk::CashflowsCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CashflowsCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CashflowsCredentials.new
  end
  ...
  describe 'test an instance of CashflowsCredentials' do
    it 'should create an instance of CashflowsCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CashflowsCredentials)
    end
  end
