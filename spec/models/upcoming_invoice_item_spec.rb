...
# Unit tests for RebillySdk::UpcomingInvoiceItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpcomingInvoiceItem' do
  before do
    # run before each test
    @instance = RebillySdk::UpcomingInvoiceItem.new
  end
  ...
  describe 'test an instance of UpcomingInvoiceItem' do
    it 'should create an instance of UpcomingInvoiceItem' do
      expect(@instance).to be_instance_of(RebillySdk::UpcomingInvoiceItem)
    end
  end
  ...
  describe 'test attribute "unit_price_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
