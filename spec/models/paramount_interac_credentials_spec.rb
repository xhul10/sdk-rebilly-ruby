...
# Unit tests for RebillySdk::ParamountInteracCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParamountInteracCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ParamountInteracCredentials.new
  end
  ...
  describe 'test an instance of ParamountInteracCredentials' do
    it 'should create an instance of ParamountInteracCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ParamountInteracCredentials)
    end
  end
