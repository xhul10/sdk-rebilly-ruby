...
# Unit tests for RebillySdk::OrganizationQuestionnaire
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationQuestionnaire' do
  before do
    # run before each test
    @instance = RebillySdk::OrganizationQuestionnaire.new
  end
  ...
  describe 'test an instance of OrganizationQuestionnaire' do
    it 'should create an instance of OrganizationQuestionnaire' do
      expect(@instance).to be_instance_of(RebillySdk::OrganizationQuestionnaire)
    end
  end
  ...
  describe 'test attribute "launch_timing"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
