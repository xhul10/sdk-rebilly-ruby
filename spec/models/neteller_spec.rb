...
# Unit tests for RebillySdk::Neteller
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Neteller' do
  before do
    # run before each test
    @instance = RebillySdk::Neteller.new
  end
  ...
  describe 'test an instance of Neteller' do
    it 'should create an instance of Neteller' do
      expect(@instance).to be_instance_of(RebillySdk::Neteller)
    end
  end
