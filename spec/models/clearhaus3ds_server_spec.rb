...
# Unit tests for RebillySdk::Clearhaus3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Clearhaus3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Clearhaus3dsServer.new
  end
  ...
  describe 'test an instance of Clearhaus3dsServer' do
    it 'should create an instance of Clearhaus3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Clearhaus3dsServer)
    end
  end
