...
# Unit tests for RebillySdk::IlixiumCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IlixiumCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::IlixiumCredentials.new
  end
  ...
  describe 'test an instance of IlixiumCredentials' do
    it 'should create an instance of IlixiumCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::IlixiumCredentials)
    end
  end
