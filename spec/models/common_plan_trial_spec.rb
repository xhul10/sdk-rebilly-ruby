...
# Unit tests for RebillySdk::CommonPlanTrial
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonPlanTrial' do
  before do
    # run before each test
    @instance = RebillySdk::CommonPlanTrial.new
  end
  ...
  describe 'test an instance of CommonPlanTrial' do
    it 'should create an instance of CommonPlanTrial' do
      expect(@instance).to be_instance_of(RebillySdk::CommonPlanTrial)
    end
  end
