...
# Unit tests for RebillySdk::TransactionEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionEmbed.new
  end
  ...
  describe 'test an instance of TransactionEmbed' do
    it 'should create an instance of TransactionEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionEmbed)
    end
  end
