...
# Unit tests for RebillySdk::AirpayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AirpayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AirpayCredentials.new
  end
  ...
  describe 'test an instance of AirpayCredentials' do
    it 'should create an instance of AirpayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AirpayCredentials)
    end
  end
