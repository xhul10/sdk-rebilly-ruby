...
# Unit tests for RebillySdk::TimelineExtraDataLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineExtraDataLinks' do
  before do
    # run before each test
    @instance = RebillySdk::TimelineExtraDataLinks.new
  end
  ...
  describe 'test an instance of TimelineExtraDataLinks' do
    it 'should create an instance of TimelineExtraDataLinks' do
      expect(@instance).to be_instance_of(RebillySdk::TimelineExtraDataLinks)
    end
  end
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kyc-document", "invoice", "subscription", "transaction", "email-message", "dispute", "coupon", "external"])
