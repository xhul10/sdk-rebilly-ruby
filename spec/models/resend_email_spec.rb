...
# Unit tests for RebillySdk::ResendEmail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResendEmail' do
  before do
    # run before each test
    @instance = RebillySdk::ResendEmail.new
  end
  ...
  describe 'test an instance of ResendEmail' do
    it 'should create an instance of ResendEmail' do
      expect(@instance).to be_instance_of(RebillySdk::ResendEmail)
    end
  end
