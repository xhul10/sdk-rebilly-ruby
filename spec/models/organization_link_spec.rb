...
# Unit tests for RebillySdk::OrganizationLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationLink' do
  before do
    # run before each test
    @instance = RebillySdk::OrganizationLink.new
  end
  ...
  describe 'test an instance of OrganizationLink' do
    it 'should create an instance of OrganizationLink' do
      expect(@instance).to be_instance_of(RebillySdk::OrganizationLink)
    end
  end
