...
# Unit tests for RebillySdk::WirecardCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WirecardCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::WirecardCredentials.new
  end
  ...
  describe 'test an instance of WirecardCredentials' do
    it 'should create an instance of WirecardCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::WirecardCredentials)
    end
  end
  describe 'test attribute "merchant_username"' do
    it 'should work' do
  ...
  describe 'test attribute "business_signature"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "sftp_username"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sftp_private_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
