...
# Unit tests for RebillySdk::Worldpay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Worldpay' do
  before do
    # run before each test
    @instance = RebillySdk::Worldpay.new
  end
  ...
  describe 'test an instance of Worldpay' do
    it 'should create an instance of Worldpay' do
      expect(@instance).to be_instance_of(RebillySdk::Worldpay)
    end
  end
