...
# Unit tests for RebillySdk::RealexCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RealexCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::RealexCredentials.new
  end
  ...
  describe 'test an instance of RealexCredentials' do
    it 'should create an instance of RealexCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::RealexCredentials)
    end
  end
  ...
  describe 'test attribute "rebate_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
