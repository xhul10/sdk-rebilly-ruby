...
# Unit tests for RebillySdk::Finrax
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Finrax' do
  before do
    # run before each test
    @instance = RebillySdk::Finrax.new
  end
  ...
  describe 'test an instance of Finrax' do
    it 'should create an instance of Finrax' do
      expect(@instance).to be_instance_of(RebillySdk::Finrax)
    end
  end
