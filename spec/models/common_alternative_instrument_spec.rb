...
# Unit tests for RebillySdk::CommonAlternativeInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonAlternativeInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::CommonAlternativeInstrument.new
  end
  ...
  describe 'test an instance of CommonAlternativeInstrument' do
    it 'should create an instance of CommonAlternativeInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::CommonAlternativeInstrument)
    end
  end
