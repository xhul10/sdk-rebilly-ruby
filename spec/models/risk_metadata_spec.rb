...
# Unit tests for RebillySdk::RiskMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RiskMetadata' do
  before do
    # run before each test
    @instance = RebillySdk::RiskMetadata.new
  end
  ...
  describe 'test an instance of RiskMetadata' do
    it 'should create an instance of RiskMetadata' do
      expect(@instance).to be_instance_of(RebillySdk::RiskMetadata)
    end
  end
