...
# Unit tests for RebillySdk::Dimoco
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Dimoco' do
  before do
    # run before each test
    @instance = RebillySdk::Dimoco.new
  end
  ...
  describe 'test an instance of Dimoco' do
    it 'should create an instance of Dimoco' do
      expect(@instance).to be_instance_of(RebillySdk::Dimoco)
    end
  end
