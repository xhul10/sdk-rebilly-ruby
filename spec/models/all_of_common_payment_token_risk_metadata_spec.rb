...
# Unit tests for RebillySdk::AllOfCommonPaymentTokenRiskMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonPaymentTokenRiskMetadata' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonPaymentTokenRiskMetadata.new
  end
  ...
  describe 'test an instance of AllOfCommonPaymentTokenRiskMetadata' do
    it 'should create an instance of AllOfCommonPaymentTokenRiskMetadata' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonPaymentTokenRiskMetadata)
    end
  end
