...
# Unit tests for RebillySdk::IntuitCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IntuitCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::IntuitCredentials.new
  end
  ...
  describe 'test an instance of IntuitCredentials' do
    it 'should create an instance of IntuitCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::IntuitCredentials)
    end
  end
