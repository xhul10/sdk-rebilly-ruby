...
# Unit tests for RebillySdk::QueryUrlLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueryUrlLink' do
  before do
    # run before each test
    @instance = RebillySdk::QueryUrlLink.new
  end
  ...
  describe 'test an instance of QueryUrlLink' do
    it 'should create an instance of QueryUrlLink' do
      expect(@instance).to be_instance_of(RebillySdk::QueryUrlLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["queryUrl"])
