...
# Unit tests for RebillySdk::GpaysafeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GpaysafeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::GpaysafeCredentials.new
  end
  ...
  describe 'test an instance of GpaysafeCredentials' do
    it 'should create an instance of GpaysafeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::GpaysafeCredentials)
    end
  end
