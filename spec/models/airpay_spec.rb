...
# Unit tests for RebillySdk::Airpay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Airpay' do
  before do
    # run before each test
    @instance = RebillySdk::Airpay.new
  end
  ...
  describe 'test an instance of Airpay' do
    it 'should create an instance of Airpay' do
      expect(@instance).to be_instance_of(RebillySdk::Airpay)
    end
  end
