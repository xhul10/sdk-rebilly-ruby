...
# Unit tests for RebillySdk::CODVoucherCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CODVoucherCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CODVoucherCredentials.new
  end
  ...
  describe 'test an instance of CODVoucherCredentials' do
    it 'should create an instance of CODVoucherCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CODVoucherCredentials)
    end
  end
