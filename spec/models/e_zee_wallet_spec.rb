...
# Unit tests for RebillySdk::EZeeWallet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EZeeWallet' do
  before do
    # run before each test
    @instance = RebillySdk::EZeeWallet.new
  end
  ...
  describe 'test an instance of EZeeWallet' do
    it 'should create an instance of EZeeWallet' do
      expect(@instance).to be_instance_of(RebillySdk::EZeeWallet)
    end
  end
