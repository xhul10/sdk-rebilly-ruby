...
# Unit tests for RebillySdk::ReadyToPayPayPalMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayPayPalMethod' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayPayPalMethod.new
  end
  ...
  describe 'test an instance of ReadyToPayPayPalMethod' do
    it 'should create an instance of ReadyToPayPayPalMethod' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayPayPalMethod)
    end
  end
