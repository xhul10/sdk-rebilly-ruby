...
# Unit tests for RebillySdk::CommonInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonInvoice' do
  before do
    # run before each test
    @instance = RebillySdk::CommonInvoice.new
  end
  ...
  describe 'test an instance of CommonInvoice' do
    it 'should create an instance of CommonInvoice' do
      expect(@instance).to be_instance_of(RebillySdk::CommonInvoice)
    end
  end
