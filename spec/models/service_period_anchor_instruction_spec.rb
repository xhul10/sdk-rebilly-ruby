...
# Unit tests for RebillySdk::ServicePeriodAnchorInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServicePeriodAnchorInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::ServicePeriodAnchorInstruction.new
  end
  ...
  describe 'test an instance of ServicePeriodAnchorInstruction' do
    it 'should create an instance of ServicePeriodAnchorInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::ServicePeriodAnchorInstruction)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["immediately", "day-of-month", "day-of-week"])
