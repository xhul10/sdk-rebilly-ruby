...
# Unit tests for RebillySdk::NGenius3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NGenius3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::NGenius3dsServer.new
  end
  ...
  describe 'test an instance of NGenius3dsServer' do
    it 'should create an instance of NGenius3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::NGenius3dsServer)
    end
  end
