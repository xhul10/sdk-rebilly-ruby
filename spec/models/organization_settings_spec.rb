...
# Unit tests for RebillySdk::OrganizationSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationSettings' do
  before do
    # run before each test
    @instance = RebillySdk::OrganizationSettings.new
  end
  ...
  describe 'test an instance of OrganizationSettings' do
    it 'should create an instance of OrganizationSettings' do
      expect(@instance).to be_instance_of(RebillySdk::OrganizationSettings)
    end
  end
  describe 'test attribute "default_tax_calculator"' do
    it 'should work' do
