...
# Unit tests for RebillySdk::PaynoteCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaynoteCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaynoteCredentials.new
  end
  ...
  describe 'test an instance of PaynoteCredentials' do
    it 'should create an instance of PaynoteCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaynoteCredentials)
    end
  end
