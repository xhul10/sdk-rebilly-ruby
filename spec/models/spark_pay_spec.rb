...
# Unit tests for RebillySdk::SparkPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SparkPay' do
  before do
    # run before each test
    @instance = RebillySdk::SparkPay.new
  end
  ...
  describe 'test an instance of SparkPay' do
    it 'should create an instance of SparkPay' do
      expect(@instance).to be_instance_of(RebillySdk::SparkPay)
    end
  end
