...
# Unit tests for RebillySdk::UPayCardCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UPayCardCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::UPayCardCredentials.new
  end
  ...
  describe 'test an instance of UPayCardCredentials' do
    it 'should create an instance of UPayCardCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::UPayCardCredentials)
    end
  end
  describe 'test attribute "receiver_account"' do
    it 'should work' do
