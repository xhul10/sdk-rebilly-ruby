...
# Unit tests for RebillySdk::CustomerJWT
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerJWT' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerJWT.new
  end
  ...
  describe 'test an instance of CustomerJWT' do
    it 'should create an instance of CustomerJWT' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerJWT)
    end
  end
  ...
  describe 'test attribute "invalidate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
