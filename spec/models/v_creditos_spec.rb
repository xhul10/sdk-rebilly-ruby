...
# Unit tests for RebillySdk::VCreditos
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VCreditos' do
  before do
    # run before each test
    @instance = RebillySdk::VCreditos.new
  end
  ...
  describe 'test an instance of VCreditos' do
    it 'should create an instance of VCreditos' do
      expect(@instance).to be_instance_of(RebillySdk::VCreditos)
    end
  end
