...
# Unit tests for RebillySdk::ParamountInterac
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParamountInterac' do
  before do
    # run before each test
    @instance = RebillySdk::ParamountInterac.new
  end
  ...
  describe 'test an instance of ParamountInterac' do
    it 'should create an instance of ParamountInterac' do
      expect(@instance).to be_instance_of(RebillySdk::ParamountInterac)
    end
  end
