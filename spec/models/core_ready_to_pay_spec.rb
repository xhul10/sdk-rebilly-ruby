...
# Unit tests for RebillySdk::CoreReadyToPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoreReadyToPay' do
  before do
    # run before each test
    @instance = RebillySdk::CoreReadyToPay.new
  end
  ...
  describe 'test an instance of CoreReadyToPay' do
    it 'should create an instance of CoreReadyToPay' do
      expect(@instance).to be_instance_of(RebillySdk::CoreReadyToPay)
    end
  end
