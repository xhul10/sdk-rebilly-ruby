...
# Unit tests for RebillySdk::KycSettingsAddressWeights
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycSettingsAddressWeights' do
  before do
    # run before each test
    @instance = RebillySdk::KycSettingsAddressWeights.new
  end
  ...
  describe 'test an instance of KycSettingsAddressWeights' do
    it 'should create an instance of KycSettingsAddressWeights' do
      expect(@instance).to be_instance_of(RebillySdk::KycSettingsAddressWeights)
    end
  end
