...
# Unit tests for RebillySdk::Immediately
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Immediately' do
  before do
    # run before each test
    @instance = RebillySdk::Immediately.new
  end
  ...
  describe 'test an instance of Immediately' do
    it 'should create an instance of Immediately' do
      expect(@instance).to be_instance_of(RebillySdk::Immediately)
    end
  end
