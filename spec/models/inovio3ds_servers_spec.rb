...
# Unit tests for RebillySdk::Inovio3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Inovio3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Inovio3dsServers.new
  end
  ...
  describe 'test an instance of Inovio3dsServers' do
    it 'should create an instance of Inovio3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Inovio3dsServers)
    end
  end
