...
# Unit tests for RebillySdk::ProsaCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProsaCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ProsaCredentials.new
  end
  ...
  describe 'test an instance of ProsaCredentials' do
    it 'should create an instance of ProsaCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ProsaCredentials)
    end
  end
