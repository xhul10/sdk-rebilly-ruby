...
# Unit tests for RebillySdk::IDebit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IDebit' do
  before do
    # run before each test
    @instance = RebillySdk::IDebit.new
  end
  ...
  describe 'test an instance of IDebit' do
    it 'should create an instance of IDebit' do
      expect(@instance).to be_instance_of(RebillySdk::IDebit)
    end
  end
