...
# Unit tests for RebillySdk::SubscriptionMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionMetadata' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionMetadata.new
  end
  ...
  describe 'test an instance of SubscriptionMetadata' do
    it 'should create an instance of SubscriptionMetadata' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionMetadata)
    end
  end
