...
# Unit tests for RebillySdk::OrderPreview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderPreview' do
  before do
    # run before each test
    @instance = RebillySdk::OrderPreview.new
  end
  ...
  describe 'test an instance of OrderPreview' do
    it 'should create an instance of OrderPreview' do
      expect(@instance).to be_instance_of(RebillySdk::OrderPreview)
    end
  end
