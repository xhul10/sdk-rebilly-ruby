...
# Unit tests for RebillySdk::CommonOrderPreview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrderPreview' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrderPreview.new
  end
  ...
  describe 'test an instance of CommonOrderPreview' do
    it 'should create an instance of CommonOrderPreview' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrderPreview)
    end
  end
  ...
  describe 'test attribute "discounts_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
