...
# Unit tests for RebillySdk::KycSettingsIdentityWeights
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycSettingsIdentityWeights' do
  before do
    # run before each test
    @instance = RebillySdk::KycSettingsIdentityWeights.new
  end
  ...
  describe 'test an instance of KycSettingsIdentityWeights' do
    it 'should create an instance of KycSettingsIdentityWeights' do
      expect(@instance).to be_instance_of(RebillySdk::KycSettingsIdentityWeights)
    end
  end
  ...
  describe 'test attribute "is_identity_document"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_published_online"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "matches_date_of_birth"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "has_minimal_age"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "has_matching_face_proof"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
