...
# Unit tests for RebillySdk::ApplePayFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApplePayFeature' do
  before do
    # run before each test
    @instance = RebillySdk::ApplePayFeature.new
  end
  ...
  describe 'test an instance of ApplePayFeature' do
    it 'should create an instance of ApplePayFeature' do
      expect(@instance).to be_instance_of(RebillySdk::ApplePayFeature)
    end
  end
