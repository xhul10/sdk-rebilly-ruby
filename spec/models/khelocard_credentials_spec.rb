...
# Unit tests for RebillySdk::KhelocardCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KhelocardCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::KhelocardCredentials.new
  end
  ...
  describe 'test an instance of KhelocardCredentials' do
    it 'should create an instance of KhelocardCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::KhelocardCredentials)
    end
  end
