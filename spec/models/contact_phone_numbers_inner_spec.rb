...
# Unit tests for RebillySdk::ContactPhoneNumbersInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactPhoneNumbersInner' do
  before do
    # run before each test
    @instance = RebillySdk::ContactPhoneNumbersInner.new
  end
  ...
  describe 'test an instance of ContactPhoneNumbersInner' do
    it 'should create an instance of ContactPhoneNumbersInner' do
      expect(@instance).to be_instance_of(RebillySdk::ContactPhoneNumbersInner)
    end
  end
