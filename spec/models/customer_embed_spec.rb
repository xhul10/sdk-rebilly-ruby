...
# Unit tests for RebillySdk::CustomerEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerEmbed.new
  end
  ...
  describe 'test an instance of CustomerEmbed' do
    it 'should create an instance of CustomerEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerEmbed)
    end
  end
