...
# Unit tests for RebillySdk::Zimpler
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Zimpler' do
  before do
    # run before each test
    @instance = RebillySdk::Zimpler.new
  end
  ...
  describe 'test an instance of Zimpler' do
    it 'should create an instance of Zimpler' do
      expect(@instance).to be_instance_of(RebillySdk::Zimpler)
    end
  end
