...
# Unit tests for RebillySdk::SafechargeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SafechargeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SafechargeCredentials.new
  end
  ...
  describe 'test an instance of SafechargeCredentials' do
    it 'should create an instance of SafechargeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SafechargeCredentials)
    end
  end
