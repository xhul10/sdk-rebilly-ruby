...
# Unit tests for RebillySdk::ApcoPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApcoPay' do
  before do
    # run before each test
    @instance = RebillySdk::ApcoPay.new
  end
  ...
  describe 'test an instance of ApcoPay' do
    it 'should create an instance of ApcoPay' do
      expect(@instance).to be_instance_of(RebillySdk::ApcoPay)
    end
  end
