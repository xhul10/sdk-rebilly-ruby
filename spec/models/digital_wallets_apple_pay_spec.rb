...
# Unit tests for RebillySdk::DigitalWalletsApplePay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DigitalWalletsApplePay' do
  before do
    # run before each test
    @instance = RebillySdk::DigitalWalletsApplePay.new
  end
  ...
  describe 'test an instance of DigitalWalletsApplePay' do
    it 'should create an instance of DigitalWalletsApplePay' do
      expect(@instance).to be_instance_of(RebillySdk::DigitalWalletsApplePay)
    end
  end
