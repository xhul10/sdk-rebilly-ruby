...
# Unit tests for RebillySdk::InvoiceReissue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceReissue' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceReissue.new
  end
  ...
  describe 'test an instance of InvoiceReissue' do
    it 'should create an instance of InvoiceReissue' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceReissue)
    end
  end
