...
# Unit tests for RebillySdk::FeeFormula
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeFormula' do
  before do
    # run before each test
    @instance = RebillySdk::FeeFormula.new
  end
  ...
  describe 'test an instance of FeeFormula' do
    it 'should create an instance of FeeFormula' do
      expect(@instance).to be_instance_of(RebillySdk::FeeFormula)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fixed-fee", "percentage"])
