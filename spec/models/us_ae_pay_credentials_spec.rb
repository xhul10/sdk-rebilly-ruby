...
# Unit tests for RebillySdk::USAePayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'USAePayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::USAePayCredentials.new
  end
  ...
  describe 'test an instance of USAePayCredentials' do
    it 'should create an instance of USAePayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::USAePayCredentials)
    end
  end
