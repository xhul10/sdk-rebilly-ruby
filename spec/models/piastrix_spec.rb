...
# Unit tests for RebillySdk::Piastrix
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Piastrix' do
  before do
    # run before each test
    @instance = RebillySdk::Piastrix.new
  end
  ...
  describe 'test an instance of Piastrix' do
    it 'should create an instance of Piastrix' do
      expect(@instance).to be_instance_of(RebillySdk::Piastrix)
    end
  end
