...
# Unit tests for RebillySdk::Safecharge
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Safecharge' do
  before do
    # run before each test
    @instance = RebillySdk::Safecharge.new
  end
  ...
  describe 'test an instance of Safecharge' do
    it 'should create an instance of Safecharge' do
      expect(@instance).to be_instance_of(RebillySdk::Safecharge)
    end
  end
