...
# Unit tests for RebillySdk::LPGCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LPGCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::LPGCredentials.new
  end
  ...
  describe 'test an instance of LPGCredentials' do
    it 'should create an instance of LPGCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::LPGCredentials)
    end
  end
  ...
  describe 'test attribute "secure_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payout_username"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payout_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
