...
# Unit tests for RebillySdk::FixedFeeFormula
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedFeeFormula' do
  before do
    # run before each test
    @instance = RebillySdk::FixedFeeFormula.new
  end
  ...
  describe 'test an instance of FixedFeeFormula' do
    it 'should create an instance of FixedFeeFormula' do
      expect(@instance).to be_instance_of(RebillySdk::FixedFeeFormula)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fixed-fee"])
