...
# Unit tests for RebillySdk::WebsiteLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebsiteLink' do
  before do
    # run before each test
    @instance = RebillySdk::WebsiteLink.new
  end
  ...
  describe 'test an instance of WebsiteLink' do
    it 'should create an instance of WebsiteLink' do
      expect(@instance).to be_instance_of(RebillySdk::WebsiteLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["website"])
