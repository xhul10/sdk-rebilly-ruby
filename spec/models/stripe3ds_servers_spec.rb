...
# Unit tests for RebillySdk::Stripe3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stripe3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Stripe3dsServers.new
  end
  ...
  describe 'test an instance of Stripe3dsServers' do
    it 'should create an instance of Stripe3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Stripe3dsServers)
    end
  end
