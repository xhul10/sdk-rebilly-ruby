...
# Unit tests for RebillySdk::CommonOrderPreviewLineItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrderPreviewLineItems' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrderPreviewLineItems.new
  end
  ...
  describe 'test an instance of CommonOrderPreviewLineItems' do
    it 'should create an instance of CommonOrderPreviewLineItems' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrderPreviewLineItems)
    end
  end
