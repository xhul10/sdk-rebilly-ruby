...
# Unit tests for RebillySdk::AllOfCommonOrderBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonOrderBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonOrderBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonOrderBillingAddress' do
    it 'should create an instance of AllOfCommonOrderBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonOrderBillingAddress)
    end
  end
