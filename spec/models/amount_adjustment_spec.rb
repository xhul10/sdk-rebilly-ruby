...
# Unit tests for RebillySdk::AmountAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmountAdjustment' do
  before do
    # run before each test
    @instance = RebillySdk::AmountAdjustment.new
  end
  ...
  describe 'test an instance of AmountAdjustment' do
    it 'should create an instance of AmountAdjustment' do
      expect(@instance).to be_instance_of(RebillySdk::AmountAdjustment)
    end
  end
