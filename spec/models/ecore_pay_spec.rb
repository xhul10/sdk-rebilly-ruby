...
# Unit tests for RebillySdk::EcorePay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EcorePay' do
  before do
    # run before each test
    @instance = RebillySdk::EcorePay.new
  end
  ...
  describe 'test an instance of EcorePay' do
    it 'should create an instance of EcorePay' do
      expect(@instance).to be_instance_of(RebillySdk::EcorePay)
    end
  end
