...
# Unit tests for RebillySdk::AllOfCommonAlternativeInstrumentBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonAlternativeInstrumentBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonAlternativeInstrumentBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonAlternativeInstrumentBillingAddress' do
    it 'should create an instance of AllOfCommonAlternativeInstrumentBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonAlternativeInstrumentBillingAddress)
    end
  end
