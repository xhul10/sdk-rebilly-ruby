...
# Unit tests for RebillySdk::MuchBetter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MuchBetter' do
  before do
    # run before each test
    @instance = RebillySdk::MuchBetter.new
  end
  ...
  describe 'test an instance of MuchBetter' do
    it 'should create an instance of MuchBetter' do
      expect(@instance).to be_instance_of(RebillySdk::MuchBetter)
    end
  end
