...
# Unit tests for RebillySdk::ReadyToPayAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayAmount' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayAmount.new
  end
  ...
  describe 'test an instance of ReadyToPayAmount' do
    it 'should create an instance of ReadyToPayAmount' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayAmount)
    end
  end
