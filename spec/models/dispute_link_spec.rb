...
# Unit tests for RebillySdk::DisputeLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisputeLink' do
  before do
    # run before each test
    @instance = RebillySdk::DisputeLink.new
  end
  ...
  describe 'test an instance of DisputeLink' do
    it 'should create an instance of DisputeLink' do
      expect(@instance).to be_instance_of(RebillySdk::DisputeLink)
    end
  end
