...
# Unit tests for RebillySdk::CyberSourceCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CyberSourceCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CyberSourceCredentials.new
  end
  ...
  describe 'test an instance of CyberSourceCredentials' do
    it 'should create an instance of CyberSourceCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CyberSourceCredentials)
    end
  end
