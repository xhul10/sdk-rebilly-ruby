...
# Unit tests for RebillySdk::AllOfPaymentCardCreatePlainBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfPaymentCardCreatePlainBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfPaymentCardCreatePlainBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfPaymentCardCreatePlainBillingAddress' do
    it 'should create an instance of AllOfPaymentCardCreatePlainBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfPaymentCardCreatePlainBillingAddress)
    end
  end
