...
# Unit tests for RebillySdk::Paysafe3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Paysafe3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Paysafe3dsServer.new
  end
  ...
  describe 'test an instance of Paysafe3dsServer' do
    it 'should create an instance of Paysafe3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Paysafe3dsServer)
    end
  end
