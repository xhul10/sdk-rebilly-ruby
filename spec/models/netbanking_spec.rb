...
# Unit tests for RebillySdk::Netbanking
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Netbanking' do
  before do
    # run before each test
    @instance = RebillySdk::Netbanking.new
  end
  ...
  describe 'test an instance of Netbanking' do
    it 'should create an instance of Netbanking' do
      expect(@instance).to be_instance_of(RebillySdk::Netbanking)
    end
  end
