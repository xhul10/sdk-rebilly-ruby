...
# Unit tests for RebillySdk::HiPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HiPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::HiPayCredentials.new
  end
  ...
  describe 'test an instance of HiPayCredentials' do
    it 'should create an instance of HiPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::HiPayCredentials)
    end
  end
