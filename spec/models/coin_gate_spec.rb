...
# Unit tests for RebillySdk::CoinGate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoinGate' do
  before do
    # run before each test
    @instance = RebillySdk::CoinGate.new
  end
  ...
  describe 'test an instance of CoinGate' do
    it 'should create an instance of CoinGate' do
      expect(@instance).to be_instance_of(RebillySdk::CoinGate)
    end
  end
