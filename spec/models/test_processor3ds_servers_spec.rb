...
# Unit tests for RebillySdk::TestProcessor3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TestProcessor3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::TestProcessor3dsServers.new
  end
  ...
  describe 'test an instance of TestProcessor3dsServers' do
    it 'should create an instance of TestProcessor3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::TestProcessor3dsServers)
    end
  end
