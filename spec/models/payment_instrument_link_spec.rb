...
# Unit tests for RebillySdk::PaymentInstrumentLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInstrumentLink' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentInstrumentLink.new
  end
  ...
  describe 'test an instance of PaymentInstrumentLink' do
    it 'should create an instance of PaymentInstrumentLink' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentInstrumentLink)
    end
  end
