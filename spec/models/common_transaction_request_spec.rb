...
# Unit tests for RebillySdk::CommonTransactionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonTransactionRequest' do
  before do
    # run before each test
    @instance = RebillySdk::CommonTransactionRequest.new
  end
  ...
  describe 'test an instance of CommonTransactionRequest' do
    it 'should create an instance of CommonTransactionRequest' do
      expect(@instance).to be_instance_of(RebillySdk::CommonTransactionRequest)
    end
  end
