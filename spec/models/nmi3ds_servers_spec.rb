...
# Unit tests for RebillySdk::NMI3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NMI3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::NMI3dsServers.new
  end
  ...
  describe 'test an instance of NMI3dsServers' do
    it 'should create an instance of NMI3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::NMI3dsServers)
    end
  end
