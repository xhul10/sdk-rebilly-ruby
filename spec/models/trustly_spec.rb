...
# Unit tests for RebillySdk::Trustly
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Trustly' do
  before do
    # run before each test
    @instance = RebillySdk::Trustly.new
  end
  ...
  describe 'test an instance of Trustly' do
    it 'should create an instance of Trustly' do
      expect(@instance).to be_instance_of(RebillySdk::Trustly)
    end
  end
