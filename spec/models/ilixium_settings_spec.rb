...
# Unit tests for RebillySdk::IlixiumSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IlixiumSettings' do
  before do
    # run before each test
    @instance = RebillySdk::IlixiumSettings.new
  end
  ...
  describe 'test an instance of IlixiumSettings' do
    it 'should create an instance of IlixiumSettings' do
      expect(@instance).to be_instance_of(RebillySdk::IlixiumSettings)
    end
  end
  describe 'test attribute "use_ip_frame"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "use_credit_endpoint"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "use_standalone_credit_endpoint"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "platform"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["itix", "tpg"])
