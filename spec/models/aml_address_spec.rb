...
# Unit tests for RebillySdk::AMLAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AMLAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AMLAddress.new
  end
  ...
  describe 'test an instance of AMLAddress' do
    it 'should create an instance of AMLAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AMLAddress)
    end
  end
