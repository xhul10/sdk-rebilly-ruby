...
# Unit tests for RebillySdk::AmexVPC
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmexVPC' do
  before do
    # run before each test
    @instance = RebillySdk::AmexVPC.new
  end
  ...
  describe 'test an instance of AmexVPC' do
    it 'should create an instance of AmexVPC' do
      expect(@instance).to be_instance_of(RebillySdk::AmexVPC)
    end
  end
