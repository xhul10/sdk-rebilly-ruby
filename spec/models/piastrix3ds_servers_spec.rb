...
# Unit tests for RebillySdk::Piastrix3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Piastrix3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Piastrix3dsServers.new
  end
  ...
  describe 'test an instance of Piastrix3dsServers' do
    it 'should create an instance of Piastrix3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Piastrix3dsServers)
    end
  end
