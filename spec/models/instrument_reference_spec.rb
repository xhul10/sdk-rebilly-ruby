...
# Unit tests for RebillySdk::InstrumentReference
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstrumentReference' do
  before do
    # run before each test
    @instance = RebillySdk::InstrumentReference.new
  end
  ...
  describe 'test an instance of InstrumentReference' do
    it 'should create an instance of InstrumentReference' do
      expect(@instance).to be_instance_of(RebillySdk::InstrumentReference)
    end
  end
