...
# Unit tests for RebillySdk::VCreditosSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VCreditosSettings' do
  before do
    # run before each test
    @instance = RebillySdk::VCreditosSettings.new
  end
  ...
  describe 'test an instance of VCreditosSettings' do
    it 'should create an instance of VCreditosSettings' do
      expect(@instance).to be_instance_of(RebillySdk::VCreditosSettings)
    end
  end
  describe 'test attribute "merchant_website_login_label"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "merchant_website_login_description"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
