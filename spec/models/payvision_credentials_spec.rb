...
# Unit tests for RebillySdk::PayvisionCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayvisionCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayvisionCredentials.new
  end
  ...
  describe 'test an instance of PayvisionCredentials' do
    it 'should create an instance of PayvisionCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayvisionCredentials)
    end
  end
