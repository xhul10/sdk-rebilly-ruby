...
# Unit tests for RebillySdk::PaymentToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentToken' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentToken.new
  end
  ...
  describe 'test an instance of PaymentToken' do
    it 'should create an instance of PaymentToken' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentToken)
    end
  end
