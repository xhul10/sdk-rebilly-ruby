...
# Unit tests for RebillySdk::TelrSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TelrSettings' do
  before do
    # run before each test
    @instance = RebillySdk::TelrSettings.new
  end
  ...
  describe 'test an instance of TelrSettings' do
    it 'should create an instance of TelrSettings' do
      expect(@instance).to be_instance_of(RebillySdk::TelrSettings)
    end
  end
