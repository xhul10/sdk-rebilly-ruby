...
# Unit tests for RebillySdk::CustomerLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerLink' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerLink.new
  end
  ...
  describe 'test an instance of CustomerLink' do
    it 'should create an instance of CustomerLink' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["customer", "targetCustomer"])
