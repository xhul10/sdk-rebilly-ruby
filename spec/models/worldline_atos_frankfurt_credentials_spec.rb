...
# Unit tests for RebillySdk::WorldlineAtosFrankfurtCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorldlineAtosFrankfurtCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::WorldlineAtosFrankfurtCredentials.new
  end
  ...
  describe 'test an instance of WorldlineAtosFrankfurtCredentials' do
    it 'should create an instance of WorldlineAtosFrankfurtCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::WorldlineAtosFrankfurtCredentials)
    end
  end
  describe 'test attribute "card_acceptor_id_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "acquiring_institution_identification_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
