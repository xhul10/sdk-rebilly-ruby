...
# Unit tests for RebillySdk::RecalculateInvoiceLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecalculateInvoiceLink' do
  before do
    # run before each test
    @instance = RebillySdk::RecalculateInvoiceLink.new
  end
  ...
  describe 'test an instance of RecalculateInvoiceLink' do
    it 'should create an instance of RecalculateInvoiceLink' do
      expect(@instance).to be_instance_of(RebillySdk::RecalculateInvoiceLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["recalculateInvoice"])
