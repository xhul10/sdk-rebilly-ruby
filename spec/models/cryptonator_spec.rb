...
# Unit tests for RebillySdk::Cryptonator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Cryptonator' do
  before do
    # run before each test
    @instance = RebillySdk::Cryptonator.new
  end
  ...
  describe 'test an instance of Cryptonator' do
    it 'should create an instance of Cryptonator' do
      expect(@instance).to be_instance_of(RebillySdk::Cryptonator)
    end
  end
