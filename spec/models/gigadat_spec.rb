...
# Unit tests for RebillySdk::Gigadat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Gigadat' do
  before do
    # run before each test
    @instance = RebillySdk::Gigadat.new
  end
  ...
  describe 'test an instance of Gigadat' do
    it 'should create an instance of Gigadat' do
      expect(@instance).to be_instance_of(RebillySdk::Gigadat)
    end
  end
