...
# Unit tests for RebillySdk::MyFatoorahCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MyFatoorahCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::MyFatoorahCredentials.new
  end
  ...
  describe 'test an instance of MyFatoorahCredentials' do
    it 'should create an instance of MyFatoorahCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::MyFatoorahCredentials)
    end
  end
