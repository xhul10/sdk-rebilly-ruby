...
# Unit tests for RebillySdk::PayClubCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayClubCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayClubCredentials.new
  end
  ...
  describe 'test an instance of PayClubCredentials' do
    it 'should create an instance of PayClubCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayClubCredentials)
    end
  end
