...
# Unit tests for RebillySdk::CommonOrderPreviewItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrderPreviewItems' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrderPreviewItems.new
  end
  ...
  describe 'test an instance of CommonOrderPreviewItems' do
    it 'should create an instance of CommonOrderPreviewItems' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrderPreviewItems)
    end
  end
