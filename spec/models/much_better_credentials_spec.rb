...
# Unit tests for RebillySdk::MuchBetterCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MuchBetterCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::MuchBetterCredentials.new
  end
  ...
  describe 'test an instance of MuchBetterCredentials' do
    it 'should create an instance of MuchBetterCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::MuchBetterCredentials)
    end
  end
