...
# Unit tests for RebillySdk::FileCreateFromUrl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileCreateFromUrl' do
  before do
    # run before each test
    @instance = RebillySdk::FileCreateFromUrl.new
  end
  ...
  describe 'test an instance of FileCreateFromUrl' do
    it 'should create an instance of FileCreateFromUrl' do
      expect(@instance).to be_instance_of(RebillySdk::FileCreateFromUrl)
    end
  end
