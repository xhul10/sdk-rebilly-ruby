...
# Unit tests for RebillySdk::SecureTrading3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecureTrading3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::SecureTrading3dsServer.new
  end
  ...
  describe 'test an instance of SecureTrading3dsServer' do
    it 'should create an instance of SecureTrading3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::SecureTrading3dsServer)
    end
  end
