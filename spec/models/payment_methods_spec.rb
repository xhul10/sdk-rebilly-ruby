...
# Unit tests for RebillySdk::PaymentMethods
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethods' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentMethods.new
  end
  ...
  describe 'test an instance of PaymentMethods' do
    it 'should create an instance of PaymentMethods' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentMethods)
    end
  end
