...
# Unit tests for RebillySdk::AllOfSearchInvoicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfSearchInvoicesItems' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfSearchInvoicesItems.new
  end
  ...
  describe 'test an instance of AllOfSearchInvoicesItems' do
    it 'should create an instance of AllOfSearchInvoicesItems' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfSearchInvoicesItems)
    end
  end
