...
# Unit tests for RebillySdk::CopprSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CopprSettings' do
  before do
    # run before each test
    @instance = RebillySdk::CopprSettings.new
  end
  ...
  describe 'test an instance of CopprSettings' do
    it 'should create an instance of CopprSettings' do
      expect(@instance).to be_instance_of(RebillySdk::CopprSettings)
    end
  end
  describe 'test attribute "rebilly_publishable_key"' do
    it 'should work' do
