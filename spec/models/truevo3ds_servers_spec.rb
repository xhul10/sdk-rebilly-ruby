...
# Unit tests for RebillySdk::Truevo3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Truevo3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Truevo3dsServers.new
  end
  ...
  describe 'test an instance of Truevo3dsServers' do
    it 'should create an instance of Truevo3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Truevo3dsServers)
    end
  end
