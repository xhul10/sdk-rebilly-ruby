...
# Unit tests for RebillySdk::PanamericanCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PanamericanCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PanamericanCredentials.new
  end
  ...
  describe 'test an instance of PanamericanCredentials' do
    it 'should create an instance of PanamericanCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PanamericanCredentials)
    end
  end
