...
# Unit tests for RebillySdk::TransactionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionRequest' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionRequest.new
  end
  ...
  describe 'test an instance of TransactionRequest' do
    it 'should create an instance of TransactionRequest' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionRequest)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["3ds-authentication", "sale", "authorize", "setup"])
