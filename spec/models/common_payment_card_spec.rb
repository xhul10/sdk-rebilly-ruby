...
# Unit tests for RebillySdk::CommonPaymentCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonPaymentCard' do
  before do
    # run before each test
    @instance = RebillySdk::CommonPaymentCard.new
  end
  ...
  describe 'test an instance of CommonPaymentCard' do
    it 'should create an instance of CommonPaymentCard' do
      expect(@instance).to be_instance_of(RebillySdk::CommonPaymentCard)
    end
  end
