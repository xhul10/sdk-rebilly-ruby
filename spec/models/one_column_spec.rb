...
# Unit tests for RebillySdk::OneColumn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneColumn' do
  before do
    # run before each test
    @instance = RebillySdk::OneColumn.new
  end
  ...
  describe 'test an instance of OneColumn' do
    it 'should create an instance of OneColumn' do
      expect(@instance).to be_instance_of(RebillySdk::OneColumn)
    end
  end
