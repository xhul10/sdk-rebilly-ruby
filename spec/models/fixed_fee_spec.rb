...
# Unit tests for RebillySdk::FixedFee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedFee' do
  before do
    # run before each test
    @instance = RebillySdk::FixedFee.new
  end
  ...
  describe 'test an instance of FixedFee' do
    it 'should create an instance of FixedFee' do
      expect(@instance).to be_instance_of(RebillySdk::FixedFee)
    end
  end
