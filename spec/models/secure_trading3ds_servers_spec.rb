...
# Unit tests for RebillySdk::SecureTrading3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecureTrading3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::SecureTrading3dsServers.new
  end
  ...
  describe 'test an instance of SecureTrading3dsServers' do
    it 'should create an instance of SecureTrading3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::SecureTrading3dsServers)
    end
  end
