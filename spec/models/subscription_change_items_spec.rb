...
# Unit tests for RebillySdk::SubscriptionChangeItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionChangeItems' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionChangeItems.new
  end
  ...
  describe 'test an instance of SubscriptionChangeItems' do
    it 'should create an instance of SubscriptionChangeItems' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionChangeItems)
    end
  end
