...
# Unit tests for RebillySdk::RestrictToPlans
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestrictToPlans' do
  before do
    # run before each test
    @instance = RebillySdk::RestrictToPlans.new
  end
  ...
  describe 'test an instance of RestrictToPlans' do
    it 'should create an instance of RestrictToPlans' do
      expect(@instance).to be_instance_of(RebillySdk::RestrictToPlans)
    end
  end
