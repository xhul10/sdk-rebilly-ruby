...
# Unit tests for RebillySdk::GigadatCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GigadatCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::GigadatCredentials.new
  end
  ...
  describe 'test an instance of GigadatCredentials' do
    it 'should create an instance of GigadatCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::GigadatCredentials)
    end
  end
