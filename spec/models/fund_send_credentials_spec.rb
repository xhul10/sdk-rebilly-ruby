...
# Unit tests for RebillySdk::FundSendCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FundSendCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::FundSendCredentials.new
  end
  ...
  describe 'test an instance of FundSendCredentials' do
    it 'should create an instance of FundSendCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::FundSendCredentials)
    end
  end
