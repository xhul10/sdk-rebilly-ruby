...
# Unit tests for RebillySdk::FlexiblePlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlexiblePlan' do
  before do
    # run before each test
    @instance = RebillySdk::FlexiblePlan.new
  end
  ...
  describe 'test an instance of FlexiblePlan' do
    it 'should create an instance of FlexiblePlan' do
      expect(@instance).to be_instance_of(RebillySdk::FlexiblePlan)
    end
  end
  ...
  describe 'test attribute "currency_sign"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
