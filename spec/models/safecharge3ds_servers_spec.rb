...
# Unit tests for RebillySdk::Safecharge3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Safecharge3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Safecharge3dsServers.new
  end
  ...
  describe 'test an instance of Safecharge3dsServers' do
    it 'should create an instance of Safecharge3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Safecharge3dsServers)
    end
  end
