...
# Unit tests for RebillySdk::AllOfReadyToPayBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfReadyToPayBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfReadyToPayBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfReadyToPayBillingAddress' do
    it 'should create an instance of AllOfReadyToPayBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfReadyToPayBillingAddress)
    end
  end
