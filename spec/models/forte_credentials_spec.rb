...
# Unit tests for RebillySdk::ForteCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ForteCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ForteCredentials.new
  end
  ...
  describe 'test an instance of ForteCredentials' do
    it 'should create an instance of ForteCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ForteCredentials)
    end
  end
  ...
  describe 'test attribute "api_access_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
