...
# Unit tests for RebillySdk::PayULatamCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayULatamCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayULatamCredentials.new
  end
  ...
  describe 'test an instance of PayULatamCredentials' do
    it 'should create an instance of PayULatamCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayULatamCredentials)
    end
  end
  ...
  describe 'test attribute "api_login"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
