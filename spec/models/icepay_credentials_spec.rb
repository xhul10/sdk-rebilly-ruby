...
# Unit tests for RebillySdk::ICEPAYCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICEPAYCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ICEPAYCredentials.new
  end
  ...
  describe 'test an instance of ICEPAYCredentials' do
    it 'should create an instance of ICEPAYCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ICEPAYCredentials)
    end
  end
