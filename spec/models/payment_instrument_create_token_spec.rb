...
# Unit tests for RebillySdk::PaymentInstrumentCreateToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInstrumentCreateToken' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentInstrumentCreateToken.new
  end
  ...
  describe 'test an instance of PaymentInstrumentCreateToken' do
    it 'should create an instance of PaymentInstrumentCreateToken' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentInstrumentCreateToken)
    end
  end
