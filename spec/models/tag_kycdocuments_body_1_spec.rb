...
# Unit tests for RebillySdk::TagKycdocumentsBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TagKycdocumentsBody1' do
  before do
    # run before each test
    @instance = RebillySdk::TagKycdocumentsBody1.new
  end
  ...
  describe 'test an instance of TagKycdocumentsBody1' do
    it 'should create an instance of TagKycdocumentsBody1' do
      expect(@instance).to be_instance_of(RebillySdk::TagKycdocumentsBody1)
    end
  end
  describe 'test attribute "kyc_document_ids"' do
    it 'should work' do
