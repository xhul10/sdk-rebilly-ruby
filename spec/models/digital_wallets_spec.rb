...
# Unit tests for RebillySdk::DigitalWallets
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DigitalWallets' do
  before do
    # run before each test
    @instance = RebillySdk::DigitalWallets.new
  end
  ...
  describe 'test an instance of DigitalWallets' do
    it 'should create an instance of DigitalWallets' do
      expect(@instance).to be_instance_of(RebillySdk::DigitalWallets)
    end
  end
