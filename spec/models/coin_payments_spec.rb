...
# Unit tests for RebillySdk::CoinPayments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoinPayments' do
  before do
    # run before each test
    @instance = RebillySdk::CoinPayments.new
  end
  ...
  describe 'test an instance of CoinPayments' do
    it 'should create an instance of CoinPayments' do
      expect(@instance).to be_instance_of(RebillySdk::CoinPayments)
    end
  end
