...
# Unit tests for RebillySdk::InovioSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InovioSettings' do
  before do
    # run before each test
    @instance = RebillySdk::InovioSettings.new
  end
  ...
  describe 'test an instance of InovioSettings' do
    it 'should create an instance of InovioSettings' do
      expect(@instance).to be_instance_of(RebillySdk::InovioSettings)
    end
  end
