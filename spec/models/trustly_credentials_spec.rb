...
# Unit tests for RebillySdk::TrustlyCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustlyCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::TrustlyCredentials.new
  end
  ...
  describe 'test an instance of TrustlyCredentials' do
    it 'should create an instance of TrustlyCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::TrustlyCredentials)
    end
  end
