...
# Unit tests for RebillySdk::TagCustomersBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TagCustomersBody' do
  before do
    # run before each test
    @instance = RebillySdk::TagCustomersBody.new
  end
  ...
  describe 'test an instance of TagCustomersBody' do
    it 'should create an instance of TagCustomersBody' do
      expect(@instance).to be_instance_of(RebillySdk::TagCustomersBody)
    end
  end
