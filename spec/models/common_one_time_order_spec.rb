...
# Unit tests for RebillySdk::CommonOneTimeOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOneTimeOrder' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOneTimeOrder.new
  end
  ...
  describe 'test an instance of CommonOneTimeOrder' do
    it 'should create an instance of CommonOneTimeOrder' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOneTimeOrder)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "completed", "canceled"])
      # validator.allowable_values.each do |value|
