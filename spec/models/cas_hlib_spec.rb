...
# Unit tests for RebillySdk::CASHlib
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CASHlib' do
  before do
    # run before each test
    @instance = RebillySdk::CASHlib.new
  end
  ...
  describe 'test an instance of CASHlib' do
    it 'should create an instance of CASHlib' do
      expect(@instance).to be_instance_of(RebillySdk::CASHlib)
    end
  end
