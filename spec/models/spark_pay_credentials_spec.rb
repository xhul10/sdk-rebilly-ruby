...
# Unit tests for RebillySdk::SparkPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SparkPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SparkPayCredentials.new
  end
  ...
  describe 'test an instance of SparkPayCredentials' do
    it 'should create an instance of SparkPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SparkPayCredentials)
    end
  end
