...
# Unit tests for RebillySdk::InitialInvoiceEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InitialInvoiceEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::InitialInvoiceEmbed.new
  end
  ...
  describe 'test an instance of InitialInvoiceEmbed' do
    it 'should create an instance of InitialInvoiceEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::InitialInvoiceEmbed)
    end
  end
