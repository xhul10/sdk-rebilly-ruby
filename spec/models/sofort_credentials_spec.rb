...
# Unit tests for RebillySdk::SofortCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SofortCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SofortCredentials.new
  end
  ...
  describe 'test an instance of SofortCredentials' do
    it 'should create an instance of SofortCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SofortCredentials)
    end
  end
