...
# Unit tests for RebillySdk::CommonSubscriptionOrderLineItemSubtotal
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonSubscriptionOrderLineItemSubtotal' do
  before do
    # run before each test
    @instance = RebillySdk::CommonSubscriptionOrderLineItemSubtotal.new
  end
  ...
  describe 'test an instance of CommonSubscriptionOrderLineItemSubtotal' do
    it 'should create an instance of CommonSubscriptionOrderLineItemSubtotal' do
      expect(@instance).to be_instance_of(RebillySdk::CommonSubscriptionOrderLineItemSubtotal)
    end
  end
