...
# Unit tests for RebillySdk::CheckoutCom3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CheckoutCom3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::CheckoutCom3dsServers.new
  end
  ...
  describe 'test an instance of CheckoutCom3dsServers' do
    it 'should create an instance of CheckoutCom3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::CheckoutCom3dsServers)
    end
  end
