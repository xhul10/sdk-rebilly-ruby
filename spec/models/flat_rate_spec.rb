...
# Unit tests for RebillySdk::FlatRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlatRate' do
  before do
    # run before each test
    @instance = RebillySdk::FlatRate.new
  end
  ...
  describe 'test an instance of FlatRate' do
    it 'should create an instance of FlatRate' do
      expect(@instance).to be_instance_of(RebillySdk::FlatRate)
    end
  end
