...
# Unit tests for RebillySdk::DiscountsPerRedemption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DiscountsPerRedemption' do
  before do
    # run before each test
    @instance = RebillySdk::DiscountsPerRedemption.new
  end
  ...
  describe 'test an instance of DiscountsPerRedemption' do
    it 'should create an instance of DiscountsPerRedemption' do
      expect(@instance).to be_instance_of(RebillySdk::DiscountsPerRedemption)
    end
  end
