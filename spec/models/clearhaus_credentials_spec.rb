...
# Unit tests for RebillySdk::ClearhausCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClearhausCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ClearhausCredentials.new
  end
  ...
  describe 'test an instance of ClearhausCredentials' do
    it 'should create an instance of ClearhausCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ClearhausCredentials)
    end
  end
