...
# Unit tests for RebillySdk::Percent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Percent' do
  before do
    # run before each test
    @instance = RebillySdk::Percent.new
  end
  ...
  describe 'test an instance of Percent' do
    it 'should create an instance of Percent' do
      expect(@instance).to be_instance_of(RebillySdk::Percent)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fixed", "percent"])
