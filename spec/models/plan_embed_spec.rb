...
# Unit tests for RebillySdk::PlanEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::PlanEmbed.new
  end
  ...
  describe 'test an instance of PlanEmbed' do
    it 'should create an instance of PlanEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::PlanEmbed)
    end
  end
