...
# Unit tests for RebillySdk::ProofOfPurchaseDocumentMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfPurchaseDocumentMatches' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfPurchaseDocumentMatches.new
  end
  ...
  describe 'test an instance of ProofOfPurchaseDocumentMatches' do
    it 'should create an instance of ProofOfPurchaseDocumentMatches' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfPurchaseDocumentMatches)
    end
  end
