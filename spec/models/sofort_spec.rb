...
# Unit tests for RebillySdk::Sofort
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Sofort' do
  before do
    # run before each test
    @instance = RebillySdk::Sofort.new
  end
  ...
  describe 'test an instance of Sofort' do
    it 'should create an instance of Sofort' do
      expect(@instance).to be_instance_of(RebillySdk::Sofort)
    end
  end
