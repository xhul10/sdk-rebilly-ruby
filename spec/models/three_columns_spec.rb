...
# Unit tests for RebillySdk::ThreeColumns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThreeColumns' do
  before do
    # run before each test
    @instance = RebillySdk::ThreeColumns.new
  end
  ...
  describe 'test an instance of ThreeColumns' do
    it 'should create an instance of ThreeColumns' do
      expect(@instance).to be_instance_of(RebillySdk::ThreeColumns)
    end
  end
