...
# Unit tests for RebillySdk::LeadSourceData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LeadSourceData' do
  before do
    # run before each test
    @instance = RebillySdk::LeadSourceData.new
  end
  ...
  describe 'test an instance of LeadSourceData' do
    it 'should create an instance of LeadSourceData' do
      expect(@instance).to be_instance_of(RebillySdk::LeadSourceData)
    end
  end
  ...
  describe 'test attribute "sub_affiliate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sales_agent"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
