...
# Unit tests for RebillySdk::SecurionPay3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecurionPay3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::SecurionPay3dsServers.new
  end
  ...
  describe 'test an instance of SecurionPay3dsServers' do
    it 'should create an instance of SecurionPay3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::SecurionPay3dsServers)
    end
  end
