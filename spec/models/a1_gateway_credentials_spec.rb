...
# Unit tests for RebillySdk::A1GatewayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'A1GatewayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::A1GatewayCredentials.new
  end
  ...
  describe 'test an instance of A1GatewayCredentials' do
    it 'should create an instance of A1GatewayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::A1GatewayCredentials)
    end
  end
