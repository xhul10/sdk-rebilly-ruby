...
# Unit tests for RebillySdk::AllOfPaymentInstrumentUpdateTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfPaymentInstrumentUpdateTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfPaymentInstrumentUpdateTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfPaymentInstrumentUpdateTokenBillingAddress' do
    it 'should create an instance of AllOfPaymentInstrumentUpdateTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfPaymentInstrumentUpdateTokenBillingAddress)
    end
  end
