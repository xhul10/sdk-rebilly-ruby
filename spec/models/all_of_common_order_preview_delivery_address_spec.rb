...
# Unit tests for RebillySdk::AllOfCommonOrderPreviewDeliveryAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonOrderPreviewDeliveryAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonOrderPreviewDeliveryAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonOrderPreviewDeliveryAddress' do
    it 'should create an instance of AllOfCommonOrderPreviewDeliveryAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonOrderPreviewDeliveryAddress)
    end
  end
