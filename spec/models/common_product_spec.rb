...
# Unit tests for RebillySdk::CommonProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonProduct' do
  before do
    # run before each test
    @instance = RebillySdk::CommonProduct.new
  end
  ...
  describe 'test an instance of CommonProduct' do
    it 'should create an instance of CommonProduct' do
      expect(@instance).to be_instance_of(RebillySdk::CommonProduct)
    end
  end
