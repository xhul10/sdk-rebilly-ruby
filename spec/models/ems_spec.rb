...
# Unit tests for RebillySdk::EMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMS' do
  before do
    # run before each test
    @instance = RebillySdk::EMS.new
  end
  ...
  describe 'test an instance of EMS' do
    it 'should create an instance of EMS' do
      expect(@instance).to be_instance_of(RebillySdk::EMS)
    end
  end
