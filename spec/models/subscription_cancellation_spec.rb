...
# Unit tests for RebillySdk::SubscriptionCancellation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionCancellation' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionCancellation.new
  end
  ...
  describe 'test an instance of SubscriptionCancellation' do
    it 'should create an instance of SubscriptionCancellation' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionCancellation)
    end
  end
  ...
  describe 'test attribute "prorated_invoice_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "applied_invoice_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["did-not-use", "did-not-want", "missing-features", "bugs-or-problems", "do-not-remember", "risk-warning", "contract-expired", "too-expensive", "other", "billing-failure"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["draft", "confirmed", "completed", "revoked"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "churn_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
