...
# Unit tests for RebillySdk::EcoPayzSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EcoPayzSettings' do
  before do
    # run before each test
    @instance = RebillySdk::EcoPayzSettings.new
  end
  ...
  describe 'test an instance of EcoPayzSettings' do
    it 'should create an instance of EcoPayzSettings' do
      expect(@instance).to be_instance_of(RebillySdk::EcoPayzSettings)
    end
  end
  describe 'test attribute "valid_currency"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CAD", "EUR", "GBP", "USD"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.valid_currency = value }.not_to raise_error
      # end
    end
  end
