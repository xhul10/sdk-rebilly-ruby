...
# Unit tests for RebillySdk::BankAccountUpdatePlain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankAccountUpdatePlain' do
  before do
    # run before each test
    @instance = RebillySdk::BankAccountUpdatePlain.new
  end
  ...
  describe 'test an instance of BankAccountUpdatePlain' do
    it 'should create an instance of BankAccountUpdatePlain' do
      expect(@instance).to be_instance_of(RebillySdk::BankAccountUpdatePlain)
    end
  end
