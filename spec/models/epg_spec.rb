...
# Unit tests for RebillySdk::EPG
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EPG' do
  before do
    # run before each test
    @instance = RebillySdk::EPG.new
  end
  ...
  describe 'test an instance of EPG' do
    it 'should create an instance of EPG' do
      expect(@instance).to be_instance_of(RebillySdk::EPG)
    end
  end
