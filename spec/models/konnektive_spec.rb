...
# Unit tests for RebillySdk::Konnektive
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Konnektive' do
  before do
    # run before each test
    @instance = RebillySdk::Konnektive.new
  end
  ...
  describe 'test an instance of Konnektive' do
    it 'should create an instance of Konnektive' do
      expect(@instance).to be_instance_of(RebillySdk::Konnektive)
    end
  end
