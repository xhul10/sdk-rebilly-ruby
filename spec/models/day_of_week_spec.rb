...
# Unit tests for RebillySdk::DayOfWeek
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DayOfWeek' do
  before do
    # run before each test
    @instance = RebillySdk::DayOfWeek.new
  end
  ...
  describe 'test an instance of DayOfWeek' do
    it 'should create an instance of DayOfWeek' do
      expect(@instance).to be_instance_of(RebillySdk::DayOfWeek)
    end
  end
  ...
  describe 'test attribute "week"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["next", "first-in-month", "last-in-month"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.week = value }.not_to raise_error
      # end
    end
  end
