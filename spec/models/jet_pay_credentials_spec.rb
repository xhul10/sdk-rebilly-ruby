...
# Unit tests for RebillySdk::JetPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JetPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::JetPayCredentials.new
  end
  ...
  describe 'test an instance of JetPayCredentials' do
    it 'should create an instance of JetPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::JetPayCredentials)
    end
  end
