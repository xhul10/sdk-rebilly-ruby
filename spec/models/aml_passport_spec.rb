...
# Unit tests for RebillySdk::AMLPassport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AMLPassport' do
  before do
    # run before each test
    @instance = RebillySdk::AMLPassport.new
  end
  ...
  describe 'test an instance of AMLPassport' do
    it 'should create an instance of AMLPassport' do
      expect(@instance).to be_instance_of(RebillySdk::AMLPassport)
    end
  end
