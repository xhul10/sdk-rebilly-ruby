...
# Unit tests for RebillySdk::MuchBetterSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MuchBetterSettings' do
  before do
    # run before each test
    @instance = RebillySdk::MuchBetterSettings.new
  end
  ...
  describe 'test an instance of MuchBetterSettings' do
    it 'should create an instance of MuchBetterSettings' do
      expect(@instance).to be_instance_of(RebillySdk::MuchBetterSettings)
    end
  end
  ...
  describe 'test attribute "has_phone_number_request"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
