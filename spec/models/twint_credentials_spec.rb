...
# Unit tests for RebillySdk::TWINTCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TWINTCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::TWINTCredentials.new
  end
  ...
  describe 'test an instance of TWINTCredentials' do
    it 'should create an instance of TWINTCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::TWINTCredentials)
    end
  end
  describe 'test attribute "store_uuid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cash_register_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
