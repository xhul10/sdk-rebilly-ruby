...
# Unit tests for RebillySdk::EMS3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMS3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::EMS3dsServers.new
  end
  ...
  describe 'test an instance of EMS3dsServers' do
    it 'should create an instance of EMS3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::EMS3dsServers)
    end
  end
