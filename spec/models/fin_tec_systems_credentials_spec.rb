...
# Unit tests for RebillySdk::FinTecSystemsCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinTecSystemsCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::FinTecSystemsCredentials.new
  end
  ...
  describe 'test an instance of FinTecSystemsCredentials' do
    it 'should create an instance of FinTecSystemsCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::FinTecSystemsCredentials)
    end
  end
