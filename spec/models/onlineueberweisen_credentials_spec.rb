...
# Unit tests for RebillySdk::OnlineueberweisenCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnlineueberweisenCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::OnlineueberweisenCredentials.new
  end
  ...
  describe 'test an instance of OnlineueberweisenCredentials' do
    it 'should create an instance of OnlineueberweisenCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::OnlineueberweisenCredentials)
    end
  end
