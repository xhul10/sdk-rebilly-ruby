...
# Unit tests for RebillySdk::NinjaWalletCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NinjaWalletCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::NinjaWalletCredentials.new
  end
  ...
  describe 'test an instance of NinjaWalletCredentials' do
    it 'should create an instance of NinjaWalletCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::NinjaWalletCredentials)
    end
  end
