...
# Unit tests for RebillySdk::NMI
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NMI' do
  before do
    # run before each test
    @instance = RebillySdk::NMI.new
  end
  ...
  describe 'test an instance of NMI' do
    it 'should create an instance of NMI' do
      expect(@instance).to be_instance_of(RebillySdk::NMI)
    end
  end
