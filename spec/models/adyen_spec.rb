...
# Unit tests for RebillySdk::Adyen
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Adyen' do
  before do
    # run before each test
    @instance = RebillySdk::Adyen.new
  end
  ...
  describe 'test an instance of Adyen' do
    it 'should create an instance of Adyen' do
      expect(@instance).to be_instance_of(RebillySdk::Adyen)
    end
  end
