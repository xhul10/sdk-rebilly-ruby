...
# Unit tests for RebillySdk::Ilixium3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ilixium3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Ilixium3dsServers.new
  end
  ...
  describe 'test an instance of Ilixium3dsServers' do
    it 'should create an instance of Ilixium3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Ilixium3dsServers)
    end
  end
