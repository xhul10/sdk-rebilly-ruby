...
# Unit tests for RebillySdk::TimelineExtraData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineExtraData' do
  before do
    # run before each test
    @instance = RebillySdk::TimelineExtraData.new
  end
  ...
  describe 'test an instance of TimelineExtraData' do
    it 'should create an instance of TimelineExtraData' do
      expect(@instance).to be_instance_of(RebillySdk::TimelineExtraData)
    end
  end
