...
# Unit tests for RebillySdk::Jeton
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Jeton' do
  before do
    # run before each test
    @instance = RebillySdk::Jeton.new
  end
  ...
  describe 'test an instance of Jeton' do
    it 'should create an instance of Jeton' do
      expect(@instance).to be_instance_of(RebillySdk::Jeton)
    end
  end
