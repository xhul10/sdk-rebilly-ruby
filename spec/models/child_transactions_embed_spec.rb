...
# Unit tests for RebillySdk::ChildTransactionsEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTransactionsEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::ChildTransactionsEmbed.new
  end
  ...
  describe 'test an instance of ChildTransactionsEmbed' do
    it 'should create an instance of ChildTransactionsEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::ChildTransactionsEmbed)
    end
  end
