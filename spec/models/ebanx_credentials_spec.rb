...
# Unit tests for RebillySdk::EBANXCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EBANXCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EBANXCredentials.new
  end
  ...
  describe 'test an instance of EBANXCredentials' do
    it 'should create an instance of EBANXCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EBANXCredentials)
    end
  end
