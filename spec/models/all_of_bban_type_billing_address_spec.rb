...
# Unit tests for RebillySdk::AllOfBBANTypeBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfBBANTypeBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfBBANTypeBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfBBANTypeBillingAddress' do
    it 'should create an instance of AllOfBBANTypeBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfBBANTypeBillingAddress)
    end
  end
