...
# Unit tests for RebillySdk::Circle
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Circle' do
  before do
    # run before each test
    @instance = RebillySdk::Circle.new
  end
  ...
  describe 'test an instance of Circle' do
    it 'should create an instance of Circle' do
      expect(@instance).to be_instance_of(RebillySdk::Circle)
    end
  end
