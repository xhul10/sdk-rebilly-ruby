...
# Unit tests for RebillySdk::USAePay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'USAePay' do
  before do
    # run before each test
    @instance = RebillySdk::USAePay.new
  end
  ...
  describe 'test an instance of USAePay' do
    it 'should create an instance of USAePay' do
      expect(@instance).to be_instance_of(RebillySdk::USAePay)
    end
  end
