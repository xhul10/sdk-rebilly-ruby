...
# Unit tests for RebillySdk::Wirecard3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Wirecard3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Wirecard3dsServer.new
  end
  ...
  describe 'test an instance of Wirecard3dsServer' do
    it 'should create an instance of Wirecard3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Wirecard3dsServer)
    end
  end
