...
# Unit tests for RebillySdk::Pagsmile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pagsmile' do
  before do
    # run before each test
    @instance = RebillySdk::Pagsmile.new
  end
  ...
  describe 'test an instance of Pagsmile' do
    it 'should create an instance of Pagsmile' do
      expect(@instance).to be_instance_of(RebillySdk::Pagsmile)
    end
  end
