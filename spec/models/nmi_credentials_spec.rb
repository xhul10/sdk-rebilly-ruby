...
# Unit tests for RebillySdk::NMICredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NMICredentials' do
  before do
    # run before each test
    @instance = RebillySdk::NMICredentials.new
  end
  ...
  describe 'test an instance of NMICredentials' do
    it 'should create an instance of NMICredentials' do
      expect(@instance).to be_instance_of(RebillySdk::NMICredentials)
    end
  end
