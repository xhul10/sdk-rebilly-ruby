...
# Unit tests for RebillySdk::PaymenTechnologiesCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymenTechnologiesCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaymenTechnologiesCredentials.new
  end
  ...
  describe 'test an instance of PaymenTechnologiesCredentials' do
    it 'should create an instance of PaymenTechnologiesCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaymenTechnologiesCredentials)
    end
  end
  describe 'test attribute "authenticate_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "authenticate_pw"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
