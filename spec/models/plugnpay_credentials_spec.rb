...
# Unit tests for RebillySdk::PlugnpayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlugnpayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PlugnpayCredentials.new
  end
  ...
  describe 'test an instance of PlugnpayCredentials' do
    it 'should create an instance of PlugnpayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PlugnpayCredentials)
    end
  end
  describe 'test attribute "publisher_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "publisher_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
