...
# Unit tests for RebillySdk::SubscriptionReactivation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionReactivation' do
  before do
    # run before each test
    @instance = RebillySdk::SubscriptionReactivation.new
  end
  ...
  describe 'test an instance of SubscriptionReactivation' do
    it 'should create an instance of SubscriptionReactivation' do
      expect(@instance).to be_instance_of(RebillySdk::SubscriptionReactivation)
    end
  end
  ...
  describe 'test attribute "cancellation_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
