...
# Unit tests for RebillySdk::Walpay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Walpay' do
  before do
    # run before each test
    @instance = RebillySdk::Walpay.new
  end
  ...
  describe 'test an instance of Walpay' do
    it 'should create an instance of Walpay' do
      expect(@instance).to be_instance_of(RebillySdk::Walpay)
    end
  end
