...
# Unit tests for RebillySdk::PayPalBillingAgreementFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayPalBillingAgreementFeature' do
  before do
    # run before each test
    @instance = RebillySdk::PayPalBillingAgreementFeature.new
  end
  ...
  describe 'test an instance of PayPalBillingAgreementFeature' do
    it 'should create an instance of PayPalBillingAgreementFeature' do
      expect(@instance).to be_instance_of(RebillySdk::PayPalBillingAgreementFeature)
    end
  end
  ...
  describe 'test attribute "paypal_merchant_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "billing_agreement_token"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
