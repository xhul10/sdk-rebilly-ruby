...
# Unit tests for RebillySdk::GatewayAccountEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GatewayAccountEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::GatewayAccountEmbed.new
  end
  ...
  describe 'test an instance of GatewayAccountEmbed' do
    it 'should create an instance of GatewayAccountEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::GatewayAccountEmbed)
    end
  end
  describe 'test attribute "gateway_account"' do
    it 'should work' do
