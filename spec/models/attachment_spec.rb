...
# Unit tests for RebillySdk::Attachment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Attachment' do
  before do
    # run before each test
    @instance = RebillySdk::Attachment.new
  end
  ...
  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      expect(@instance).to be_instance_of(RebillySdk::Attachment)
    end
  end
  ...
  describe 'test attribute "related_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["customer", "dispute", "gateway-timeline-comment", "invoice", "organization", "payment", "plan", "product", "subscription", "transaction", "customer-timeline-comment", "transaction-timeline-comment", "order-timeline-comment"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.related_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "related_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
