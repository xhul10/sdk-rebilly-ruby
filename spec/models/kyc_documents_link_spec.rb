...
# Unit tests for RebillySdk::KycDocumentsLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycDocumentsLink' do
  before do
    # run before each test
    @instance = RebillySdk::KycDocumentsLink.new
  end
  ...
  describe 'test an instance of KycDocumentsLink' do
    it 'should create an instance of KycDocumentsLink' do
      expect(@instance).to be_instance_of(RebillySdk::KycDocumentsLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kycDocuments"])
