...
# Unit tests for RebillySdk::RapydSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RapydSettings' do
  before do
    # run before each test
    @instance = RebillySdk::RapydSettings.new
  end
  ...
  describe 'test an instance of RapydSettings' do
    it 'should create an instance of RapydSettings' do
      expect(@instance).to be_instance_of(RebillySdk::RapydSettings)
    end
  end
  describe 'test attribute "ipn_url"' do
    it 'should work' do
