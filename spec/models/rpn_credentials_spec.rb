...
# Unit tests for RebillySdk::RPNCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RPNCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::RPNCredentials.new
  end
  ...
  describe 'test an instance of RPNCredentials' do
    it 'should create an instance of RPNCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::RPNCredentials)
    end
  end
