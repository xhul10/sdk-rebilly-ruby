...
# Unit tests for RebillySdk::KycSettingsIdentity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycSettingsIdentity' do
  before do
    # run before each test
    @instance = RebillySdk::KycSettingsIdentity.new
  end
  ...
  describe 'test an instance of KycSettingsIdentity' do
    it 'should create an instance of KycSettingsIdentity' do
      expect(@instance).to be_instance_of(RebillySdk::KycSettingsIdentity)
    end
  end
