...
# Unit tests for RebillySdk::NinjaWallet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NinjaWallet' do
  before do
    # run before each test
    @instance = RebillySdk::NinjaWallet.new
  end
  ...
  describe 'test an instance of NinjaWallet' do
    it 'should create an instance of NinjaWallet' do
      expect(@instance).to be_instance_of(RebillySdk::NinjaWallet)
    end
  end
