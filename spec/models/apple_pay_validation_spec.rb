...
# Unit tests for RebillySdk::ApplePayValidation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApplePayValidation' do
  before do
    # run before each test
    @instance = RebillySdk::ApplePayValidation.new
  end
  ...
  describe 'test an instance of ApplePayValidation' do
    it 'should create an instance of ApplePayValidation' do
      expect(@instance).to be_instance_of(RebillySdk::ApplePayValidation)
    end
  end
  ...
  describe 'test attribute "validation_request"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "validation_response"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
