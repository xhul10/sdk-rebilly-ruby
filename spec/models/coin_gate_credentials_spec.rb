...
# Unit tests for RebillySdk::CoinGateCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoinGateCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CoinGateCredentials.new
  end
  ...
  describe 'test an instance of CoinGateCredentials' do
    it 'should create an instance of CoinGateCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CoinGateCredentials)
    end
  end
