...
# Unit tests for RebillySdk::CredoraxCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CredoraxCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CredoraxCredentials.new
  end
  ...
  describe 'test an instance of CredoraxCredentials' do
    it 'should create an instance of CredoraxCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CredoraxCredentials)
    end
  end
  ...
  describe 'test attribute "merchant_md5_signature"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
