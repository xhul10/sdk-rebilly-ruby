...
# Unit tests for RebillySdk::RebillyTaxjar
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RebillyTaxjar' do
  before do
    # run before each test
    @instance = RebillySdk::RebillyTaxjar.new
  end
  ...
  describe 'test an instance of RebillyTaxjar' do
    it 'should create an instance of RebillyTaxjar' do
      expect(@instance).to be_instance_of(RebillySdk::RebillyTaxjar)
    end
  end
  describe 'test attribute "calculator"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["manual", "rebilly-taxjar"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.calculator = value }.not_to raise_error
      # end
    end
  end
