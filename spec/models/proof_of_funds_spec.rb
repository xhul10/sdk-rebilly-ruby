...
# Unit tests for RebillySdk::ProofOfFunds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfFunds' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfFunds.new
  end
  ...
  describe 'test an instance of ProofOfFunds' do
    it 'should create an instance of ProofOfFunds' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfFunds)
    end
  end
