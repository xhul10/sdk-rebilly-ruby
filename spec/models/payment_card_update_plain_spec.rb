...
# Unit tests for RebillySdk::PaymentCardUpdatePlain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentCardUpdatePlain' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentCardUpdatePlain.new
  end
  ...
  describe 'test an instance of PaymentCardUpdatePlain' do
    it 'should create an instance of PaymentCardUpdatePlain' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentCardUpdatePlain)
    end
  end
