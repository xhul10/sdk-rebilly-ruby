...
# Unit tests for RebillySdk::KycDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycDocument' do
  before do
    # run before each test
    @instance = RebillySdk::KycDocument.new
  end
  ...
  describe 'test an instance of KycDocument' do
    it 'should create an instance of KycDocument' do
      expect(@instance).to be_instance_of(RebillySdk::KycDocument)
    end
  end
  ...
  describe 'test attribute "review_start_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
