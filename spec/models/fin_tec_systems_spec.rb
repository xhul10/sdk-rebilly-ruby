...
# Unit tests for RebillySdk::FinTecSystems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinTecSystems' do
  before do
    # run before each test
    @instance = RebillySdk::FinTecSystems.new
  end
  ...
  describe 'test an instance of FinTecSystems' do
    it 'should create an instance of FinTecSystems' do
      expect(@instance).to be_instance_of(RebillySdk::FinTecSystems)
    end
  end
