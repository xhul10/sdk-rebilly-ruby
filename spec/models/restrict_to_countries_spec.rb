...
# Unit tests for RebillySdk::RestrictToCountries
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestrictToCountries' do
  before do
    # run before each test
    @instance = RebillySdk::RestrictToCountries.new
  end
  ...
  describe 'test an instance of RestrictToCountries' do
    it 'should create an instance of RestrictToCountries' do
      expect(@instance).to be_instance_of(RebillySdk::RestrictToCountries)
    end
  end
