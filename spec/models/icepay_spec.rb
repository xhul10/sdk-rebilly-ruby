...
# Unit tests for RebillySdk::ICEPAY
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICEPAY' do
  before do
    # run before each test
    @instance = RebillySdk::ICEPAY.new
  end
  ...
  describe 'test an instance of ICEPAY' do
    it 'should create an instance of ICEPAY' do
      expect(@instance).to be_instance_of(RebillySdk::ICEPAY)
    end
  end
