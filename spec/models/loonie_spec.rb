...
# Unit tests for RebillySdk::Loonie
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Loonie' do
  before do
    # run before each test
    @instance = RebillySdk::Loonie.new
  end
  ...
  describe 'test an instance of Loonie' do
    it 'should create an instance of Loonie' do
      expect(@instance).to be_instance_of(RebillySdk::Loonie)
    end
  end
