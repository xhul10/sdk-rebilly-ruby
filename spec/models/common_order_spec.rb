...
# Unit tests for RebillySdk::CommonOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrder' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrder.new
  end
  ...
  describe 'test an instance of CommonOrder' do
    it 'should create an instance of CommonOrder' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrder)
    end
  end
