...
# Unit tests for RebillySdk::AllOfAlternativePaymentTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfAlternativePaymentTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfAlternativePaymentTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfAlternativePaymentTokenBillingAddress' do
    it 'should create an instance of AllOfAlternativePaymentTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfAlternativePaymentTokenBillingAddress)
    end
  end
