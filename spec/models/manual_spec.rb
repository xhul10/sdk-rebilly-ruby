...
# Unit tests for RebillySdk::Manual
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Manual' do
  before do
    # run before each test
    @instance = RebillySdk::Manual.new
  end
  ...
  describe 'test an instance of Manual' do
    it 'should create an instance of Manual' do
      expect(@instance).to be_instance_of(RebillySdk::Manual)
    end
  end
