...
# Unit tests for RebillySdk::OchaPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OchaPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::OchaPayCredentials.new
  end
  ...
  describe 'test an instance of OchaPayCredentials' do
    it 'should create an instance of OchaPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::OchaPayCredentials)
    end
  end
