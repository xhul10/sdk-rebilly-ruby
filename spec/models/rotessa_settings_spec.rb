...
# Unit tests for RebillySdk::RotessaSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RotessaSettings' do
  before do
    # run before each test
    @instance = RebillySdk::RotessaSettings.new
  end
  ...
  describe 'test an instance of RotessaSettings' do
    it 'should create an instance of RotessaSettings' do
      expect(@instance).to be_instance_of(RebillySdk::RotessaSettings)
    end
  end
