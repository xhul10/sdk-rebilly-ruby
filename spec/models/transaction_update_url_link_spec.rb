...
# Unit tests for RebillySdk::TransactionUpdateUrlLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionUpdateUrlLink' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionUpdateUrlLink.new
  end
  ...
  describe 'test an instance of TransactionUpdateUrlLink' do
    it 'should create an instance of TransactionUpdateUrlLink' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionUpdateUrlLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["updateUrl"])
