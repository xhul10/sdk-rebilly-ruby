...
# Unit tests for RebillySdk::BlueSnap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlueSnap' do
  before do
    # run before each test
    @instance = RebillySdk::BlueSnap.new
  end
  ...
  describe 'test an instance of BlueSnap' do
    it 'should create an instance of BlueSnap' do
      expect(@instance).to be_instance_of(RebillySdk::BlueSnap)
    end
  end
