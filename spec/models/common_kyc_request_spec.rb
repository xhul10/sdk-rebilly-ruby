...
# Unit tests for RebillySdk::CommonKycRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonKycRequest' do
  before do
    # run before each test
    @instance = RebillySdk::CommonKycRequest.new
  end
  ...
  describe 'test an instance of CommonKycRequest' do
    it 'should create an instance of CommonKycRequest' do
      expect(@instance).to be_instance_of(RebillySdk::CommonKycRequest)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unfulfilled", "pending", "rejected", "fulfilled", "expired"])
