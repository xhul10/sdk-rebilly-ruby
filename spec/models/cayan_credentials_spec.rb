...
# Unit tests for RebillySdk::CayanCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CayanCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CayanCredentials.new
  end
  ...
  describe 'test an instance of CayanCredentials' do
    it 'should create an instance of CayanCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CayanCredentials)
    end
  end
