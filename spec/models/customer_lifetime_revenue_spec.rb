...
# Unit tests for RebillySdk::CustomerLifetimeRevenue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerLifetimeRevenue' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerLifetimeRevenue.new
  end
  ...
  describe 'test an instance of CustomerLifetimeRevenue' do
    it 'should create an instance of CustomerLifetimeRevenue' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerLifetimeRevenue)
    end
  end
