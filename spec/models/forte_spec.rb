...
# Unit tests for RebillySdk::Forte
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Forte' do
  before do
    # run before each test
    @instance = RebillySdk::Forte.new
  end
  ...
  describe 'test an instance of Forte' do
    it 'should create an instance of Forte' do
      expect(@instance).to be_instance_of(RebillySdk::Forte)
    end
  end
