...
# Unit tests for RebillySdk::Blocklist
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Blocklist' do
  before do
    # run before each test
    @instance = RebillySdk::Blocklist.new
  end
  ...
  describe 'test an instance of Blocklist' do
    it 'should create an instance of Blocklist' do
      expect(@instance).to be_instance_of(RebillySdk::Blocklist)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["payment-card", "bank-account", "customer-id", "email", "email-domain", "ip-address", "country", "fingerprint", "bin", "address"])
