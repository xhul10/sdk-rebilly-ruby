...
# Unit tests for RebillySdk::AuthorizeNet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizeNet' do
  before do
    # run before each test
    @instance = RebillySdk::AuthorizeNet.new
  end
  ...
  describe 'test an instance of AuthorizeNet' do
    it 'should create an instance of AuthorizeNet' do
      expect(@instance).to be_instance_of(RebillySdk::AuthorizeNet)
    end
  end
