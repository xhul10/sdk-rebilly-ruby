...
# Unit tests for RebillySdk::AllOfPlaidAccountTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfPlaidAccountTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfPlaidAccountTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfPlaidAccountTokenBillingAddress' do
    it 'should create an instance of AllOfPlaidAccountTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfPlaidAccountTokenBillingAddress)
    end
  end
