...
# Unit tests for RebillySdk::ApplePayValidationValidationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApplePayValidationValidationRequest' do
  before do
    # run before each test
    @instance = RebillySdk::ApplePayValidationValidationRequest.new
  end
  ...
  describe 'test an instance of ApplePayValidationValidationRequest' do
    it 'should create an instance of ApplePayValidationValidationRequest' do
      expect(@instance).to be_instance_of(RebillySdk::ApplePayValidationValidationRequest)
    end
  end
