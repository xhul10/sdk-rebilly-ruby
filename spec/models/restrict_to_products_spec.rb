...
# Unit tests for RebillySdk::RestrictToProducts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestrictToProducts' do
  before do
    # run before each test
    @instance = RebillySdk::RestrictToProducts.new
  end
  ...
  describe 'test an instance of RestrictToProducts' do
    it 'should create an instance of RestrictToProducts' do
      expect(@instance).to be_instance_of(RebillySdk::RestrictToProducts)
    end
  end
