...
# Unit tests for RebillySdk::ProofOfIdentityDocumentMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfIdentityDocumentMatches' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfIdentityDocumentMatches.new
  end
  ...
  describe 'test an instance of ProofOfIdentityDocumentMatches' do
    it 'should create an instance of ProofOfIdentityDocumentMatches' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfIdentityDocumentMatches)
    end
  end
