...
# Unit tests for RebillySdk::Payvision3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Payvision3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Payvision3dsServer.new
  end
  ...
  describe 'test an instance of Payvision3dsServer' do
    it 'should create an instance of Payvision3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Payvision3dsServer)
    end
  end
