...
# Unit tests for RebillySdk::IDebitCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IDebitCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::IDebitCredentials.new
  end
  ...
  describe 'test an instance of IDebitCredentials' do
    it 'should create an instance of IDebitCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::IDebitCredentials)
    end
  end
