...
# Unit tests for RebillySdk::CustomerTimelineCustomEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerTimelineCustomEvent' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerTimelineCustomEvent.new
  end
  ...
  describe 'test an instance of CustomerTimelineCustomEvent' do
    it 'should create an instance of CustomerTimelineCustomEvent' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerTimelineCustomEvent)
    end
  end
