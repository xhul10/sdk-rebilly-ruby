...
# Unit tests for RebillySdk::DigitalWalletsGooglePay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DigitalWalletsGooglePay' do
  before do
    # run before each test
    @instance = RebillySdk::DigitalWalletsGooglePay.new
  end
  ...
  describe 'test an instance of DigitalWalletsGooglePay' do
    it 'should create an instance of DigitalWalletsGooglePay' do
      expect(@instance).to be_instance_of(RebillySdk::DigitalWalletsGooglePay)
    end
  end
  ...
  describe 'test attribute "merchant_origin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
