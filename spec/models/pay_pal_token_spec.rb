...
# Unit tests for RebillySdk::PayPalToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayPalToken' do
  before do
    # run before each test
    @instance = RebillySdk::PayPalToken.new
  end
  ...
  describe 'test an instance of PayPalToken' do
    it 'should create an instance of PayPalToken' do
      expect(@instance).to be_instance_of(RebillySdk::PayPalToken)
    end
  end
