...
# Unit tests for RebillySdk::AuthenticationOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthenticationOptions' do
  before do
    # run before each test
    @instance = RebillySdk::AuthenticationOptions.new
  end
  ...
  describe 'test an instance of AuthenticationOptions' do
    it 'should create an instance of AuthenticationOptions' do
      expect(@instance).to be_instance_of(RebillySdk::AuthenticationOptions)
    end
  end
  ...
  describe 'test attribute "credential_ttl"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "auth_token_ttl"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "reset_token_ttl"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "otp_required"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
