...
# Unit tests for RebillySdk::RecentInvoiceLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecentInvoiceLink' do
  before do
    # run before each test
    @instance = RebillySdk::RecentInvoiceLink.new
  end
  ...
  describe 'test an instance of RecentInvoiceLink' do
    it 'should create an instance of RecentInvoiceLink' do
      expect(@instance).to be_instance_of(RebillySdk::RecentInvoiceLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["recentInvoice"])
