...
# Unit tests for RebillySdk::ParamountEft
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParamountEft' do
  before do
    # run before each test
    @instance = RebillySdk::ParamountEft.new
  end
  ...
  describe 'test an instance of ParamountEft' do
    it 'should create an instance of ParamountEft' do
      expect(@instance).to be_instance_of(RebillySdk::ParamountEft)
    end
  end
