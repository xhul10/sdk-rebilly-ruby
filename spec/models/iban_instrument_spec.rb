...
# Unit tests for RebillySdk::IBANInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IBANInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::IBANInstrument.new
  end
  ...
  describe 'test an instance of IBANInstrument' do
    it 'should create an instance of IBANInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::IBANInstrument)
    end
  end
