...
# Unit tests for RebillySdk::BankAccountInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankAccountInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::BankAccountInstrument.new
  end
  ...
  describe 'test an instance of BankAccountInstrument' do
    it 'should create an instance of BankAccountInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::BankAccountInstrument)
    end
  end
