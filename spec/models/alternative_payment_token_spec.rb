...
# Unit tests for RebillySdk::AlternativePaymentToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlternativePaymentToken' do
  before do
    # run before each test
    @instance = RebillySdk::AlternativePaymentToken.new
  end
  ...
  describe 'test an instance of AlternativePaymentToken' do
    it 'should create an instance of AlternativePaymentToken' do
      expect(@instance).to be_instance_of(RebillySdk::AlternativePaymentToken)
    end
  end
