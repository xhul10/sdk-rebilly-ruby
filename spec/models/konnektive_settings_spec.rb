...
# Unit tests for RebillySdk::KonnektiveSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KonnektiveSettings' do
  before do
    # run before each test
    @instance = RebillySdk::KonnektiveSettings.new
  end
  ...
  describe 'test an instance of KonnektiveSettings' do
    it 'should create an instance of KonnektiveSettings' do
      expect(@instance).to be_instance_of(RebillySdk::KonnektiveSettings)
    end
  end
