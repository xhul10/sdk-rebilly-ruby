...
# Unit tests for RebillySdk::Wallet88Credentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Wallet88Credentials' do
  before do
    # run before each test
    @instance = RebillySdk::Wallet88Credentials.new
  end
  ...
  describe 'test an instance of Wallet88Credentials' do
    it 'should create an instance of Wallet88Credentials' do
      expect(@instance).to be_instance_of(RebillySdk::Wallet88Credentials)
    end
  end
