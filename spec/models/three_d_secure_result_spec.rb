...
# Unit tests for RebillySdk::ThreeDSecureResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThreeDSecureResult' do
  before do
    # run before each test
    @instance = RebillySdk::ThreeDSecureResult.new
  end
  ...
  describe 'test an instance of ThreeDSecureResult' do
    it 'should create an instance of ThreeDSecureResult' do
      expect(@instance).to be_instance_of(RebillySdk::ThreeDSecureResult)
    end
  end
