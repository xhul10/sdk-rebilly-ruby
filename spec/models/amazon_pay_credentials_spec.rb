...
# Unit tests for RebillySdk::AmazonPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AmazonPayCredentials.new
  end
  ...
  describe 'test an instance of AmazonPayCredentials' do
    it 'should create an instance of AmazonPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AmazonPayCredentials)
    end
  end
  ...
  describe 'test attribute "public_key_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
