...
# Unit tests for RebillySdk::IBANType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IBANType' do
  before do
    # run before each test
    @instance = RebillySdk::IBANType.new
  end
  ...
  describe 'test an instance of IBANType' do
    it 'should create an instance of IBANType' do
      expect(@instance).to be_instance_of(RebillySdk::IBANType)
    end
  end
