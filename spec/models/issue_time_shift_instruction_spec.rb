...
# Unit tests for RebillySdk::IssueTimeShiftInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IssueTimeShiftInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::IssueTimeShiftInstruction.new
  end
  ...
  describe 'test an instance of IssueTimeShiftInstruction' do
    it 'should create an instance of IssueTimeShiftInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::IssueTimeShiftInstruction)
    end
  end
  describe 'test attribute "chronology"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["before"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.chronology = value }.not_to raise_error
      # end
    end
  end
