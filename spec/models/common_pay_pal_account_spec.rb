...
# Unit tests for RebillySdk::CommonPayPalAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonPayPalAccount' do
  before do
    # run before each test
    @instance = RebillySdk::CommonPayPalAccount.new
  end
  ...
  describe 'test an instance of CommonPayPalAccount' do
    it 'should create an instance of CommonPayPalAccount' do
      expect(@instance).to be_instance_of(RebillySdk::CommonPayPalAccount)
    end
  end
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["paypal"])
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["inactive", "active", "deactivated"])
      # validator.allowable_values.each do |value|
