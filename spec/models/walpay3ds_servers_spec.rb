...
# Unit tests for RebillySdk::Walpay3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Walpay3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Walpay3dsServers.new
  end
  ...
  describe 'test an instance of Walpay3dsServers' do
    it 'should create an instance of Walpay3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Walpay3dsServers)
    end
  end
