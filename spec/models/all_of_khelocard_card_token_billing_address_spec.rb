...
# Unit tests for RebillySdk::AllOfKhelocardCardTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfKhelocardCardTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfKhelocardCardTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfKhelocardCardTokenBillingAddress' do
    it 'should create an instance of AllOfKhelocardCardTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfKhelocardCardTokenBillingAddress)
    end
  end
