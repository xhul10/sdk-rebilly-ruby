...
# Unit tests for RebillySdk::AllOfCommonPayPalAccountBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonPayPalAccountBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonPayPalAccountBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonPayPalAccountBillingAddress' do
    it 'should create an instance of AllOfCommonPayPalAccountBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonPayPalAccountBillingAddress)
    end
  end
