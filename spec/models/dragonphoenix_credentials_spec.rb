...
# Unit tests for RebillySdk::DragonphoenixCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DragonphoenixCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::DragonphoenixCredentials.new
  end
  ...
  describe 'test an instance of DragonphoenixCredentials' do
    it 'should create an instance of DragonphoenixCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::DragonphoenixCredentials)
    end
  end
