...
# Unit tests for RebillySdk::CouponExpiration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponExpiration' do
  before do
    # run before each test
    @instance = RebillySdk::CouponExpiration.new
  end
  ...
  describe 'test an instance of CouponExpiration' do
    it 'should create an instance of CouponExpiration' do
      expect(@instance).to be_instance_of(RebillySdk::CouponExpiration)
    end
  end
