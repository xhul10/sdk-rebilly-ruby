...
# Unit tests for RebillySdk::InvoicesEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicesEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::InvoicesEmbed.new
  end
  ...
  describe 'test an instance of InvoicesEmbed' do
    it 'should create an instance of InvoicesEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::InvoicesEmbed)
    end
  end
