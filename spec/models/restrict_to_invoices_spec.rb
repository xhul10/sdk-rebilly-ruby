...
# Unit tests for RebillySdk::RestrictToInvoices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestrictToInvoices' do
  before do
    # run before each test
    @instance = RebillySdk::RestrictToInvoices.new
  end
  ...
  describe 'test an instance of RestrictToInvoices' do
    it 'should create an instance of RestrictToInvoices' do
      expect(@instance).to be_instance_of(RebillySdk::RestrictToInvoices)
    end
  end
