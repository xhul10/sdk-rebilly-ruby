...
# Unit tests for RebillySdk::AllOfCommonBankAccountBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonBankAccountBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonBankAccountBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonBankAccountBillingAddress' do
    it 'should create an instance of AllOfCommonBankAccountBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonBankAccountBillingAddress)
    end
  end
