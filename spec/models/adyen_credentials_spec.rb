...
# Unit tests for RebillySdk::AdyenCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdyenCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AdyenCredentials.new
  end
  ...
  describe 'test an instance of AdyenCredentials' do
    it 'should create an instance of AdyenCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AdyenCredentials)
    end
  end
