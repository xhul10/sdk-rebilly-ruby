...
# Unit tests for RebillySdk::ProofOfIdentity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfIdentity' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfIdentity.new
  end
  ...
  describe 'test an instance of ProofOfIdentity' do
    it 'should create an instance of ProofOfIdentity' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfIdentity)
    end
  end
  ...
  describe 'test attribute "document_matches"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
