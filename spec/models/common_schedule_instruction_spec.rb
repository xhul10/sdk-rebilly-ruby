...
# Unit tests for RebillySdk::CommonScheduleInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonScheduleInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::CommonScheduleInstruction.new
  end
  ...
  describe 'test an instance of CommonScheduleInstruction' do
    it 'should create an instance of CommonScheduleInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::CommonScheduleInstruction)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["auto", "immediately", "date-interval", "day-of-month", "day-of-week"])
