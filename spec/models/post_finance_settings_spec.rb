...
# Unit tests for RebillySdk::PostFinanceSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostFinanceSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PostFinanceSettings.new
  end
  ...
  describe 'test an instance of PostFinanceSettings' do
    it 'should create an instance of PostFinanceSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PostFinanceSettings)
    end
  end
  describe 'test attribute "skip_payment_file_upload"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "enable_alias_authentication"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
