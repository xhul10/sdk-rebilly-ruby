...
# Unit tests for RebillySdk::TimelineTable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineTable' do
  before do
    # run before each test
    @instance = RebillySdk::TimelineTable.new
  end
  ...
  describe 'test an instance of TimelineTable' do
    it 'should create an instance of TimelineTable' do
      expect(@instance).to be_instance_of(RebillySdk::TimelineTable)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["list", "one-columns", "two-columns", "three-columns"])
