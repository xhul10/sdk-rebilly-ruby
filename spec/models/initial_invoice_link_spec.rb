...
# Unit tests for RebillySdk::InitialInvoiceLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InitialInvoiceLink' do
  before do
    # run before each test
    @instance = RebillySdk::InitialInvoiceLink.new
  end
  ...
  describe 'test an instance of InitialInvoiceLink' do
    it 'should create an instance of InitialInvoiceLink' do
      expect(@instance).to be_instance_of(RebillySdk::InitialInvoiceLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["initialInvoice"])
