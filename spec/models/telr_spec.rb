...
# Unit tests for RebillySdk::Telr
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Telr' do
  before do
    # run before each test
    @instance = RebillySdk::Telr.new
  end
  ...
  describe 'test an instance of Telr' do
    it 'should create an instance of Telr' do
      expect(@instance).to be_instance_of(RebillySdk::Telr)
    end
  end
