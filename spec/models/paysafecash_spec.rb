...
# Unit tests for RebillySdk::Paysafecash
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Paysafecash' do
  before do
    # run before each test
    @instance = RebillySdk::Paysafecash.new
  end
  ...
  describe 'test an instance of Paysafecash' do
    it 'should create an instance of Paysafecash' do
      expect(@instance).to be_instance_of(RebillySdk::Paysafecash)
    end
  end
