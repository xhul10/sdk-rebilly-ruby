...
# Unit tests for RebillySdk::OrganizationEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::OrganizationEmbed.new
  end
  ...
  describe 'test an instance of OrganizationEmbed' do
    it 'should create an instance of OrganizationEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::OrganizationEmbed)
    end
  end
