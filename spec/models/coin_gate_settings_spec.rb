...
# Unit tests for RebillySdk::CoinGateSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoinGateSettings' do
  before do
    # run before each test
    @instance = RebillySdk::CoinGateSettings.new
  end
  ...
  describe 'test an instance of CoinGateSettings' do
    it 'should create an instance of CoinGateSettings' do
      expect(@instance).to be_instance_of(RebillySdk::CoinGateSettings)
    end
  end
