...
# Unit tests for RebillySdk::DLocal
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DLocal' do
  before do
    # run before each test
    @instance = RebillySdk::DLocal.new
  end
  ...
  describe 'test an instance of DLocal' do
    it 'should create an instance of DLocal' do
      expect(@instance).to be_instance_of(RebillySdk::DLocal)
    end
  end
