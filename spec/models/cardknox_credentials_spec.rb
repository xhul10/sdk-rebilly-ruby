...
# Unit tests for RebillySdk::CardknoxCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardknoxCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CardknoxCredentials.new
  end
  ...
  describe 'test an instance of CardknoxCredentials' do
    it 'should create an instance of CardknoxCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CardknoxCredentials)
    end
  end
  describe 'test attribute "x_key"' do
    it 'should work' do
