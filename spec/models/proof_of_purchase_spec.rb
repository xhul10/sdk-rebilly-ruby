...
# Unit tests for RebillySdk::ProofOfPurchase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProofOfPurchase' do
  before do
    # run before each test
    @instance = RebillySdk::ProofOfPurchase.new
  end
  ...
  describe 'test an instance of ProofOfPurchase' do
    it 'should create an instance of ProofOfPurchase' do
      expect(@instance).to be_instance_of(RebillySdk::ProofOfPurchase)
    end
  end
