...
# Unit tests for RebillySdk::Coppr
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Coppr' do
  before do
    # run before each test
    @instance = RebillySdk::Coppr.new
  end
  ...
  describe 'test an instance of Coppr' do
    it 'should create an instance of Coppr' do
      expect(@instance).to be_instance_of(RebillySdk::Coppr)
    end
  end
