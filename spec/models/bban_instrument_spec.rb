...
# Unit tests for RebillySdk::BBANInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BBANInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::BBANInstrument.new
  end
  ...
  describe 'test an instance of BBANInstrument' do
    it 'should create an instance of BBANInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::BBANInstrument)
    end
  end
