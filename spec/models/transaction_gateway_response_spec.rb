...
# Unit tests for RebillySdk::TransactionGatewayResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionGatewayResponse' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionGatewayResponse.new
  end
  ...
  describe 'test an instance of TransactionGatewayResponse' do
    it 'should create an instance of TransactionGatewayResponse' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionGatewayResponse)
    end
  end
