...
# Unit tests for RebillySdk::AMLAliases
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AMLAliases' do
  before do
    # run before each test
    @instance = RebillySdk::AMLAliases.new
  end
  ...
  describe 'test an instance of AMLAliases' do
    it 'should create an instance of AMLAliases' do
      expect(@instance).to be_instance_of(RebillySdk::AMLAliases)
    end
  end
  ...
  describe 'test attribute "authenticity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["strong", "weak", "unknown"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.authenticity = value }.not_to raise_error
      # end
    end
  end
