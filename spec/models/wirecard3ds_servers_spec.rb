...
# Unit tests for RebillySdk::Wirecard3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Wirecard3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Wirecard3dsServers.new
  end
  ...
  describe 'test an instance of Wirecard3dsServers' do
    it 'should create an instance of Wirecard3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Wirecard3dsServers)
    end
  end
