...
# Unit tests for RebillySdk::NGenius3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NGenius3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::NGenius3dsServers.new
  end
  ...
  describe 'test an instance of NGenius3dsServers' do
    it 'should create an instance of NGenius3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::NGenius3dsServers)
    end
  end
