...
# Unit tests for RebillySdk::SMSVoucher
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SMSVoucher' do
  before do
    # run before each test
    @instance = RebillySdk::SMSVoucher.new
  end
  ...
  describe 'test an instance of SMSVoucher' do
    it 'should create an instance of SMSVoucher' do
      expect(@instance).to be_instance_of(RebillySdk::SMSVoucher)
    end
  end
