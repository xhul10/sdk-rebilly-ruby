...
# Unit tests for RebillySdk::Cardknox
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Cardknox' do
  before do
    # run before each test
    @instance = RebillySdk::Cardknox.new
  end
  ...
  describe 'test an instance of Cardknox' do
    it 'should create an instance of Cardknox' do
      expect(@instance).to be_instance_of(RebillySdk::Cardknox)
    end
  end
