...
# Unit tests for RebillySdk::PaysafecashCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaysafecashCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaysafecashCredentials.new
  end
  ...
  describe 'test an instance of PaysafecashCredentials' do
    it 'should create an instance of PaysafecashCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaysafecashCredentials)
    end
  end
