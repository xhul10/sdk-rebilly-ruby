...
# Unit tests for RebillySdk::AllOfBankAccountTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfBankAccountTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfBankAccountTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfBankAccountTokenBillingAddress' do
    it 'should create an instance of AllOfBankAccountTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfBankAccountTokenBillingAddress)
    end
  end
