...
# Unit tests for RebillySdk::TransactionRefund
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionRefund' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionRefund.new
  end
  ...
  describe 'test an instance of TransactionRefund' do
    it 'should create an instance of TransactionRefund' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionRefund)
    end
  end
