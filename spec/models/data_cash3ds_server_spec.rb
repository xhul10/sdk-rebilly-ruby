...
# Unit tests for RebillySdk::DataCash3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataCash3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::DataCash3dsServer.new
  end
  ...
  describe 'test an instance of DataCash3dsServer' do
    it 'should create an instance of DataCash3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::DataCash3dsServer)
    end
  end
