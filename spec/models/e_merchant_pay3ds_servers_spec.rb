...
# Unit tests for RebillySdk::EMerchantPay3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMerchantPay3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::EMerchantPay3dsServers.new
  end
  ...
  describe 'test an instance of EMerchantPay3dsServers' do
    it 'should create an instance of EMerchantPay3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::EMerchantPay3dsServers)
    end
  end
