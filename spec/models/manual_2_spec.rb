...
# Unit tests for RebillySdk::Manual2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Manual2' do
  before do
    # run before each test
    @instance = RebillySdk::Manual2.new
  end
  ...
  describe 'test an instance of Manual2' do
    it 'should create an instance of Manual2' do
      expect(@instance).to be_instance_of(RebillySdk::Manual2)
    end
  end
