...
# Unit tests for RebillySdk::LeadSourceEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LeadSourceEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::LeadSourceEmbed.new
  end
  ...
  describe 'test an instance of LeadSourceEmbed' do
    it 'should create an instance of LeadSourceEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::LeadSourceEmbed)
    end
  end
