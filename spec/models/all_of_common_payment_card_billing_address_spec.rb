...
# Unit tests for RebillySdk::AllOfCommonPaymentCardBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonPaymentCardBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonPaymentCardBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonPaymentCardBillingAddress' do
    it 'should create an instance of AllOfCommonPaymentCardBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonPaymentCardBillingAddress)
    end
  end
