...
# Unit tests for RebillySdk::ReadyToPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPay' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPay.new
  end
  ...
  describe 'test an instance of ReadyToPay' do
    it 'should create an instance of ReadyToPay' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPay)
    end
  end
