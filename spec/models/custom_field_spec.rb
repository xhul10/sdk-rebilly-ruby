...
# Unit tests for RebillySdk::CustomField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomField' do
  before do
    # run before each test
    @instance = RebillySdk::CustomField.new
  end
  ...
  describe 'test an instance of CustomField' do
    it 'should create an instance of CustomField' do
      expect(@instance).to be_instance_of(RebillySdk::CustomField)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["array", "boolean", "datetime", "integer", "number", "string", "monetary"])
  ...
  describe 'test attribute "additional_schema"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
