...
# Unit tests for RebillySdk::Payvision3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Payvision3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Payvision3dsServers.new
  end
  ...
  describe 'test an instance of Payvision3dsServers' do
    it 'should create an instance of Payvision3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Payvision3dsServers)
    end
  end
