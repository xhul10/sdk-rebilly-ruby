...
# Unit tests for RebillySdk::PaymentAsia
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentAsia' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentAsia.new
  end
  ...
  describe 'test an instance of PaymentAsia' do
    it 'should create an instance of PaymentAsia' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentAsia)
    end
  end
