...
# Unit tests for RebillySdk::ParamountEftCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParamountEftCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ParamountEftCredentials.new
  end
  ...
  describe 'test an instance of ParamountEftCredentials' do
    it 'should create an instance of ParamountEftCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ParamountEftCredentials)
    end
  end
  ...
  describe 'test attribute "merchant_pass"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
