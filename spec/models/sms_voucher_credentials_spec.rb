...
# Unit tests for RebillySdk::SMSVoucherCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SMSVoucherCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SMSVoucherCredentials.new
  end
  ...
  describe 'test an instance of SMSVoucherCredentials' do
    it 'should create an instance of SMSVoucherCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SMSVoucherCredentials)
    end
  end
