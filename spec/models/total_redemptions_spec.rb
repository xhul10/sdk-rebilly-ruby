...
# Unit tests for RebillySdk::TotalRedemptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TotalRedemptions' do
  before do
    # run before each test
    @instance = RebillySdk::TotalRedemptions.new
  end
  ...
  describe 'test an instance of TotalRedemptions' do
    it 'should create an instance of TotalRedemptions' do
      expect(@instance).to be_instance_of(RebillySdk::TotalRedemptions)
    end
  end
