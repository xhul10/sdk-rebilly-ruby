...
# Unit tests for RebillySdk::InvoiceRetryScheduleInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceRetryScheduleInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceRetryScheduleInstruction.new
  end
  ...
  describe 'test an instance of InvoiceRetryScheduleInstruction' do
    it 'should create an instance of InvoiceRetryScheduleInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceRetryScheduleInstruction)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["immediately", "date-interval", "day-of-month", "day-of-week"])
