...
# Unit tests for RebillySdk::NeosurfCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NeosurfCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::NeosurfCredentials.new
  end
  ...
  describe 'test an instance of NeosurfCredentials' do
    it 'should create an instance of NeosurfCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::NeosurfCredentials)
    end
  end
