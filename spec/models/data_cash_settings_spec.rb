...
# Unit tests for RebillySdk::DataCashSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataCashSettings' do
  before do
    # run before each test
    @instance = RebillySdk::DataCashSettings.new
  end
  ...
  describe 'test an instance of DataCashSettings' do
    it 'should create an instance of DataCashSettings' do
      expect(@instance).to be_instance_of(RebillySdk::DataCashSettings)
    end
  end
