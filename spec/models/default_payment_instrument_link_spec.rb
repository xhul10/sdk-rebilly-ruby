...
# Unit tests for RebillySdk::DefaultPaymentInstrumentLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefaultPaymentInstrumentLink' do
  before do
    # run before each test
    @instance = RebillySdk::DefaultPaymentInstrumentLink.new
  end
  ...
  describe 'test an instance of DefaultPaymentInstrumentLink' do
    it 'should create an instance of DefaultPaymentInstrumentLink' do
      expect(@instance).to be_instance_of(RebillySdk::DefaultPaymentInstrumentLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["defaultPaymentInstrument"])
