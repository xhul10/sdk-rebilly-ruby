...
# Unit tests for RebillySdk::AmexVPCCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmexVPCCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AmexVPCCredentials.new
  end
  ...
  describe 'test an instance of AmexVPCCredentials' do
    it 'should create an instance of AmexVPCCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AmexVPCCredentials)
    end
  end
