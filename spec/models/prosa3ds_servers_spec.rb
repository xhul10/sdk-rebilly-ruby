...
# Unit tests for RebillySdk::Prosa3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Prosa3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Prosa3dsServers.new
  end
  ...
  describe 'test an instance of Prosa3dsServers' do
    it 'should create an instance of Prosa3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Prosa3dsServers)
    end
  end
