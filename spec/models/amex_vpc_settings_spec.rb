...
# Unit tests for RebillySdk::AmexVPCSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmexVPCSettings' do
  before do
    # run before each test
    @instance = RebillySdk::AmexVPCSettings.new
  end
  ...
  describe 'test an instance of AmexVPCSettings' do
    it 'should create an instance of AmexVPCSettings' do
      expect(@instance).to be_instance_of(RebillySdk::AmexVPCSettings)
    end
  end
