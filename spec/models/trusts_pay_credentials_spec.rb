...
# Unit tests for RebillySdk::TrustsPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustsPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::TrustsPayCredentials.new
  end
  ...
  describe 'test an instance of TrustsPayCredentials' do
    it 'should create an instance of TrustsPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::TrustsPayCredentials)
    end
  end
  describe 'test attribute "merchant_no"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "gateway_no"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "signkey"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
