...
# Unit tests for RebillySdk::PayULatam
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayULatam' do
  before do
    # run before each test
    @instance = RebillySdk::PayULatam.new
  end
  ...
  describe 'test an instance of PayULatam' do
    it 'should create an instance of PayULatam' do
      expect(@instance).to be_instance_of(RebillySdk::PayULatam)
    end
  end
