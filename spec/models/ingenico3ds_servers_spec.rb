...
# Unit tests for RebillySdk::Ingenico3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ingenico3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Ingenico3dsServers.new
  end
  ...
  describe 'test an instance of Ingenico3dsServers' do
    it 'should create an instance of Ingenico3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Ingenico3dsServers)
    end
  end
