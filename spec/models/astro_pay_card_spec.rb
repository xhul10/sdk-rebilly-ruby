...
# Unit tests for RebillySdk::AstroPayCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AstroPayCard' do
  before do
    # run before each test
    @instance = RebillySdk::AstroPayCard.new
  end
  ...
  describe 'test an instance of AstroPayCard' do
    it 'should create an instance of AstroPayCard' do
      expect(@instance).to be_instance_of(RebillySdk::AstroPayCard)
    end
  end
