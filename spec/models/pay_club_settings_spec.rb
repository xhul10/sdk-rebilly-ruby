...
# Unit tests for RebillySdk::PayClubSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayClubSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PayClubSettings.new
  end
  ...
  describe 'test an instance of PayClubSettings' do
    it 'should create an instance of PayClubSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PayClubSettings)
    end
  end
  describe 'test attribute "use3_ds_channel"' do
    it 'should work' do
