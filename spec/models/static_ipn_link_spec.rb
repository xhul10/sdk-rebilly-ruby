...
# Unit tests for RebillySdk::StaticIpnLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticIpnLink' do
  before do
    # run before each test
    @instance = RebillySdk::StaticIpnLink.new
  end
  ...
  describe 'test an instance of StaticIpnLink' do
    it 'should create an instance of StaticIpnLink' do
      expect(@instance).to be_instance_of(RebillySdk::StaticIpnLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["staticIpnUrl"])
