...
# Unit tests for RebillySdk::DataCash
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataCash' do
  before do
    # run before each test
    @instance = RebillySdk::DataCash.new
  end
  ...
  describe 'test an instance of DataCash' do
    it 'should create an instance of DataCash' do
      expect(@instance).to be_instance_of(RebillySdk::DataCash)
    end
  end
