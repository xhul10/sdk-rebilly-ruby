...
# Unit tests for RebillySdk::TestProcessor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TestProcessor' do
  before do
    # run before each test
    @instance = RebillySdk::TestProcessor.new
  end
  ...
  describe 'test an instance of TestProcessor' do
    it 'should create an instance of TestProcessor' do
      expect(@instance).to be_instance_of(RebillySdk::TestProcessor)
    end
  end
