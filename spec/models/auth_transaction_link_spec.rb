...
# Unit tests for RebillySdk::AuthTransactionLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthTransactionLink' do
  before do
    # run before each test
    @instance = RebillySdk::AuthTransactionLink.new
  end
  ...
  describe 'test an instance of AuthTransactionLink' do
    it 'should create an instance of AuthTransactionLink' do
      expect(@instance).to be_instance_of(RebillySdk::AuthTransactionLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["authTransaction"])
