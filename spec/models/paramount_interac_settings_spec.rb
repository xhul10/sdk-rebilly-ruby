...
# Unit tests for RebillySdk::ParamountInteracSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParamountInteracSettings' do
  before do
    # run before each test
    @instance = RebillySdk::ParamountInteracSettings.new
  end
  ...
  describe 'test an instance of ParamountInteracSettings' do
    it 'should create an instance of ParamountInteracSettings' do
      expect(@instance).to be_instance_of(RebillySdk::ParamountInteracSettings)
    end
  end
  ...
  describe 'test attribute "merchant_sub_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
