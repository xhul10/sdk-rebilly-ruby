...
# Unit tests for RebillySdk::PayPalAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayPalAccount' do
  before do
    # run before each test
    @instance = RebillySdk::PayPalAccount.new
  end
  ...
  describe 'test an instance of PayPalAccount' do
    it 'should create an instance of PayPalAccount' do
      expect(@instance).to be_instance_of(RebillySdk::PayPalAccount)
    end
  end
