...
# Unit tests for RebillySdk::Paysafe3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Paysafe3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Paysafe3dsServers.new
  end
  ...
  describe 'test an instance of Paysafe3dsServers' do
    it 'should create an instance of Paysafe3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Paysafe3dsServers)
    end
  end
