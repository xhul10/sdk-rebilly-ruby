...
# Unit tests for RebillySdk::Dengi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Dengi' do
  before do
    # run before each test
    @instance = RebillySdk::Dengi.new
  end
  ...
  describe 'test an instance of Dengi' do
    it 'should create an instance of Dengi' do
      expect(@instance).to be_instance_of(RebillySdk::Dengi)
    end
  end
