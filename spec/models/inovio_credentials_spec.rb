...
# Unit tests for RebillySdk::InovioCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InovioCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::InovioCredentials.new
  end
  ...
  describe 'test an instance of InovioCredentials' do
    it 'should create an instance of InovioCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::InovioCredentials)
    end
  end
