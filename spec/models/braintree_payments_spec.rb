...
# Unit tests for RebillySdk::BraintreePayments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BraintreePayments' do
  before do
    # run before each test
    @instance = RebillySdk::BraintreePayments.new
  end
  ...
  describe 'test an instance of BraintreePayments' do
    it 'should create an instance of BraintreePayments' do
      expect(@instance).to be_instance_of(RebillySdk::BraintreePayments)
    end
  end
