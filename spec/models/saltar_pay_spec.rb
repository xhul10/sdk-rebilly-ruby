...
# Unit tests for RebillySdk::SaltarPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SaltarPay' do
  before do
    # run before each test
    @instance = RebillySdk::SaltarPay.new
  end
  ...
  describe 'test an instance of SaltarPay' do
    it 'should create an instance of SaltarPay' do
      expect(@instance).to be_instance_of(RebillySdk::SaltarPay)
    end
  end
