...
# Unit tests for RebillySdk::SmartInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartInvoice' do
  before do
    # run before each test
    @instance = RebillySdk::SmartInvoice.new
  end
  ...
  describe 'test an instance of SmartInvoice' do
    it 'should create an instance of SmartInvoice' do
      expect(@instance).to be_instance_of(RebillySdk::SmartInvoice)
    end
  end
