...
# Unit tests for RebillySdk::PayoutRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayoutRequest' do
  before do
    # run before each test
    @instance = RebillySdk::PayoutRequest.new
  end
  ...
  describe 'test an instance of PayoutRequest' do
    it 'should create an instance of PayoutRequest' do
      expect(@instance).to be_instance_of(RebillySdk::PayoutRequest)
    end
  end
