...
# Unit tests for RebillySdk::LoonieCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LoonieCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::LoonieCredentials.new
  end
  ...
  describe 'test an instance of LoonieCredentials' do
    it 'should create an instance of LoonieCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::LoonieCredentials)
    end
  end
