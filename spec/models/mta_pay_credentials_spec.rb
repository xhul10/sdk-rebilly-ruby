...
# Unit tests for RebillySdk::MtaPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MtaPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::MtaPayCredentials.new
  end
  ...
  describe 'test an instance of MtaPayCredentials' do
    it 'should create an instance of MtaPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::MtaPayCredentials)
    end
  end
  ...
  describe 'test attribute "md5key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
