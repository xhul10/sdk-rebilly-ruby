...
# Unit tests for RebillySdk::OnlineueberweisenSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnlineueberweisenSettings' do
  before do
    # run before each test
    @instance = RebillySdk::OnlineueberweisenSettings.new
  end
  ...
  describe 'test an instance of OnlineueberweisenSettings' do
    it 'should create an instance of OnlineueberweisenSettings' do
      expect(@instance).to be_instance_of(RebillySdk::OnlineueberweisenSettings)
    end
  end
  describe 'test attribute "payform_code"' do
    it 'should work' do
