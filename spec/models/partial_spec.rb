...
# Unit tests for RebillySdk::Partial
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Partial' do
  before do
    # run before each test
    @instance = RebillySdk::Partial.new
  end
  ...
  describe 'test an instance of Partial' do
    it 'should create an instance of Partial' do
      expect(@instance).to be_instance_of(RebillySdk::Partial)
    end
  end
  ...
  describe 'test attribute "after_approval_policy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
