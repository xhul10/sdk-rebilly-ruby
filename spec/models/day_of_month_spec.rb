...
# Unit tests for RebillySdk::DayOfMonth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DayOfMonth' do
  before do
    # run before each test
    @instance = RebillySdk::DayOfMonth.new
  end
  ...
  describe 'test an instance of DayOfMonth' do
    it 'should create an instance of DayOfMonth' do
      expect(@instance).to be_instance_of(RebillySdk::DayOfMonth)
    end
  end
