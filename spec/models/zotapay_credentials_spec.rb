...
# Unit tests for RebillySdk::ZotapayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZotapayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ZotapayCredentials.new
  end
  ...
  describe 'test an instance of ZotapayCredentials' do
    it 'should create an instance of ZotapayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ZotapayCredentials)
    end
  end
  ...
  describe 'test attribute "merchant_secret_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
