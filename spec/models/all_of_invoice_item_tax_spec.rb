...
# Unit tests for RebillySdk::AllOfInvoiceItemTax
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfInvoiceItemTax' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfInvoiceItemTax.new
  end
  ...
  describe 'test an instance of AllOfInvoiceItemTax' do
    it 'should create an instance of AllOfInvoiceItemTax' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfInvoiceItemTax)
    end
  end
