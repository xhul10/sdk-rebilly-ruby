...
# Unit tests for RebillySdk::GooneyCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GooneyCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::GooneyCredentials.new
  end
  ...
  describe 'test an instance of GooneyCredentials' do
    it 'should create an instance of GooneyCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::GooneyCredentials)
    end
  end
