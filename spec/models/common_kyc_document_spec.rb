...
# Unit tests for RebillySdk::CommonKycDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonKycDocument' do
  before do
    # run before each test
    @instance = RebillySdk::CommonKycDocument.new
  end
  ...
  describe 'test an instance of CommonKycDocument' do
    it 'should create an instance of CommonKycDocument' do
      expect(@instance).to be_instance_of(RebillySdk::CommonKycDocument)
    end
  end
  ...
  describe 'test attribute "document_subtype"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "in-progress", "accepted", "rejected"])
