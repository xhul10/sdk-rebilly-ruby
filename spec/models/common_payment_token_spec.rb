...
# Unit tests for RebillySdk::CommonPaymentToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonPaymentToken' do
  before do
    # run before each test
    @instance = RebillySdk::CommonPaymentToken.new
  end
  ...
  describe 'test an instance of CommonPaymentToken' do
    it 'should create an instance of CommonPaymentToken' do
      expect(@instance).to be_instance_of(RebillySdk::CommonPaymentToken)
    end
  end
