...
# Unit tests for RebillySdk::EMSCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMSCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EMSCredentials.new
  end
  ...
  describe 'test an instance of EMSCredentials' do
    it 'should create an instance of EMSCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EMSCredentials)
    end
  end
  ...
  describe 'test attribute "client_certificate_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
