...
# Unit tests for RebillySdk::GET3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GET3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::GET3dsServers.new
  end
  ...
  describe 'test an instance of GET3dsServers' do
    it 'should create an instance of GET3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::GET3dsServers)
    end
  end
