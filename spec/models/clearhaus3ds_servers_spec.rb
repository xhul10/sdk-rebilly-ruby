...
# Unit tests for RebillySdk::Clearhaus3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Clearhaus3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Clearhaus3dsServers.new
  end
  ...
  describe 'test an instance of Clearhaus3dsServers' do
    it 'should create an instance of Clearhaus3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Clearhaus3dsServers)
    end
  end
