...
# Unit tests for RebillySdk::FlexepinCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlexepinCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::FlexepinCredentials.new
  end
  ...
  describe 'test an instance of FlexepinCredentials' do
    it 'should create an instance of FlexepinCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::FlexepinCredentials)
    end
  end
