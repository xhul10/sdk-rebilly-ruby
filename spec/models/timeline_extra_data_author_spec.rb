...
# Unit tests for RebillySdk::TimelineExtraDataAuthor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimelineExtraDataAuthor' do
  before do
    # run before each test
    @instance = RebillySdk::TimelineExtraDataAuthor.new
  end
  ...
  describe 'test an instance of TimelineExtraDataAuthor' do
    it 'should create an instance of TimelineExtraDataAuthor' do
      expect(@instance).to be_instance_of(RebillySdk::TimelineExtraDataAuthor)
    end
  end
