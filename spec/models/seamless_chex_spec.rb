...
# Unit tests for RebillySdk::SeamlessChex
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SeamlessChex' do
  before do
    # run before each test
    @instance = RebillySdk::SeamlessChex.new
  end
  ...
  describe 'test an instance of SeamlessChex' do
    it 'should create an instance of SeamlessChex' do
      expect(@instance).to be_instance_of(RebillySdk::SeamlessChex)
    end
  end
