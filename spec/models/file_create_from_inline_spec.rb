...
# Unit tests for RebillySdk::FileCreateFromInline
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileCreateFromInline' do
  before do
    # run before each test
    @instance = RebillySdk::FileCreateFromInline.new
  end
  ...
  describe 'test an instance of FileCreateFromInline' do
    it 'should create an instance of FileCreateFromInline' do
      expect(@instance).to be_instance_of(RebillySdk::FileCreateFromInline)
    end
  end
