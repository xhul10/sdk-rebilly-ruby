...
# Unit tests for RebillySdk::CommonOrderPreviewDiscounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonOrderPreviewDiscounts' do
  before do
    # run before each test
    @instance = RebillySdk::CommonOrderPreviewDiscounts.new
  end
  ...
  describe 'test an instance of CommonOrderPreviewDiscounts' do
    it 'should create an instance of CommonOrderPreviewDiscounts' do
      expect(@instance).to be_instance_of(RebillySdk::CommonOrderPreviewDiscounts)
    end
  end
