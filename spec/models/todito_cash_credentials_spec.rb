...
# Unit tests for RebillySdk::ToditoCashCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ToditoCashCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ToditoCashCredentials.new
  end
  ...
  describe 'test an instance of ToditoCashCredentials' do
    it 'should create an instance of ToditoCashCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ToditoCashCredentials)
    end
  end
