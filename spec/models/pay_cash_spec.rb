...
# Unit tests for RebillySdk::PayCash
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayCash' do
  before do
    # run before each test
    @instance = RebillySdk::PayCash.new
  end
  ...
  describe 'test an instance of PayCash' do
    it 'should create an instance of PayCash' do
      expect(@instance).to be_instance_of(RebillySdk::PayCash)
    end
  end
