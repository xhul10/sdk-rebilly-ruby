...
# Unit tests for RebillySdk::Stripe
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stripe' do
  before do
    # run before each test
    @instance = RebillySdk::Stripe.new
  end
  ...
  describe 'test an instance of Stripe' do
    it 'should create an instance of Stripe' do
      expect(@instance).to be_instance_of(RebillySdk::Stripe)
    end
  end
