...
# Unit tests for RebillySdk::EMerchantPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMerchantPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EMerchantPayCredentials.new
  end
  ...
  describe 'test an instance of EMerchantPayCredentials' do
    it 'should create an instance of EMerchantPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EMerchantPayCredentials)
    end
  end
