...
# Unit tests for RebillySdk::CryptonatorCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CryptonatorCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CryptonatorCredentials.new
  end
  ...
  describe 'test an instance of CryptonatorCredentials' do
    it 'should create an instance of CryptonatorCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CryptonatorCredentials)
    end
  end
