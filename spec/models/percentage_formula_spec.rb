...
# Unit tests for RebillySdk::PercentageFormula
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PercentageFormula' do
  before do
    # run before each test
    @instance = RebillySdk::PercentageFormula.new
  end
  ...
  describe 'test an instance of PercentageFormula' do
    it 'should create an instance of PercentageFormula' do
      expect(@instance).to be_instance_of(RebillySdk::PercentageFormula)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["percentage"])
  ...
  describe 'test attribute "bips"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "round"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["regular", "up", "down"])
      # validator.allowable_values.each do |value|
