...
# Unit tests for RebillySdk::PaymenTechnologies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymenTechnologies' do
  before do
    # run before each test
    @instance = RebillySdk::PaymenTechnologies.new
  end
  ...
  describe 'test an instance of PaymenTechnologies' do
    it 'should create an instance of PaymenTechnologies' do
      expect(@instance).to be_instance_of(RebillySdk::PaymenTechnologies)
    end
  end
