...
# Unit tests for RebillySdk::PayvisionSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayvisionSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PayvisionSettings.new
  end
  ...
  describe 'test an instance of PayvisionSettings' do
    it 'should create an instance of PayvisionSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PayvisionSettings)
    end
  end
  ...
  describe 'test attribute "merchant_account_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
