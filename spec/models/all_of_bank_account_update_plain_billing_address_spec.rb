...
# Unit tests for RebillySdk::AllOfBankAccountUpdatePlainBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfBankAccountUpdatePlainBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfBankAccountUpdatePlainBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfBankAccountUpdatePlainBillingAddress' do
    it 'should create an instance of AllOfBankAccountUpdatePlainBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfBankAccountUpdatePlainBillingAddress)
    end
  end
