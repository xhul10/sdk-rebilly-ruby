...
# Unit tests for RebillySdk::CashToCodeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CashToCodeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CashToCodeCredentials.new
  end
  ...
  describe 'test an instance of CashToCodeCredentials' do
    it 'should create an instance of CashToCodeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CashToCodeCredentials)
    end
  end
  describe 'test attribute "cash_to_code_username"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cash_to_code_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
