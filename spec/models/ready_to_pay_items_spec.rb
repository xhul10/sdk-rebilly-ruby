...
# Unit tests for RebillySdk::ReadyToPayItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayItems' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayItems.new
  end
  ...
  describe 'test an instance of ReadyToPayItems' do
    it 'should create an instance of ReadyToPayItems' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayItems)
    end
  end
