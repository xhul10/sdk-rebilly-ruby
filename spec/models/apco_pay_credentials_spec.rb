...
# Unit tests for RebillySdk::ApcoPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApcoPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ApcoPayCredentials.new
  end
  ...
  describe 'test an instance of ApcoPayCredentials' do
    it 'should create an instance of ApcoPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ApcoPayCredentials)
    end
  end
