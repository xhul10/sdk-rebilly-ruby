...
# Unit tests for RebillySdk::Directa24Credentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Directa24Credentials' do
  before do
    # run before each test
    @instance = RebillySdk::Directa24Credentials.new
  end
  ...
  describe 'test an instance of Directa24Credentials' do
    it 'should create an instance of Directa24Credentials' do
      expect(@instance).to be_instance_of(RebillySdk::Directa24Credentials)
    end
  end
  ...
  describe 'test attribute "x_tran_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "web_pay_login"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "web_pay_tran_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
