...
# Unit tests for RebillySdk::NuaPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NuaPay' do
  before do
    # run before each test
    @instance = RebillySdk::NuaPay.new
  end
  ...
  describe 'test an instance of NuaPay' do
    it 'should create an instance of NuaPay' do
      expect(@instance).to be_instance_of(RebillySdk::NuaPay)
    end
  end
