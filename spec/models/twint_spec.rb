...
# Unit tests for RebillySdk::TWINT
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TWINT' do
  before do
    # run before each test
    @instance = RebillySdk::TWINT.new
  end
  ...
  describe 'test an instance of TWINT' do
    it 'should create an instance of TWINT' do
      expect(@instance).to be_instance_of(RebillySdk::TWINT)
    end
  end
