...
# Unit tests for RebillySdk::FeePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeePatch' do
  before do
    # run before each test
    @instance = RebillySdk::FeePatch.new
  end
  ...
  describe 'test an instance of FeePatch' do
    it 'should create an instance of FeePatch' do
      expect(@instance).to be_instance_of(RebillySdk::FeePatch)
    end
  end
