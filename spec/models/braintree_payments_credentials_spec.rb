...
# Unit tests for RebillySdk::BraintreePaymentsCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BraintreePaymentsCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::BraintreePaymentsCredentials.new
  end
  ...
  describe 'test an instance of BraintreePaymentsCredentials' do
    it 'should create an instance of BraintreePaymentsCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::BraintreePaymentsCredentials)
    end
  end
