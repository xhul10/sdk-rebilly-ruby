...
# Unit tests for RebillySdk::PaymentCardEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentCardEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentCardEmbed.new
  end
  ...
  describe 'test an instance of PaymentCardEmbed' do
    it 'should create an instance of PaymentCardEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentCardEmbed)
    end
  end
