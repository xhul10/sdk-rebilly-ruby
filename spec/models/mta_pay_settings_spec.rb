...
# Unit tests for RebillySdk::MtaPaySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MtaPaySettings' do
  before do
    # run before each test
    @instance = RebillySdk::MtaPaySettings.new
  end
  ...
  describe 'test an instance of MtaPaySettings' do
    it 'should create an instance of MtaPaySettings' do
      expect(@instance).to be_instance_of(RebillySdk::MtaPaySettings)
    end
  end
  describe 'test attribute "goods"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mobile_pay"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
