...
# Unit tests for RebillySdk::Prosa
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Prosa' do
  before do
    # run before each test
    @instance = RebillySdk::Prosa.new
  end
  ...
  describe 'test an instance of Prosa' do
    it 'should create an instance of Prosa' do
      expect(@instance).to be_instance_of(RebillySdk::Prosa)
    end
  end
