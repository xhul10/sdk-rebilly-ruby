...
# Unit tests for RebillySdk::IpayOptionsCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpayOptionsCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::IpayOptionsCredentials.new
  end
  ...
  describe 'test an instance of IpayOptionsCredentials' do
    it 'should create an instance of IpayOptionsCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::IpayOptionsCredentials)
    end
  end
