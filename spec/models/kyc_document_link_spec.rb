...
# Unit tests for RebillySdk::KycDocumentLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycDocumentLink' do
  before do
    # run before each test
    @instance = RebillySdk::KycDocumentLink.new
  end
  ...
  describe 'test an instance of KycDocumentLink' do
    it 'should create an instance of KycDocumentLink' do
      expect(@instance).to be_instance_of(RebillySdk::KycDocumentLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kycDocument"])
