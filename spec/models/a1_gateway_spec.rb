...
# Unit tests for RebillySdk::A1Gateway
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'A1Gateway' do
  before do
    # run before each test
    @instance = RebillySdk::A1Gateway.new
  end
  ...
  describe 'test an instance of A1Gateway' do
    it 'should create an instance of A1Gateway' do
      expect(@instance).to be_instance_of(RebillySdk::A1Gateway)
    end
  end
