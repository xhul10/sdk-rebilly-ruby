...
# Unit tests for RebillySdk::ProductEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::ProductEmbed.new
  end
  ...
  describe 'test an instance of ProductEmbed' do
    it 'should create an instance of ProductEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::ProductEmbed)
    end
  end
