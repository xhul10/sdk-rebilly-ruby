...
# Unit tests for RebillySdk::AttachmentResourceLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AttachmentResourceLink' do
  before do
    # run before each test
    @instance = RebillySdk::AttachmentResourceLink.new
  end
  ...
  describe 'test an instance of AttachmentResourceLink' do
    it 'should create an instance of AttachmentResourceLink' do
      expect(@instance).to be_instance_of(RebillySdk::AttachmentResourceLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["customer", "dispute", "invoice", "payment", "plan", "product", "subscription", "transaction"])
