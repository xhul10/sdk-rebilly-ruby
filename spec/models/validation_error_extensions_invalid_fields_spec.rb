...
# Unit tests for RebillySdk::ValidationErrorExtensionsInvalidFields
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidationErrorExtensionsInvalidFields' do
  before do
    # run before each test
    @instance = RebillySdk::ValidationErrorExtensionsInvalidFields.new
  end
  ...
  describe 'test an instance of ValidationErrorExtensionsInvalidFields' do
    it 'should create an instance of ValidationErrorExtensionsInvalidFields' do
      expect(@instance).to be_instance_of(RebillySdk::ValidationErrorExtensionsInvalidFields)
    end
  end
