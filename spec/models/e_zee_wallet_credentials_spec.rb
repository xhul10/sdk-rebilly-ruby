...
# Unit tests for RebillySdk::EZeeWalletCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EZeeWalletCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EZeeWalletCredentials.new
  end
  ...
  describe 'test an instance of EZeeWalletCredentials' do
    it 'should create an instance of EZeeWalletCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EZeeWalletCredentials)
    end
  end
