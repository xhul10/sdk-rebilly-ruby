...
# Unit tests for RebillySdk::KonnektiveCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KonnektiveCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::KonnektiveCredentials.new
  end
  ...
  describe 'test an instance of KonnektiveCredentials' do
    it 'should create an instance of KonnektiveCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::KonnektiveCredentials)
    end
  end
