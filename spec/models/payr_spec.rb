...
# Unit tests for RebillySdk::Payr
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Payr' do
  before do
    # run before each test
    @instance = RebillySdk::Payr.new
  end
  ...
  describe 'test an instance of Payr' do
    it 'should create an instance of Payr' do
      expect(@instance).to be_instance_of(RebillySdk::Payr)
    end
  end
