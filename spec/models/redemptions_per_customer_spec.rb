...
# Unit tests for RebillySdk::RedemptionsPerCustomer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedemptionsPerCustomer' do
  before do
    # run before each test
    @instance = RebillySdk::RedemptionsPerCustomer.new
  end
  ...
  describe 'test an instance of RedemptionsPerCustomer' do
    it 'should create an instance of RedemptionsPerCustomer' do
      expect(@instance).to be_instance_of(RebillySdk::RedemptionsPerCustomer)
    end
  end
