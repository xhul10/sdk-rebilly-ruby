...
# Unit tests for RebillySdk::Rebilly
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Rebilly' do
  before do
    # run before each test
    @instance = RebillySdk::Rebilly.new
  end
  ...
  describe 'test an instance of Rebilly' do
    it 'should create an instance of Rebilly' do
      expect(@instance).to be_instance_of(RebillySdk::Rebilly)
    end
  end
  describe 'test attribute "calculator"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["manual", "rebilly"])
