...
# Unit tests for RebillySdk::CouponRestriction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CouponRestriction' do
  before do
    # run before each test
    @instance = RebillySdk::CouponRestriction.new
  end
  ...
  describe 'test an instance of CouponRestriction' do
    it 'should create an instance of CouponRestriction' do
      expect(@instance).to be_instance_of(RebillySdk::CouponRestriction)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["discounts-per-redemption", "minimum-order-amount", "redemptions-per-customer", "restrict-to-invoices", "restrict-to-plans", "restrict-to-subscriptions", "restrict-to-products", "total-redemptions", "paid-by-time"])
