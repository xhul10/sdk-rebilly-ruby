...
# Unit tests for RebillySdk::Onlineueberweisen
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Onlineueberweisen' do
  before do
    # run before each test
    @instance = RebillySdk::Onlineueberweisen.new
  end
  ...
  describe 'test an instance of Onlineueberweisen' do
    it 'should create an instance of Onlineueberweisen' do
      expect(@instance).to be_instance_of(RebillySdk::Onlineueberweisen)
    end
  end
