...
# Unit tests for RebillySdk::AllOfSearchOrdersItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfSearchOrdersItems' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfSearchOrdersItems.new
  end
  ...
  describe 'test an instance of AllOfSearchOrdersItems' do
    it 'should create an instance of AllOfSearchOrdersItems' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfSearchOrdersItems)
    end
  end
