...
# Unit tests for RebillySdk::OnRampCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnRampCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::OnRampCredentials.new
  end
  ...
  describe 'test an instance of OnRampCredentials' do
    it 'should create an instance of OnRampCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::OnRampCredentials)
    end
  end
