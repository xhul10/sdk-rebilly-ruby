...
# Unit tests for RebillySdk::EMSSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMSSettings' do
  before do
    # run before each test
    @instance = RebillySdk::EMSSettings.new
  end
  ...
  describe 'test an instance of EMSSettings' do
    it 'should create an instance of EMSSettings' do
      expect(@instance).to be_instance_of(RebillySdk::EMSSettings)
    end
  end
