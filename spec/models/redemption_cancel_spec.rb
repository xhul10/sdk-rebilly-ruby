...
# Unit tests for RebillySdk::RedemptionCancel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedemptionCancel' do
  before do
    # run before each test
    @instance = RebillySdk::RedemptionCancel.new
  end
  ...
  describe 'test an instance of RedemptionCancel' do
    it 'should create an instance of RedemptionCancel' do
      expect(@instance).to be_instance_of(RebillySdk::RedemptionCancel)
    end
  end
  describe 'test attribute "action"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["resend-email", "redemption-cancel", "ruleset-restore"])
