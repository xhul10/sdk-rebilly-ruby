...
# Unit tests for RebillySdk::CustomEventScheduleInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomEventScheduleInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::CustomEventScheduleInstruction.new
  end
  ...
  describe 'test an instance of CustomEventScheduleInstruction' do
    it 'should create an instance of CustomEventScheduleInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::CustomEventScheduleInstruction)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["date-interval", "day-of-month", "day-of-week"])
