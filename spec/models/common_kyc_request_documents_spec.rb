...
# Unit tests for RebillySdk::CommonKycRequestDocuments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonKycRequestDocuments' do
  before do
    # run before each test
    @instance = RebillySdk::CommonKycRequestDocuments.new
  end
  ...
  describe 'test an instance of CommonKycRequestDocuments' do
    it 'should create an instance of CommonKycRequestDocuments' do
      expect(@instance).to be_instance_of(RebillySdk::CommonKycRequestDocuments)
    end
  end
  ...
  describe 'test attribute "face_proof_required"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
