...
# Unit tests for RebillySdk::MtaPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MtaPay' do
  before do
    # run before each test
    @instance = RebillySdk::MtaPay.new
  end
  ...
  describe 'test an instance of MtaPay' do
    it 'should create an instance of MtaPay' do
      expect(@instance).to be_instance_of(RebillySdk::MtaPay)
    end
  end
