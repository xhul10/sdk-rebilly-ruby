...
# Unit tests for RebillySdk::PaymeroCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymeroCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaymeroCredentials.new
  end
  ...
  describe 'test an instance of PaymeroCredentials' do
    it 'should create an instance of PaymeroCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaymeroCredentials)
    end
  end
