...
# Unit tests for RebillySdk::PaymentInstrument3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInstrument3' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentInstrument3.new
  end
  ...
  describe 'test an instance of PaymentInstrument3' do
    it 'should create an instance of PaymentInstrument3' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentInstrument3)
    end
  end
