...
# Unit tests for RebillySdk::InvoiceLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceLink' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceLink.new
  end
  ...
  describe 'test an instance of InvoiceLink' do
    it 'should create an instance of InvoiceLink' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceLink)
    end
  end
