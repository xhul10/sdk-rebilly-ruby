...
# Unit tests for RebillySdk::RulesetRestore
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RulesetRestore' do
  before do
    # run before each test
    @instance = RebillySdk::RulesetRestore.new
  end
  ...
  describe 'test an instance of RulesetRestore' do
    it 'should create an instance of RulesetRestore' do
      expect(@instance).to be_instance_of(RebillySdk::RulesetRestore)
    end
  end
