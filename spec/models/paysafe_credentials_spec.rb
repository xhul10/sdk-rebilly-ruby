...
# Unit tests for RebillySdk::PaysafeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaysafeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaysafeCredentials.new
  end
  ...
  describe 'test an instance of PaysafeCredentials' do
    it 'should create an instance of PaysafeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaysafeCredentials)
    end
  end
  ...
  describe 'test attribute "store_pwd"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
