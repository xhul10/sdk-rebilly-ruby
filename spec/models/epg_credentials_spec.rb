...
# Unit tests for RebillySdk::EPGCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EPGCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EPGCredentials.new
  end
  ...
  describe 'test an instance of EPGCredentials' do
    it 'should create an instance of EPGCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EPGCredentials)
    end
  end
