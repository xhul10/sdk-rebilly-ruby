...
# Unit tests for RebillySdk::Directa24Settings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Directa24Settings' do
  before do
    # run before each test
    @instance = RebillySdk::Directa24Settings.new
  end
  ...
  describe 'test an instance of Directa24Settings' do
    it 'should create an instance of Directa24Settings' do
      expect(@instance).to be_instance_of(RebillySdk::Directa24Settings)
    end
  end
  ...
  describe 'test attribute "skip_step"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
