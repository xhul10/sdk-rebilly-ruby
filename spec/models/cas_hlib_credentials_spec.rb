...
# Unit tests for RebillySdk::CASHlibCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CASHlibCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CASHlibCredentials.new
  end
  ...
  describe 'test an instance of CASHlibCredentials' do
    it 'should create an instance of CASHlibCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CASHlibCredentials)
    end
  end
