...
# Unit tests for RebillySdk::GooglePayFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GooglePayFeature' do
  before do
    # run before each test
    @instance = RebillySdk::GooglePayFeature.new
  end
  ...
  describe 'test an instance of GooglePayFeature' do
    it 'should create an instance of GooglePayFeature' do
      expect(@instance).to be_instance_of(RebillySdk::GooglePayFeature)
    end
  end
