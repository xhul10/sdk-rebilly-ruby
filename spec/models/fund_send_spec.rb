...
# Unit tests for RebillySdk::FundSend
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FundSend' do
  before do
    # run before each test
    @instance = RebillySdk::FundSend.new
  end
  ...
  describe 'test an instance of FundSend' do
    it 'should create an instance of FundSend' do
      expect(@instance).to be_instance_of(RebillySdk::FundSend)
    end
  end
