...
# Unit tests for RebillySdk::PurchaseMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseMatches' do
  before do
    # run before each test
    @instance = RebillySdk::PurchaseMatches.new
  end
  ...
  describe 'test an instance of PurchaseMatches' do
    it 'should create an instance of PurchaseMatches' do
      expect(@instance).to be_instance_of(RebillySdk::PurchaseMatches)
    end
  end
