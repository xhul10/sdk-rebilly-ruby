...
# Unit tests for RebillySdk::ReadyToPayPaymentCardMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayPaymentCardMethod' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayPaymentCardMethod.new
  end
  ...
  describe 'test an instance of ReadyToPayPaymentCardMethod' do
    it 'should create an instance of ReadyToPayPaymentCardMethod' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayPaymentCardMethod)
    end
  end
