...
# Unit tests for RebillySdk::GreenboxCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GreenboxCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::GreenboxCredentials.new
  end
  ...
  describe 'test an instance of GreenboxCredentials' do
    it 'should create an instance of GreenboxCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::GreenboxCredentials)
    end
  end
