...
# Unit tests for RebillySdk::KycGathererLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycGathererLink' do
  before do
    # run before each test
    @instance = RebillySdk::KycGathererLink.new
  end
  ...
  describe 'test an instance of KycGathererLink' do
    it 'should create an instance of KycGathererLink' do
      expect(@instance).to be_instance_of(RebillySdk::KycGathererLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kycGatherer"])
