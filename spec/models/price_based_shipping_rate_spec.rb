...
# Unit tests for RebillySdk::PriceBasedShippingRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PriceBasedShippingRate' do
  before do
    # run before each test
    @instance = RebillySdk::PriceBasedShippingRate.new
  end
  ...
  describe 'test an instance of PriceBasedShippingRate' do
    it 'should create an instance of PriceBasedShippingRate' do
      expect(@instance).to be_instance_of(RebillySdk::PriceBasedShippingRate)
    end
  end
