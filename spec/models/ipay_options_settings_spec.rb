...
# Unit tests for RebillySdk::IpayOptionsSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpayOptionsSettings' do
  before do
    # run before each test
    @instance = RebillySdk::IpayOptionsSettings.new
  end
  ...
  describe 'test an instance of IpayOptionsSettings' do
    it 'should create an instance of IpayOptionsSettings' do
      expect(@instance).to be_instance_of(RebillySdk::IpayOptionsSettings)
    end
  end
  describe 'test attribute "extra_step"' do
    it 'should work' do
  ...
  describe 'test attribute "subdomain"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["miglite", "w88asiapay"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.subdomain = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "platform"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SOAP", "TxHandler", "SecureHosted"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "card_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ideal", "idealqr", "sofort"])
      # validator.allowable_values.each do |value|
