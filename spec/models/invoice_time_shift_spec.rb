...
# Unit tests for RebillySdk::InvoiceTimeShift
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceTimeShift' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceTimeShift.new
  end
  ...
  describe 'test an instance of InvoiceTimeShift' do
    it 'should create an instance of InvoiceTimeShift' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceTimeShift)
    end
  end
  describe 'test attribute "issue_time_shift"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "due_time_shift"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
