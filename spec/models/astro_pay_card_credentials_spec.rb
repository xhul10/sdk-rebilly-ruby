...
# Unit tests for RebillySdk::AstroPayCardCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AstroPayCardCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AstroPayCardCredentials.new
  end
  ...
  describe 'test an instance of AstroPayCardCredentials' do
    it 'should create an instance of AstroPayCardCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AstroPayCardCredentials)
    end
  end
