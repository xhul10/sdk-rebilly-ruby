...
# Unit tests for RebillySdk::Pay4FunCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pay4FunCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::Pay4FunCredentials.new
  end
  ...
  describe 'test an instance of Pay4FunCredentials' do
    it 'should create an instance of Pay4FunCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::Pay4FunCredentials)
    end
  end
  ...
  describe 'test attribute "merchant_secret"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
