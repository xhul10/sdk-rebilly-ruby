...
# Unit tests for RebillySdk::ThreecolumnsData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThreecolumnsData' do
  before do
    # run before each test
    @instance = RebillySdk::ThreecolumnsData.new
  end
  ...
  describe 'test an instance of ThreecolumnsData' do
    it 'should create an instance of ThreecolumnsData' do
      expect(@instance).to be_instance_of(RebillySdk::ThreecolumnsData)
    end
  end
