...
# Unit tests for RebillySdk::Euteller
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Euteller' do
  before do
    # run before each test
    @instance = RebillySdk::Euteller.new
  end
  ...
  describe 'test an instance of Euteller' do
    it 'should create an instance of Euteller' do
      expect(@instance).to be_instance_of(RebillySdk::Euteller)
    end
  end
