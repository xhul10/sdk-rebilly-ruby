...
# Unit tests for RebillySdk::TWINTSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TWINTSettings' do
  before do
    # run before each test
    @instance = RebillySdk::TWINTSettings.new
  end
  ...
  describe 'test an instance of TWINTSettings' do
    it 'should create an instance of TWINTSettings' do
      expect(@instance).to be_instance_of(RebillySdk::TWINTSettings)
    end
  end
  describe 'test attribute "cash_register_type"' do
    it 'should work' do
