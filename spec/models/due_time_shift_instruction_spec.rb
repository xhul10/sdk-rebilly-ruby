...
# Unit tests for RebillySdk::DueTimeShiftInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DueTimeShiftInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::DueTimeShiftInstruction.new
  end
  ...
  describe 'test an instance of DueTimeShiftInstruction' do
    it 'should create an instance of DueTimeShiftInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::DueTimeShiftInstruction)
    end
  end
