...
# Unit tests for RebillySdk::OriginalPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OriginalPlan' do
  before do
    # run before each test
    @instance = RebillySdk::OriginalPlan.new
  end
  ...
  describe 'test an instance of OriginalPlan' do
    it 'should create an instance of OriginalPlan' do
      expect(@instance).to be_instance_of(RebillySdk::OriginalPlan)
    end
  end
