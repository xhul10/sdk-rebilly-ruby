...
# Unit tests for RebillySdk::KhelocardCardTokenPaymentInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KhelocardCardTokenPaymentInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::KhelocardCardTokenPaymentInstrument.new
  end
  ...
  describe 'test an instance of KhelocardCardTokenPaymentInstrument' do
    it 'should create an instance of KhelocardCardTokenPaymentInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::KhelocardCardTokenPaymentInstrument)
    end
  end
