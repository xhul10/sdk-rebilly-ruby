...
# Unit tests for RebillySdk::STPMexico
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'STPMexico' do
  before do
    # run before each test
    @instance = RebillySdk::STPMexico.new
  end
  ...
  describe 'test an instance of STPMexico' do
    it 'should create an instance of STPMexico' do
      expect(@instance).to be_instance_of(RebillySdk::STPMexico)
    end
  end
