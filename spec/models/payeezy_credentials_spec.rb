...
# Unit tests for RebillySdk::PayeezyCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayeezyCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayeezyCredentials.new
  end
  ...
  describe 'test an instance of PayeezyCredentials' do
    it 'should create an instance of PayeezyCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayeezyCredentials)
    end
  end
