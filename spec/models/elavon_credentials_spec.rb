...
# Unit tests for RebillySdk::ElavonCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ElavonCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ElavonCredentials.new
  end
  ...
  describe 'test an instance of ElavonCredentials' do
    it 'should create an instance of ElavonCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ElavonCredentials)
    end
  end
  describe 'test attribute "ssl_merchant_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ssl_user_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ssl_pin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
