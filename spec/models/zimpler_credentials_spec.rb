...
# Unit tests for RebillySdk::ZimplerCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZimplerCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ZimplerCredentials.new
  end
  ...
  describe 'test an instance of ZimplerCredentials' do
    it 'should create an instance of ZimplerCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ZimplerCredentials)
    end
  end
