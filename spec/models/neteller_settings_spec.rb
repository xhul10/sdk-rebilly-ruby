...
# Unit tests for RebillySdk::NetellerSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetellerSettings' do
  before do
    # run before each test
    @instance = RebillySdk::NetellerSettings.new
  end
  ...
  describe 'test an instance of NetellerSettings' do
    it 'should create an instance of NetellerSettings' do
      expect(@instance).to be_instance_of(RebillySdk::NetellerSettings)
    end
  end
  describe 'test attribute "populate_customer_email"' do
    it 'should work' do
