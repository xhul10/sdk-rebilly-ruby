...
# Unit tests for RebillySdk::Inovio3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Inovio3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Inovio3dsServer.new
  end
  ...
  describe 'test an instance of Inovio3dsServer' do
    it 'should create an instance of Inovio3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Inovio3dsServer)
    end
  end
