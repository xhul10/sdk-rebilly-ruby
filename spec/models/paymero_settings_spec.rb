...
# Unit tests for RebillySdk::PaymeroSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymeroSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PaymeroSettings.new
  end
  ...
  describe 'test an instance of PaymeroSettings' do
    it 'should create an instance of PaymeroSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PaymeroSettings)
    end
  end
  ...
  describe 'test attribute "main_currency"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["TRX", "ETH"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.main_currency = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "amount_exceeded"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
