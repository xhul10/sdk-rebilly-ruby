...
# Unit tests for RebillySdk::AllOfPaymentCardUpdatePlainBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfPaymentCardUpdatePlainBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfPaymentCardUpdatePlainBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfPaymentCardUpdatePlainBillingAddress' do
    it 'should create an instance of AllOfPaymentCardUpdatePlainBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfPaymentCardUpdatePlainBillingAddress)
    end
  end
