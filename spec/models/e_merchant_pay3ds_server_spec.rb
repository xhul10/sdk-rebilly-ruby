...
# Unit tests for RebillySdk::EMerchantPay3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMerchantPay3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::EMerchantPay3dsServer.new
  end
  ...
  describe 'test an instance of EMerchantPay3dsServer' do
    it 'should create an instance of EMerchantPay3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::EMerchantPay3dsServer)
    end
  end
