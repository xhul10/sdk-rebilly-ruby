...
# Unit tests for RebillySdk::RapydCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RapydCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::RapydCredentials.new
  end
  ...
  describe 'test an instance of RapydCredentials' do
    it 'should create an instance of RapydCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::RapydCredentials)
    end
  end
