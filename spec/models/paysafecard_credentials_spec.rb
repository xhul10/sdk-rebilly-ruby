...
# Unit tests for RebillySdk::PaysafecardCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaysafecardCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PaysafecardCredentials.new
  end
  ...
  describe 'test an instance of PaysafecardCredentials' do
    it 'should create an instance of PaysafecardCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PaysafecardCredentials)
    end
  end
