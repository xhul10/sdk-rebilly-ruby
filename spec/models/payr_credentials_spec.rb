...
# Unit tests for RebillySdk::PayrCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayrCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayrCredentials.new
  end
  ...
  describe 'test an instance of PayrCredentials' do
    it 'should create an instance of PayrCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayrCredentials)
    end
  end
