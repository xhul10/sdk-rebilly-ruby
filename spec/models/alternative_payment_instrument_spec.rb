...
# Unit tests for RebillySdk::AlternativePaymentInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlternativePaymentInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::AlternativePaymentInstrument.new
  end
  ...
  describe 'test an instance of AlternativePaymentInstrument' do
    it 'should create an instance of AlternativePaymentInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::AlternativePaymentInstrument)
    end
  end
