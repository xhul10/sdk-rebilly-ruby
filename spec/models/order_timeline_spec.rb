...
# Unit tests for RebillySdk::OrderTimeline
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderTimeline' do
  before do
    # run before each test
    @instance = RebillySdk::OrderTimeline.new
  end
  ...
  describe 'test an instance of OrderTimeline' do
    it 'should create an instance of OrderTimeline' do
      expect(@instance).to be_instance_of(RebillySdk::OrderTimeline)
    end
  end
