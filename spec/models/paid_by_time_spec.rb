...
# Unit tests for RebillySdk::PaidByTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaidByTime' do
  before do
    # run before each test
    @instance = RebillySdk::PaidByTime.new
  end
  ...
  describe 'test an instance of PaidByTime' do
    it 'should create an instance of PaidByTime' do
      expect(@instance).to be_instance_of(RebillySdk::PaidByTime)
    end
  end
