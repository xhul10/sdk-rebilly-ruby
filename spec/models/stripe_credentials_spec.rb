...
# Unit tests for RebillySdk::StripeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StripeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::StripeCredentials.new
  end
  ...
  describe 'test an instance of StripeCredentials' do
    it 'should create an instance of StripeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::StripeCredentials)
    end
  end
  describe 'test attribute "stripe_client_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "stripe_secret"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
