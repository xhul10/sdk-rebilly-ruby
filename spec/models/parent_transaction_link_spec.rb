...
# Unit tests for RebillySdk::ParentTransactionLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParentTransactionLink' do
  before do
    # run before each test
    @instance = RebillySdk::ParentTransactionLink.new
  end
  ...
  describe 'test an instance of ParentTransactionLink' do
    it 'should create an instance of ParentTransactionLink' do
      expect(@instance).to be_instance_of(RebillySdk::ParentTransactionLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["parentTransaction"])
