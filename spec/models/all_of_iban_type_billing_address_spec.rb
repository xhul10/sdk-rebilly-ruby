...
# Unit tests for RebillySdk::AllOfIBANTypeBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfIBANTypeBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfIBANTypeBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfIBANTypeBillingAddress' do
    it 'should create an instance of AllOfIBANTypeBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfIBANTypeBillingAddress)
    end
  end
