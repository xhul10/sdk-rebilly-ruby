...
# Unit tests for RebillySdk::STPMexicoCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'STPMexicoCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::STPMexicoCredentials.new
  end
  ...
  describe 'test an instance of STPMexicoCredentials' do
    it 'should create an instance of STPMexicoCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::STPMexicoCredentials)
    end
  end
