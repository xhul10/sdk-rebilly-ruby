...
# Unit tests for RebillySdk::SecureTradingCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecureTradingCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::SecureTradingCredentials.new
  end
  ...
  describe 'test an instance of SecureTradingCredentials' do
    it 'should create an instance of SecureTradingCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::SecureTradingCredentials)
    end
  end
