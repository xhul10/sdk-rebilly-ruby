...
# Unit tests for RebillySdk::EPro
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EPro' do
  before do
    # run before each test
    @instance = RebillySdk::EPro.new
  end
  ...
  describe 'test an instance of EPro' do
    it 'should create an instance of EPro' do
      expect(@instance).to be_instance_of(RebillySdk::EPro)
    end
  end
