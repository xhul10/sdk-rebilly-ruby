...
# Unit tests for RebillySdk::KycSettingsAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycSettingsAddress' do
  before do
    # run before each test
    @instance = RebillySdk::KycSettingsAddress.new
  end
  ...
  describe 'test an instance of KycSettingsAddress' do
    it 'should create an instance of KycSettingsAddress' do
      expect(@instance).to be_instance_of(RebillySdk::KycSettingsAddress)
    end
  end
