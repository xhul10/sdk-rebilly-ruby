...
# Unit tests for RebillySdk::ICanPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICanPay' do
  before do
    # run before each test
    @instance = RebillySdk::ICanPay.new
  end
  ...
  describe 'test an instance of ICanPay' do
    it 'should create an instance of ICanPay' do
      expect(@instance).to be_instance_of(RebillySdk::ICanPay)
    end
  end
