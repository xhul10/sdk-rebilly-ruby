...
# Unit tests for RebillySdk::PermalinkLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PermalinkLink' do
  before do
    # run before each test
    @instance = RebillySdk::PermalinkLink.new
  end
  ...
  describe 'test an instance of PermalinkLink' do
    it 'should create an instance of PermalinkLink' do
      expect(@instance).to be_instance_of(RebillySdk::PermalinkLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["permalink"])
