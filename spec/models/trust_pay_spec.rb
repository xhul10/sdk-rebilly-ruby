...
# Unit tests for RebillySdk::TrustPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustPay' do
  before do
    # run before each test
    @instance = RebillySdk::TrustPay.new
  end
  ...
  describe 'test an instance of TrustPay' do
    it 'should create an instance of TrustPay' do
      expect(@instance).to be_instance_of(RebillySdk::TrustPay)
    end
  end
