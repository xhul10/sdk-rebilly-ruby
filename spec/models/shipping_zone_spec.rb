...
# Unit tests for RebillySdk::ShippingZone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingZone' do
  before do
    # run before each test
    @instance = RebillySdk::ShippingZone.new
  end
  ...
  describe 'test an instance of ShippingZone' do
    it 'should create an instance of ShippingZone' do
      expect(@instance).to be_instance_of(RebillySdk::ShippingZone)
    end
  end
