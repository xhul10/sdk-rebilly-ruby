...
# Unit tests for RebillySdk::CircleCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CircleCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CircleCredentials.new
  end
  ...
  describe 'test an instance of CircleCredentials' do
    it 'should create an instance of CircleCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CircleCredentials)
    end
  end
