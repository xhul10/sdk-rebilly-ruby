...
# Unit tests for RebillySdk::AllOfSearchCustomersItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfSearchCustomersItems' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfSearchCustomersItems.new
  end
  ...
  describe 'test an instance of AllOfSearchCustomersItems' do
    it 'should create an instance of AllOfSearchCustomersItems' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfSearchCustomersItems)
    end
  end
  ...
  describe 'test attribute "lifetime_revenue"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "invoice_count"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
