...
# Unit tests for RebillySdk::CauriPayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CauriPayment' do
  before do
    # run before each test
    @instance = RebillySdk::CauriPayment.new
  end
  ...
  describe 'test an instance of CauriPayment' do
    it 'should create an instance of CauriPayment' do
      expect(@instance).to be_instance_of(RebillySdk::CauriPayment)
    end
  end
