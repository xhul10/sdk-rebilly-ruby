...
# Unit tests for RebillySdk::InvoiceRetryAmountAdjustmentInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceRetryAmountAdjustmentInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceRetryAmountAdjustmentInstruction.new
  end
  ...
  describe 'test an instance of InvoiceRetryAmountAdjustmentInstruction' do
    it 'should create an instance of InvoiceRetryAmountAdjustmentInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceRetryAmountAdjustmentInstruction)
    end
  end
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "partial"])
