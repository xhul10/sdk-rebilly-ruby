...
# Unit tests for RebillySdk::Wallet88
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Wallet88' do
  before do
    # run before each test
    @instance = RebillySdk::Wallet88.new
  end
  ...
  describe 'test an instance of Wallet88' do
    it 'should create an instance of Wallet88' do
      expect(@instance).to be_instance_of(RebillySdk::Wallet88)
    end
  end
