...
# Unit tests for RebillySdk::Product
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Product' do
  before do
    # run before each test
    @instance = RebillySdk::Product.new
  end
  ...
  describe 'test an instance of Product' do
    it 'should create an instance of Product' do
      expect(@instance).to be_instance_of(RebillySdk::Product)
    end
  end
  ...
  describe 'test attribute "tax_category_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["00000", "99999", "20010", "40030", "51020", "51010", "31000", "30070"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.tax_category_id = value }.not_to raise_error
      # end
    end
  end
