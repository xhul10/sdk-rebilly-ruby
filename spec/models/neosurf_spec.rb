...
# Unit tests for RebillySdk::Neosurf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Neosurf' do
  before do
    # run before each test
    @instance = RebillySdk::Neosurf.new
  end
  ...
  describe 'test an instance of Neosurf' do
    it 'should create an instance of Neosurf' do
      expect(@instance).to be_instance_of(RebillySdk::Neosurf)
    end
  end
