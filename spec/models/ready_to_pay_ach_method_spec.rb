...
# Unit tests for RebillySdk::ReadyToPayAchMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReadyToPayAchMethod' do
  before do
    # run before each test
    @instance = RebillySdk::ReadyToPayAchMethod.new
  end
  ...
  describe 'test an instance of ReadyToPayAchMethod' do
    it 'should create an instance of ReadyToPayAchMethod' do
      expect(@instance).to be_instance_of(RebillySdk::ReadyToPayAchMethod)
    end
  end
