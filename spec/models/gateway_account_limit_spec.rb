...
# Unit tests for RebillySdk::GatewayAccountLimit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GatewayAccountLimit' do
  before do
    # run before each test
    @instance = RebillySdk::GatewayAccountLimit.new
  end
  ...
  describe 'test an instance of GatewayAccountLimit' do
    it 'should create an instance of GatewayAccountLimit' do
      expect(@instance).to be_instance_of(RebillySdk::GatewayAccountLimit)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["monitoring", "reached"])
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["count", "money"])
      # validator.allowable_values.each do |value|
