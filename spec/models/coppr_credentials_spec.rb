...
# Unit tests for RebillySdk::CopprCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CopprCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CopprCredentials.new
  end
  ...
  describe 'test an instance of CopprCredentials' do
    it 'should create an instance of CopprCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CopprCredentials)
    end
  end
