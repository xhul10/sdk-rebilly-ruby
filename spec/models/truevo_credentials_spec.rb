...
# Unit tests for RebillySdk::TruevoCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TruevoCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::TruevoCredentials.new
  end
  ...
  describe 'test an instance of TruevoCredentials' do
    it 'should create an instance of TruevoCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::TruevoCredentials)
    end
  end
