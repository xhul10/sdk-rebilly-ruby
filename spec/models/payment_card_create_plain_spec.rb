...
# Unit tests for RebillySdk::PaymentCardCreatePlain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentCardCreatePlain' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentCardCreatePlain.new
  end
  ...
  describe 'test an instance of PaymentCardCreatePlain' do
    it 'should create an instance of PaymentCardCreatePlain' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentCardCreatePlain)
    end
  end
