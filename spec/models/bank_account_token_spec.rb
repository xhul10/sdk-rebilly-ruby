...
# Unit tests for RebillySdk::BankAccountToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankAccountToken' do
  before do
    # run before each test
    @instance = RebillySdk::BankAccountToken.new
  end
  ...
  describe 'test an instance of BankAccountToken' do
    it 'should create an instance of BankAccountToken' do
      expect(@instance).to be_instance_of(RebillySdk::BankAccountToken)
    end
  end
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ach", "echeck"])
