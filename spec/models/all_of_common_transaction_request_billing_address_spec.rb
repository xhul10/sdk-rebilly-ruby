...
# Unit tests for RebillySdk::AllOfCommonTransactionRequestBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonTransactionRequestBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonTransactionRequestBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonTransactionRequestBillingAddress' do
    it 'should create an instance of AllOfCommonTransactionRequestBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonTransactionRequestBillingAddress)
    end
  end
