...
# Unit tests for RebillySdk::BrowserData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BrowserData' do
  before do
    # run before each test
    @instance = RebillySdk::BrowserData.new
  end
  ...
  describe 'test an instance of BrowserData' do
    it 'should create an instance of BrowserData' do
      expect(@instance).to be_instance_of(RebillySdk::BrowserData)
    end
  end
  describe 'test attribute "color_depth"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_java_enabled"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "time_zone_offset"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
