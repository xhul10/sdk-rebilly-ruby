...
# Unit tests for RebillySdk::AddressMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressMatches' do
  before do
    # run before each test
    @instance = RebillySdk::AddressMatches.new
  end
  ...
  describe 'test an instance of AddressMatches' do
    it 'should create an instance of AddressMatches' do
      expect(@instance).to be_instance_of(RebillySdk::AddressMatches)
    end
  end
  ...
  describe 'test attribute "word_count_result"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unique_words"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unique_words_result"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
