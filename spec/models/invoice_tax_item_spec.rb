...
# Unit tests for RebillySdk::InvoiceTaxItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceTaxItem' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceTaxItem.new
  end
  ...
  describe 'test an instance of InvoiceTaxItem' do
    it 'should create an instance of InvoiceTaxItem' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceTaxItem)
    end
  end
