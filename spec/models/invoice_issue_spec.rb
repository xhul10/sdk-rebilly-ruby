...
# Unit tests for RebillySdk::InvoiceIssue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceIssue' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceIssue.new
  end
  ...
  describe 'test an instance of InvoiceIssue' do
    it 'should create an instance of InvoiceIssue' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceIssue)
    end
  end
