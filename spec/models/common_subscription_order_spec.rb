...
# Unit tests for RebillySdk::CommonSubscriptionOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonSubscriptionOrder' do
  before do
    # run before each test
    @instance = RebillySdk::CommonSubscriptionOrder.new
  end
  ...
  describe 'test an instance of CommonSubscriptionOrder' do
    it 'should create an instance of CommonSubscriptionOrder' do
      expect(@instance).to be_instance_of(RebillySdk::CommonSubscriptionOrder)
    end
  end
  ...
  describe 'test attribute "order_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["subscription-order", "one-time-order"])
  ...
  describe 'test attribute "billing_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["draft", "unpaid", "past-due", "abandoned", "paid", "voided", "refunded", "disputed", "partially-refunded", "partially-paid"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "initial_invoice_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "recent_invoice_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "void_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "coupon_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
