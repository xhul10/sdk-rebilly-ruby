...
# Unit tests for RebillySdk::AuthorizeNetCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizeNetCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::AuthorizeNetCredentials.new
  end
  ...
  describe 'test an instance of AuthorizeNetCredentials' do
    it 'should create an instance of AuthorizeNetCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::AuthorizeNetCredentials)
    end
  end
  describe 'test attribute "api_login_id"' do
    it 'should work' do
