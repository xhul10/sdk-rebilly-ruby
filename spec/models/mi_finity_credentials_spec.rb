...
# Unit tests for RebillySdk::MiFinityCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MiFinityCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::MiFinityCredentials.new
  end
  ...
  describe 'test an instance of MiFinityCredentials' do
    it 'should create an instance of MiFinityCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::MiFinityCredentials)
    end
  end
  ...
  describe 'test attribute "mifinity_account_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
