...
# Unit tests for RebillySdk::CommonBankAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonBankAccount' do
  before do
    # run before each test
    @instance = RebillySdk::CommonBankAccount.new
  end
  ...
  describe 'test an instance of CommonBankAccount' do
    it 'should create an instance of CommonBankAccount' do
      expect(@instance).to be_instance_of(RebillySdk::CommonBankAccount)
    end
  end
  ...
  describe 'test attribute "account_number_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BBAN", "IBAN"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "account_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["checking", "savings", "other"])
      # validator.allowable_values.each do |value|
