...
# Unit tests for RebillySdk::FullPaymentCardTokenPaymentInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FullPaymentCardTokenPaymentInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::FullPaymentCardTokenPaymentInstrument.new
  end
  ...
  describe 'test an instance of FullPaymentCardTokenPaymentInstrument' do
    it 'should create an instance of FullPaymentCardTokenPaymentInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::FullPaymentCardTokenPaymentInstrument)
    end
  end
