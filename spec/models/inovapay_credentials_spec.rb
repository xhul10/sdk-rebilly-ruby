...
# Unit tests for RebillySdk::INOVAPAYCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'INOVAPAYCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::INOVAPAYCredentials.new
  end
  ...
  describe 'test an instance of INOVAPAYCredentials' do
    it 'should create an instance of INOVAPAYCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::INOVAPAYCredentials)
    end
  end
