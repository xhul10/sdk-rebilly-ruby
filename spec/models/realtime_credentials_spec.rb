...
# Unit tests for RebillySdk::RealtimeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RealtimeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::RealtimeCredentials.new
  end
  ...
  describe 'test an instance of RealtimeCredentials' do
    it 'should create an instance of RealtimeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::RealtimeCredentials)
    end
  end
