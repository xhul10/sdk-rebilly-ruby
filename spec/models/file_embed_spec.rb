...
# Unit tests for RebillySdk::FileEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::FileEmbed.new
  end
  ...
  describe 'test an instance of FileEmbed' do
    it 'should create an instance of FileEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::FileEmbed)
    end
  end
