...
# Unit tests for RebillySdk::NGeniusCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NGeniusCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::NGeniusCredentials.new
  end
  ...
  describe 'test an instance of NGeniusCredentials' do
    it 'should create an instance of NGeniusCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::NGeniusCredentials)
    end
  end
