...
# Unit tests for RebillySdk::PPROCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PPROCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PPROCredentials.new
  end
  ...
  describe 'test an instance of PPROCredentials' do
    it 'should create an instance of PPROCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PPROCredentials)
    end
  end
  ...
  describe 'test attribute "notification_secret"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
