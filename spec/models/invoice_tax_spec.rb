...
# Unit tests for RebillySdk::InvoiceTax
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceTax' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceTax.new
  end
  ...
  describe 'test an instance of InvoiceTax' do
    it 'should create an instance of InvoiceTax' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceTax)
    end
  end
