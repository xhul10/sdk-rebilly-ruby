...
# Unit tests for RebillySdk::LeadSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LeadSource' do
  before do
    # run before each test
    @instance = RebillySdk::LeadSource.new
  end
  ...
  describe 'test an instance of LeadSource' do
    it 'should create an instance of LeadSource' do
      expect(@instance).to be_instance_of(RebillySdk::LeadSource)
    end
  end
