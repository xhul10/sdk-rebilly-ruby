...
# Unit tests for RebillySdk::ContactEmailsInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactEmailsInner' do
  before do
    # run before each test
    @instance = RebillySdk::ContactEmailsInner.new
  end
  ...
  describe 'test an instance of ContactEmailsInner' do
    it 'should create an instance of ContactEmailsInner' do
      expect(@instance).to be_instance_of(RebillySdk::ContactEmailsInner)
    end
  end
