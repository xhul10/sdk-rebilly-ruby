...
# Unit tests for RebillySdk::ApprovalUrlLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApprovalUrlLink' do
  before do
    # run before each test
    @instance = RebillySdk::ApprovalUrlLink.new
  end
  ...
  describe 'test an instance of ApprovalUrlLink' do
    it 'should create an instance of ApprovalUrlLink' do
      expect(@instance).to be_instance_of(RebillySdk::ApprovalUrlLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["approvalUrl"])
