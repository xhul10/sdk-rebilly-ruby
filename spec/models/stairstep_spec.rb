...
# Unit tests for RebillySdk::Stairstep
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stairstep' do
  before do
    # run before each test
    @instance = RebillySdk::Stairstep.new
  end
  ...
  describe 'test an instance of Stairstep' do
    it 'should create an instance of Stairstep' do
      expect(@instance).to be_instance_of(RebillySdk::Stairstep)
    end
  end
