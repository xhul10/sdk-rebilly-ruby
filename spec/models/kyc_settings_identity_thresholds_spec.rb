...
# Unit tests for RebillySdk::KycSettingsIdentityThresholds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycSettingsIdentityThresholds' do
  before do
    # run before each test
    @instance = RebillySdk::KycSettingsIdentityThresholds.new
  end
  ...
  describe 'test an instance of KycSettingsIdentityThresholds' do
    it 'should create an instance of KycSettingsIdentityThresholds' do
      expect(@instance).to be_instance_of(RebillySdk::KycSettingsIdentityThresholds)
    end
  end
  describe 'test attribute "reject_below"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "accept_above"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
