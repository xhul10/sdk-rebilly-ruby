...
# Unit tests for RebillySdk::AllOfTransactionDccQuote
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfTransactionDccQuote' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfTransactionDccQuote.new
  end
  ...
  describe 'test an instance of AllOfTransactionDccQuote' do
    it 'should create an instance of AllOfTransactionDccQuote' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfTransactionDccQuote)
    end
  end
