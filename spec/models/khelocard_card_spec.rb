...
# Unit tests for RebillySdk::KhelocardCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KhelocardCard' do
  before do
    # run before each test
    @instance = RebillySdk::KhelocardCard.new
  end
  ...
  describe 'test an instance of KhelocardCard' do
    it 'should create an instance of KhelocardCard' do
      expect(@instance).to be_instance_of(RebillySdk::KhelocardCard)
    end
  end
