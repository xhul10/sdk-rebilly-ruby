...
# Unit tests for RebillySdk::CommonSubscriptionOrderTrial
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonSubscriptionOrderTrial' do
  before do
    # run before each test
    @instance = RebillySdk::CommonSubscriptionOrderTrial.new
  end
  ...
  describe 'test an instance of CommonSubscriptionOrderTrial' do
    it 'should create an instance of CommonSubscriptionOrderTrial' do
      expect(@instance).to be_instance_of(RebillySdk::CommonSubscriptionOrderTrial)
    end
  end
