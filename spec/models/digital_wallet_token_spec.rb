...
# Unit tests for RebillySdk::DigitalWalletToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DigitalWalletToken' do
  before do
    # run before each test
    @instance = RebillySdk::DigitalWalletToken.new
  end
  ...
  describe 'test an instance of DigitalWalletToken' do
    it 'should create an instance of DigitalWalletToken' do
      expect(@instance).to be_instance_of(RebillySdk::DigitalWalletToken)
    end
  end
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["digital-wallet"])
