...
# Unit tests for RebillySdk::Pay4Fun
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pay4Fun' do
  before do
    # run before each test
    @instance = RebillySdk::Pay4Fun.new
  end
  ...
  describe 'test an instance of Pay4Fun' do
    it 'should create an instance of Pay4Fun' do
      expect(@instance).to be_instance_of(RebillySdk::Pay4Fun)
    end
  end
