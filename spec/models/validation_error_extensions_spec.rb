...
# Unit tests for RebillySdk::ValidationErrorExtensions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidationErrorExtensions' do
  before do
    # run before each test
    @instance = RebillySdk::ValidationErrorExtensions.new
  end
  ...
  describe 'test an instance of ValidationErrorExtensions' do
    it 'should create an instance of ValidationErrorExtensions' do
      expect(@instance).to be_instance_of(RebillySdk::ValidationErrorExtensions)
    end
  end
