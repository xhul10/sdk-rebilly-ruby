...
# Unit tests for RebillySdk::EMerchantPaySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EMerchantPaySettings' do
  before do
    # run before each test
    @instance = RebillySdk::EMerchantPaySettings.new
  end
  ...
  describe 'test an instance of EMerchantPaySettings' do
    it 'should create an instance of EMerchantPaySettings' do
      expect(@instance).to be_instance_of(RebillySdk::EMerchantPaySettings)
    end
  end
  describe 'test attribute "use_genesis_platform"' do
    it 'should work' do
