...
# Unit tests for RebillySdk::GatewayAccountLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GatewayAccountLink' do
  before do
    # run before each test
    @instance = RebillySdk::GatewayAccountLink.new
  end
  ...
  describe 'test an instance of GatewayAccountLink' do
    it 'should create an instance of GatewayAccountLink' do
      expect(@instance).to be_instance_of(RebillySdk::GatewayAccountLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["gatewayAccount"])
