...
# Unit tests for RebillySdk::TransactionGateway
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionGateway' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionGateway.new
  end
  ...
  describe 'test an instance of TransactionGateway' do
    it 'should create an instance of TransactionGateway' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionGateway)
    end
  end
  ...
  describe 'test attribute "cvv_response"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
