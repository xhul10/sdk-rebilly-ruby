...
# Unit tests for RebillySdk::RPN
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RPN' do
  before do
    # run before each test
    @instance = RebillySdk::RPN.new
  end
  ...
  describe 'test an instance of RPN' do
    it 'should create an instance of RPN' do
      expect(@instance).to be_instance_of(RebillySdk::RPN)
    end
  end
