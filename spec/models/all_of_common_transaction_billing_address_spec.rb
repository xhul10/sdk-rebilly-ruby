...
# Unit tests for RebillySdk::AllOfCommonTransactionBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonTransactionBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonTransactionBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonTransactionBillingAddress' do
    it 'should create an instance of AllOfCommonTransactionBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonTransactionBillingAddress)
    end
  end
