...
# Unit tests for RebillySdk::TestProcessor3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TestProcessor3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::TestProcessor3dsServer.new
  end
  ...
  describe 'test an instance of TestProcessor3dsServer' do
    it 'should create an instance of TestProcessor3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::TestProcessor3dsServer)
    end
  end
