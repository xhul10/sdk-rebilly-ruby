...
# Unit tests for RebillySdk::Tiered
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Tiered' do
  before do
    # run before each test
    @instance = RebillySdk::Tiered.new
  end
  ...
  describe 'test an instance of Tiered' do
    it 'should create an instance of Tiered' do
      expect(@instance).to be_instance_of(RebillySdk::Tiered)
    end
  end
