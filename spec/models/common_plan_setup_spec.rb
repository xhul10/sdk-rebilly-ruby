...
# Unit tests for RebillySdk::CommonPlanSetup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonPlanSetup' do
  before do
    # run before each test
    @instance = RebillySdk::CommonPlanSetup.new
  end
  ...
  describe 'test an instance of CommonPlanSetup' do
    it 'should create an instance of CommonPlanSetup' do
      expect(@instance).to be_instance_of(RebillySdk::CommonPlanSetup)
    end
  end
