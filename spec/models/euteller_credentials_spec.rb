...
# Unit tests for RebillySdk::EutellerCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EutellerCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EutellerCredentials.new
  end
  ...
  describe 'test an instance of EutellerCredentials' do
    it 'should create an instance of EutellerCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EutellerCredentials)
    end
  end
