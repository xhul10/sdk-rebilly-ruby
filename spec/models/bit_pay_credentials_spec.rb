...
# Unit tests for RebillySdk::BitPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BitPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::BitPayCredentials.new
  end
  ...
  describe 'test an instance of BitPayCredentials' do
    it 'should create an instance of BitPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::BitPayCredentials)
    end
  end
