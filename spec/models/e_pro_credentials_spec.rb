...
# Unit tests for RebillySdk::EProCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EProCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EProCredentials.new
  end
  ...
  describe 'test an instance of EProCredentials' do
    it 'should create an instance of EProCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EProCredentials)
    end
  end
