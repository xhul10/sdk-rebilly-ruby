...
# Unit tests for RebillySdk::ConektaCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConektaCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::ConektaCredentials.new
  end
  ...
  describe 'test an instance of ConektaCredentials' do
    it 'should create an instance of ConektaCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::ConektaCredentials)
    end
  end
