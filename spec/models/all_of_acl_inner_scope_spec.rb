...
# Unit tests for RebillySdk::AllOfAclInnerScope
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfAclInnerScope' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfAclInnerScope.new
  end
  ...
  describe 'test an instance of AllOfAclInnerScope' do
    it 'should create an instance of AllOfAclInnerScope' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfAclInnerScope)
    end
  end
  ...
  describe 'test attribute "custom_field_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
