...
# Unit tests for RebillySdk::ExtraData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExtraData' do
  before do
    # run before each test
    @instance = RebillySdk::ExtraData.new
  end
  ...
  describe 'test an instance of ExtraData' do
    it 'should create an instance of ExtraData' do
      expect(@instance).to be_instance_of(RebillySdk::ExtraData)
    end
  end
  describe 'test attribute "kount_fraud_session_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pay_pal_merchant_session_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
