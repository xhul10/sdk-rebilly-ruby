...
# Unit tests for RebillySdk::PanamericanSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PanamericanSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PanamericanSettings.new
  end
  ...
  describe 'test an instance of PanamericanSettings' do
    it 'should create an instance of PanamericanSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PanamericanSettings)
    end
  end
  ...
  describe 'test attribute "convert_to_ascii"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
