...
# Unit tests for RebillySdk::VaultedInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VaultedInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::VaultedInstrument.new
  end
  ...
  describe 'test an instance of VaultedInstrument' do
    it 'should create an instance of VaultedInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::VaultedInstrument)
    end
  end
