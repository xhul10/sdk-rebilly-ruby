...
# Unit tests for RebillySdk::PayCashCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayCashCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayCashCredentials.new
  end
  ...
  describe 'test an instance of PayCashCredentials' do
    it 'should create an instance of PayCashCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayCashCredentials)
    end
  end
  describe 'test attribute "emisor"' do
    it 'should work' do
