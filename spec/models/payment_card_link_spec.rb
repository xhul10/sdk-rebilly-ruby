...
# Unit tests for RebillySdk::PaymentCardLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentCardLink' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentCardLink.new
  end
  ...
  describe 'test an instance of PaymentCardLink' do
    it 'should create an instance of PaymentCardLink' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentCardLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["paymentCard"])
