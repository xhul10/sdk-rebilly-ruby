...
# Unit tests for RebillySdk::PurchaseBumpOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseBumpOffer' do
  before do
    # run before each test
    @instance = RebillySdk::PurchaseBumpOffer.new
  end
  ...
  describe 'test an instance of PurchaseBumpOffer' do
    it 'should create an instance of PurchaseBumpOffer' do
      expect(@instance).to be_instance_of(RebillySdk::PurchaseBumpOffer)
    end
  end
