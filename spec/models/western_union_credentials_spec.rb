...
# Unit tests for RebillySdk::WesternUnionCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WesternUnionCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::WesternUnionCredentials.new
  end
  ...
  describe 'test an instance of WesternUnionCredentials' do
    it 'should create an instance of WesternUnionCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::WesternUnionCredentials)
    end
  end
  ...
  describe 'test attribute "certificate_common_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
