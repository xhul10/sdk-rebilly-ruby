...
# Unit tests for RebillySdk::Awepay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Awepay' do
  before do
    # run before each test
    @instance = RebillySdk::Awepay.new
  end
  ...
  describe 'test an instance of Awepay' do
    it 'should create an instance of Awepay' do
      expect(@instance).to be_instance_of(RebillySdk::Awepay)
    end
  end
