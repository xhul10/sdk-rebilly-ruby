...
# Unit tests for RebillySdk::CashToCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CashToCode' do
  before do
    # run before each test
    @instance = RebillySdk::CashToCode.new
  end
  ...
  describe 'test an instance of CashToCode' do
    it 'should create an instance of CashToCode' do
      expect(@instance).to be_instance_of(RebillySdk::CashToCode)
    end
  end
