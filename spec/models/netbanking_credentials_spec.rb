...
# Unit tests for RebillySdk::NetbankingCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetbankingCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::NetbankingCredentials.new
  end
  ...
  describe 'test an instance of NetbankingCredentials' do
    it 'should create an instance of NetbankingCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::NetbankingCredentials)
    end
  end
  describe 'test attribute "midcode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "midsecret"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
