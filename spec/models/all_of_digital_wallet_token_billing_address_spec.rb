...
# Unit tests for RebillySdk::AllOfDigitalWalletTokenBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfDigitalWalletTokenBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfDigitalWalletTokenBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfDigitalWalletTokenBillingAddress' do
    it 'should create an instance of AllOfDigitalWalletTokenBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfDigitalWalletTokenBillingAddress)
    end
  end
