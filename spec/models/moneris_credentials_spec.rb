...
# Unit tests for RebillySdk::MonerisCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MonerisCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::MonerisCredentials.new
  end
  ...
  describe 'test an instance of MonerisCredentials' do
    it 'should create an instance of MonerisCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::MonerisCredentials)
    end
  end
