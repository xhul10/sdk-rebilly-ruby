...
# Unit tests for RebillySdk::DetailedProblem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DetailedProblem' do
  before do
    # run before each test
    @instance = RebillySdk::DetailedProblem.new
  end
  ...
  describe 'test an instance of DetailedProblem' do
    it 'should create an instance of DetailedProblem' do
      expect(@instance).to be_instance_of(RebillySdk::DetailedProblem)
    end
  end
