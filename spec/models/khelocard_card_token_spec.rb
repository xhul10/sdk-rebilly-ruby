...
# Unit tests for RebillySdk::KhelocardCardToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KhelocardCardToken' do
  before do
    # run before each test
    @instance = RebillySdk::KhelocardCardToken.new
  end
  ...
  describe 'test an instance of KhelocardCardToken' do
    it 'should create an instance of KhelocardCardToken' do
      expect(@instance).to be_instance_of(RebillySdk::KhelocardCardToken)
    end
  end
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Khelocard"])
