...
# Unit tests for RebillySdk::Wirecard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Wirecard' do
  before do
    # run before each test
    @instance = RebillySdk::Wirecard.new
  end
  ...
  describe 'test an instance of Wirecard' do
    it 'should create an instance of Wirecard' do
      expect(@instance).to be_instance_of(RebillySdk::Wirecard)
    end
  end
