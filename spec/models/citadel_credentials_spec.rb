...
# Unit tests for RebillySdk::CitadelCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CitadelCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CitadelCredentials.new
  end
  ...
  describe 'test an instance of CitadelCredentials' do
    it 'should create an instance of CitadelCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CitadelCredentials)
    end
  end
