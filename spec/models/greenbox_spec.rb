...
# Unit tests for RebillySdk::Greenbox
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Greenbox' do
  before do
    # run before each test
    @instance = RebillySdk::Greenbox.new
  end
  ...
  describe 'test an instance of Greenbox' do
    it 'should create an instance of Greenbox' do
      expect(@instance).to be_instance_of(RebillySdk::Greenbox)
    end
  end
