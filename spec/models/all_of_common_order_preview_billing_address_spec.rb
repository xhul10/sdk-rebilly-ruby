...
# Unit tests for RebillySdk::AllOfCommonOrderPreviewBillingAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfCommonOrderPreviewBillingAddress' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfCommonOrderPreviewBillingAddress.new
  end
  ...
  describe 'test an instance of AllOfCommonOrderPreviewBillingAddress' do
    it 'should create an instance of AllOfCommonOrderPreviewBillingAddress' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfCommonOrderPreviewBillingAddress)
    end
  end
