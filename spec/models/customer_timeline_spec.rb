...
# Unit tests for RebillySdk::CustomerTimeline
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerTimeline' do
  before do
    # run before each test
    @instance = RebillySdk::CustomerTimeline.new
  end
  ...
  describe 'test an instance of CustomerTimeline' do
    it 'should create an instance of CustomerTimeline' do
      expect(@instance).to be_instance_of(RebillySdk::CustomerTimeline)
    end
  end
