...
# Unit tests for RebillySdk::AllOfShippingZoneRatesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfShippingZoneRatesItems' do
  before do
    # run before each test
    @instance = RebillySdk::AllOfShippingZoneRatesItems.new
  end
  ...
  describe 'test an instance of AllOfShippingZoneRatesItems' do
    it 'should create an instance of AllOfShippingZoneRatesItems' do
      expect(@instance).to be_instance_of(RebillySdk::AllOfShippingZoneRatesItems)
    end
  end
  ...
  describe 'test attribute "min_order_subtotal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "max_order_subtotal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
