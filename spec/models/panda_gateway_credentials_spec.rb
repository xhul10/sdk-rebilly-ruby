...
# Unit tests for RebillySdk::PandaGatewayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PandaGatewayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PandaGatewayCredentials.new
  end
  ...
  describe 'test an instance of PandaGatewayCredentials' do
    it 'should create an instance of PandaGatewayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PandaGatewayCredentials)
    end
  end
  ...
  describe 'test attribute "api_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sign_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
