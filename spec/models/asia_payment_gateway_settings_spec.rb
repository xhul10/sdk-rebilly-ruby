...
# Unit tests for RebillySdk::AsiaPaymentGatewaySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AsiaPaymentGatewaySettings' do
  before do
    # run before each test
    @instance = RebillySdk::AsiaPaymentGatewaySettings.new
  end
  ...
  describe 'test an instance of AsiaPaymentGatewaySettings' do
    it 'should create an instance of AsiaPaymentGatewaySettings' do
      expect(@instance).to be_instance_of(RebillySdk::AsiaPaymentGatewaySettings)
    end
  end
  describe 'test attribute "use3_ds_endpoint"' do
    it 'should work' do
