...
# Unit tests for RebillySdk::AdyenSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdyenSettings' do
  before do
    # run before each test
    @instance = RebillySdk::AdyenSettings.new
  end
  ...
  describe 'test an instance of AdyenSettings' do
    it 'should create an instance of AdyenSettings' do
      expect(@instance).to be_instance_of(RebillySdk::AdyenSettings)
    end
  end
