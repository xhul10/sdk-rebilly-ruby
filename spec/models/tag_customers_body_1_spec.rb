...
# Unit tests for RebillySdk::TagCustomersBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TagCustomersBody1' do
  before do
    # run before each test
    @instance = RebillySdk::TagCustomersBody1.new
  end
  ...
  describe 'test an instance of TagCustomersBody1' do
    it 'should create an instance of TagCustomersBody1' do
      expect(@instance).to be_instance_of(RebillySdk::TagCustomersBody1)
    end
  end
