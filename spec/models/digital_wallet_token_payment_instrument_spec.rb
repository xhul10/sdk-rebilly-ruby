...
# Unit tests for RebillySdk::DigitalWalletTokenPaymentInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DigitalWalletTokenPaymentInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::DigitalWalletTokenPaymentInstrument.new
  end
  ...
  describe 'test an instance of DigitalWalletTokenPaymentInstrument' do
    it 'should create an instance of DigitalWalletTokenPaymentInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::DigitalWalletTokenPaymentInstrument)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Apple Pay", "Google Pay"])
