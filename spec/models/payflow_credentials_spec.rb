...
# Unit tests for RebillySdk::PayflowCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayflowCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::PayflowCredentials.new
  end
  ...
  describe 'test an instance of PayflowCredentials' do
    it 'should create an instance of PayflowCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::PayflowCredentials)
    end
  end
