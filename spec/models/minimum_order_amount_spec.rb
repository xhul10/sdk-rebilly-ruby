...
# Unit tests for RebillySdk::MinimumOrderAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MinimumOrderAmount' do
  before do
    # run before each test
    @instance = RebillySdk::MinimumOrderAmount.new
  end
  ...
  describe 'test an instance of MinimumOrderAmount' do
    it 'should create an instance of MinimumOrderAmount' do
      expect(@instance).to be_instance_of(RebillySdk::MinimumOrderAmount)
    end
  end
