...
# Unit tests for RebillySdk::Worldpay3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Worldpay3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::Worldpay3dsServers.new
  end
  ...
  describe 'test an instance of Worldpay3dsServers' do
    it 'should create an instance of Worldpay3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::Worldpay3dsServers)
    end
  end
