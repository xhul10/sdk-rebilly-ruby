...
# Unit tests for RebillySdk::LPG
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LPG' do
  before do
    # run before each test
    @instance = RebillySdk::LPG.new
  end
  ...
  describe 'test an instance of LPG' do
    it 'should create an instance of LPG' do
      expect(@instance).to be_instance_of(RebillySdk::LPG)
    end
  end
