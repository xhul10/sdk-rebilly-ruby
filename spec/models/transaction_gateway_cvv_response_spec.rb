...
# Unit tests for RebillySdk::TransactionGatewayCvvResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionGatewayCvvResponse' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionGatewayCvvResponse.new
  end
  ...
  describe 'test an instance of TransactionGatewayCvvResponse' do
    it 'should create an instance of TransactionGatewayCvvResponse' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionGatewayCvvResponse)
    end
  end
  ...
  describe 'test attribute "original_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "original_message"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
