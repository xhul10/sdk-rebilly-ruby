...
# Unit tests for RebillySdk::HiPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HiPay' do
  before do
    # run before each test
    @instance = RebillySdk::HiPay.new
  end
  ...
  describe 'test an instance of HiPay' do
    it 'should create an instance of HiPay' do
      expect(@instance).to be_instance_of(RebillySdk::HiPay)
    end
  end
