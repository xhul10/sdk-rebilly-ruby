...
# Unit tests for RebillySdk::IdentityMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdentityMatches' do
  before do
    # run before each test
    @instance = RebillySdk::IdentityMatches.new
  end
  ...
  describe 'test an instance of IdentityMatches' do
    it 'should create an instance of IdentityMatches' do
      expect(@instance).to be_instance_of(RebillySdk::IdentityMatches)
    end
  end
