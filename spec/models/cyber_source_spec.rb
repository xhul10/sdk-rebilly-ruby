...
# Unit tests for RebillySdk::CyberSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CyberSource' do
  before do
    # run before each test
    @instance = RebillySdk::CyberSource.new
  end
  ...
  describe 'test an instance of CyberSource' do
    it 'should create an instance of CyberSource' do
      expect(@instance).to be_instance_of(RebillySdk::CyberSource)
    end
  end
