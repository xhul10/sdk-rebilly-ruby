...
# Unit tests for RebillySdk::OnBoardingUrlLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnBoardingUrlLink' do
  before do
    # run before each test
    @instance = RebillySdk::OnBoardingUrlLink.new
  end
  ...
  describe 'test an instance of OnBoardingUrlLink' do
    it 'should create an instance of OnBoardingUrlLink' do
      expect(@instance).to be_instance_of(RebillySdk::OnBoardingUrlLink)
    end
  end
  ...
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["onBoardingUrl"])
