...
# Unit tests for RebillySdk::AsiaPaymentGateway
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AsiaPaymentGateway' do
  before do
    # run before each test
    @instance = RebillySdk::AsiaPaymentGateway.new
  end
  ...
  describe 'test an instance of AsiaPaymentGateway' do
    it 'should create an instance of AsiaPaymentGateway' do
      expect(@instance).to be_instance_of(RebillySdk::AsiaPaymentGateway)
    end
  end
