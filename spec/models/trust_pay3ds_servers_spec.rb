...
# Unit tests for RebillySdk::TrustPay3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustPay3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::TrustPay3dsServers.new
  end
  ...
  describe 'test an instance of TrustPay3dsServers' do
    it 'should create an instance of TrustPay3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::TrustPay3dsServers)
    end
  end
