...
# Unit tests for RebillySdk::InvoiceTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceTransaction' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceTransaction.new
  end
  ...
  describe 'test an instance of InvoiceTransaction' do
    it 'should create an instance of InvoiceTransaction' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceTransaction)
    end
  end
