...
# Unit tests for RebillySdk::Dragonphoenix
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Dragonphoenix' do
  before do
    # run before each test
    @instance = RebillySdk::Dragonphoenix.new
  end
  ...
  describe 'test an instance of Dragonphoenix' do
    it 'should create an instance of Dragonphoenix' do
      expect(@instance).to be_instance_of(RebillySdk::Dragonphoenix)
    end
  end
