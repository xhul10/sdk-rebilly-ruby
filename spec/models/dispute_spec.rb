...
# Unit tests for RebillySdk::Dispute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Dispute' do
  before do
    # run before each test
    @instance = RebillySdk::Dispute.new
  end
  ...
  describe 'test an instance of Dispute' do
    it 'should create an instance of Dispute' do
      expect(@instance).to be_instance_of(RebillySdk::Dispute)
    end
  end
  ...
  describe 'test attribute "category"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fraud", "unrecognized", "product-not-received", "product-unacceptable", "product-not-refunded", "duplicate", "subscription-canceled", "uncategorized"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["information-request", "first-chargeback", "second-chargeback", "arbitration", "fraud", "ethoca-alert", "verifi-alert"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "posted_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "deadline_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "resolved_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
