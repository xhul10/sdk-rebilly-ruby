...
# Unit tests for RebillySdk::PiastrixSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PiastrixSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PiastrixSettings.new
  end
  ...
  describe 'test an instance of PiastrixSettings' do
    it 'should create an instance of PiastrixSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PiastrixSettings)
    end
  end
  describe 'test attribute "tolerance_percentage"' do
    it 'should work' do
