...
# Unit tests for RebillySdk::PaymentsOS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentsOS' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentsOS.new
  end
  ...
  describe 'test an instance of PaymentsOS' do
    it 'should create an instance of PaymentsOS' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentsOS)
    end
  end
