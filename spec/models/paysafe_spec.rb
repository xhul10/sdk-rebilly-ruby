...
# Unit tests for RebillySdk::Paysafe
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Paysafe' do
  before do
    # run before each test
    @instance = RebillySdk::Paysafe.new
  end
  ...
  describe 'test an instance of Paysafe' do
    it 'should create an instance of Paysafe' do
      expect(@instance).to be_instance_of(RebillySdk::Paysafe)
    end
  end
