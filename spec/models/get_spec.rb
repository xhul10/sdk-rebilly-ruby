...
# Unit tests for RebillySdk::GET
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GET' do
  before do
    # run before each test
    @instance = RebillySdk::GET.new
  end
  ...
  describe 'test an instance of GET' do
    it 'should create an instance of GET' do
      expect(@instance).to be_instance_of(RebillySdk::GET)
    end
  end
