...
# Unit tests for RebillySdk::XPay
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XPay' do
  before do
    # run before each test
    @instance = RebillySdk::XPay.new
  end
  ...
  describe 'test an instance of XPay' do
    it 'should create an instance of XPay' do
      expect(@instance).to be_instance_of(RebillySdk::XPay)
    end
  end
