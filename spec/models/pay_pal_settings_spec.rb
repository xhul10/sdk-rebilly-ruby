...
# Unit tests for RebillySdk::PayPalSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayPalSettings' do
  before do
    # run before each test
    @instance = RebillySdk::PayPalSettings.new
  end
  ...
  describe 'test an instance of PayPalSettings' do
    it 'should create an instance of PayPalSettings' do
      expect(@instance).to be_instance_of(RebillySdk::PayPalSettings)
    end
  end
  ...
  describe 'test attribute "enable_guest_checkout"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "use_hosted_checkout_form"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "force_guest_checkout"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
