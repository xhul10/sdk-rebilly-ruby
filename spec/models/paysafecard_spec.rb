...
# Unit tests for RebillySdk::Paysafecard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Paysafecard' do
  before do
    # run before each test
    @instance = RebillySdk::Paysafecard.new
  end
  ...
  describe 'test an instance of Paysafecard' do
    it 'should create an instance of Paysafecard' do
      expect(@instance).to be_instance_of(RebillySdk::Paysafecard)
    end
  end
