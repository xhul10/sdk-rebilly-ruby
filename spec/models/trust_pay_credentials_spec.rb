...
# Unit tests for RebillySdk::TrustPayCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustPayCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::TrustPayCredentials.new
  end
  ...
  describe 'test an instance of TrustPayCredentials' do
    it 'should create an instance of TrustPayCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::TrustPayCredentials)
    end
  end
