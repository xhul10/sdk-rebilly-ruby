...
# Unit tests for RebillySdk::BlueSnapSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlueSnapSettings' do
  before do
    # run before each test
    @instance = RebillySdk::BlueSnapSettings.new
  end
  ...
  describe 'test an instance of BlueSnapSettings' do
    it 'should create an instance of BlueSnapSettings' do
      expect(@instance).to be_instance_of(RebillySdk::BlueSnapSettings)
    end
  end
  describe 'test attribute "enable_moto"' do
    it 'should work' do
