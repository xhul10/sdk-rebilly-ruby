...
# Unit tests for RebillySdk::PayTabs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PayTabs' do
  before do
    # run before each test
    @instance = RebillySdk::PayTabs.new
  end
  ...
  describe 'test an instance of PayTabs' do
    it 'should create an instance of PayTabs' do
      expect(@instance).to be_instance_of(RebillySdk::PayTabs)
    end
  end
