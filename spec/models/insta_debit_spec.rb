...
# Unit tests for RebillySdk::InstaDebit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstaDebit' do
  before do
    # run before each test
    @instance = RebillySdk::InstaDebit.new
  end
  ...
  describe 'test an instance of InstaDebit' do
    it 'should create an instance of InstaDebit' do
      expect(@instance).to be_instance_of(RebillySdk::InstaDebit)
    end
  end
