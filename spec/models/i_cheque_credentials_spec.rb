...
# Unit tests for RebillySdk::IChequeCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IChequeCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::IChequeCredentials.new
  end
  ...
  describe 'test an instance of IChequeCredentials' do
    it 'should create an instance of IChequeCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::IChequeCredentials)
    end
  end
  ...
  describe 'test attribute "secret_word"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "api_user_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "api_security_token"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
