...
# Unit tests for RebillySdk::AclInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AclInner' do
  before do
    # run before each test
    @instance = RebillySdk::AclInner.new
  end
  ...
  describe 'test an instance of AclInner' do
    it 'should create an instance of AclInner' do
      expect(@instance).to be_instance_of(RebillySdk::AclInner)
    end
  end
