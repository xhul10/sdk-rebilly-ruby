...
# Unit tests for RebillySdk::PartialPaymentCardToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartialPaymentCardToken' do
  before do
    # run before each test
    @instance = RebillySdk::PartialPaymentCardToken.new
  end
  ...
  describe 'test an instance of PartialPaymentCardToken' do
    it 'should create an instance of PartialPaymentCardToken' do
      expect(@instance).to be_instance_of(RebillySdk::PartialPaymentCardToken)
    end
  end
  ...
  describe 'test attribute "usage_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
