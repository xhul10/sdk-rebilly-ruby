...
# Unit tests for RebillySdk::CODVoucher
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CODVoucher' do
  before do
    # run before each test
    @instance = RebillySdk::CODVoucher.new
  end
  ...
  describe 'test an instance of CODVoucher' do
    it 'should create an instance of CODVoucher' do
      expect(@instance).to be_instance_of(RebillySdk::CODVoucher)
    end
  end
