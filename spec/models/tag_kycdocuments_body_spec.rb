...
# Unit tests for RebillySdk::TagKycdocumentsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TagKycdocumentsBody' do
  before do
    # run before each test
    @instance = RebillySdk::TagKycdocumentsBody.new
  end
  ...
  describe 'test an instance of TagKycdocumentsBody' do
    it 'should create an instance of TagKycdocumentsBody' do
      expect(@instance).to be_instance_of(RebillySdk::TagKycdocumentsBody)
    end
  end
