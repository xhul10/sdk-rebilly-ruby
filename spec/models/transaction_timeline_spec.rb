...
# Unit tests for RebillySdk::TransactionTimeline
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionTimeline' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionTimeline.new
  end
  ...
  describe 'test an instance of TransactionTimeline' do
    it 'should create an instance of TransactionTimeline' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionTimeline)
    end
  end
  ...
  describe 'test attribute "triggered_by"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["rebilly", "app", "direct-api"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "occurred_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
