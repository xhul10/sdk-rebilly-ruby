...
# Unit tests for RebillySdk::InvoiceTimeline
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceTimeline' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceTimeline.new
  end
  ...
  describe 'test an instance of InvoiceTimeline' do
    it 'should create an instance of InvoiceTimeline' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceTimeline)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["timeline-comment-created", "invoice-created", "invoice-issued", "invoice-abandoned", "invoice-voided", "invoice-past-due", "invoice-paid", "invoice-partially-paid", "invoice-disputed", "invoice-refunded", "invoice-partially-refunded", "invoice-renewal-payment-declined", "email-message-sent", "coupon-applied", "transaction-approved", "transaction-abandoned", "transaction-canceled", "transaction-declined", "transaction-initiated", "transaction-refunded", "transaction-voided"])
