...
# Unit tests for RebillySdk::CommonPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonPlan' do
  before do
    # run before each test
    @instance = RebillySdk::CommonPlan.new
  end
  ...
  describe 'test an instance of CommonPlan' do
    it 'should create an instance of CommonPlan' do
      expect(@instance).to be_instance_of(RebillySdk::CommonPlan)
    end
  end
