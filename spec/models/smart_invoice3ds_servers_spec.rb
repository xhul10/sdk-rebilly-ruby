...
# Unit tests for RebillySdk::SmartInvoice3dsServers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartInvoice3dsServers' do
  before do
    # run before each test
    @instance = RebillySdk::SmartInvoice3dsServers.new
  end
  ...
  describe 'test an instance of SmartInvoice3dsServers' do
    it 'should create an instance of SmartInvoice3dsServers' do
      expect(@instance).to be_instance_of(RebillySdk::SmartInvoice3dsServers)
    end
  end
