...
# Unit tests for RebillySdk::CCAvenueCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CCAvenueCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::CCAvenueCredentials.new
  end
  ...
  describe 'test an instance of CCAvenueCredentials' do
    it 'should create an instance of CCAvenueCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::CCAvenueCredentials)
    end
  end
  ...
  describe 'test attribute "working_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
