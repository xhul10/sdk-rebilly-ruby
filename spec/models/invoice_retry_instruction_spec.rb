...
# Unit tests for RebillySdk::InvoiceRetryInstruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceRetryInstruction' do
  before do
    # run before each test
    @instance = RebillySdk::InvoiceRetryInstruction.new
  end
  ...
  describe 'test an instance of InvoiceRetryInstruction' do
    it 'should create an instance of InvoiceRetryInstruction' do
      expect(@instance).to be_instance_of(RebillySdk::InvoiceRetryInstruction)
    end
  end
  ...
  describe 'test attribute "after_attempt_policies"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["change-subscription-renewal-time"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.after_attempt_policies = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "after_retry_end_policies"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["abandon-invoice", "cancel-subscription"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.after_retry_end_policies = value }.not_to raise_error
      # end
    end
  end
