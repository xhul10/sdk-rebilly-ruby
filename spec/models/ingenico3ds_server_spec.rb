...
# Unit tests for RebillySdk::Ingenico3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ingenico3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::Ingenico3dsServer.new
  end
  ...
  describe 'test an instance of Ingenico3dsServer' do
    it 'should create an instance of Ingenico3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::Ingenico3dsServer)
    end
  end
