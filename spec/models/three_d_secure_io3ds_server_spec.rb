...
# Unit tests for RebillySdk::ThreeDSecureIO3dsServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThreeDSecureIO3dsServer' do
  before do
    # run before each test
    @instance = RebillySdk::ThreeDSecureIO3dsServer.new
  end
  ...
  describe 'test an instance of ThreeDSecureIO3dsServer' do
    it 'should create an instance of ThreeDSecureIO3dsServer' do
      expect(@instance).to be_instance_of(RebillySdk::ThreeDSecureIO3dsServer)
    end
  end
  ...
  describe 'test attribute "merchant_acquirer_bin_visa"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "merchant_acquirer_bin_mastercard"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "use3ds_for_merchant_initiated"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "three_ri_ind"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["01", "02", "03", "04", "05", "06", "07", "8", "9", "10", "11"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.three_ri_ind = value }.not_to raise_error
      # end
    end
  end
