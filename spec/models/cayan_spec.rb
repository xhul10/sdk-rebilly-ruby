...
# Unit tests for RebillySdk::Cayan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Cayan' do
  before do
    # run before each test
    @instance = RebillySdk::Cayan.new
  end
  ...
  describe 'test an instance of Cayan' do
    it 'should create an instance of Cayan' do
      expect(@instance).to be_instance_of(RebillySdk::Cayan)
    end
  end
