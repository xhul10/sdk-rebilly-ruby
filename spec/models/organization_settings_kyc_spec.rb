...
# Unit tests for RebillySdk::OrganizationSettingsKyc
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationSettingsKyc' do
  before do
    # run before each test
    @instance = RebillySdk::OrganizationSettingsKyc.new
  end
  ...
  describe 'test an instance of OrganizationSettingsKyc' do
    it 'should create an instance of OrganizationSettingsKyc' do
      expect(@instance).to be_instance_of(RebillySdk::OrganizationSettingsKyc)
    end
  end
  describe 'test attribute "identity_proof"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "address_proof"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
