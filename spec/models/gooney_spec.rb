...
# Unit tests for RebillySdk::Gooney
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Gooney' do
  before do
    # run before each test
    @instance = RebillySdk::Gooney.new
  end
  ...
  describe 'test an instance of Gooney' do
    it 'should create an instance of Gooney' do
      expect(@instance).to be_instance_of(RebillySdk::Gooney)
    end
  end
