...
# Unit tests for RebillySdk::Paynote
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Paynote' do
  before do
    # run before each test
    @instance = RebillySdk::Paynote.new
  end
  ...
  describe 'test an instance of Paynote' do
    it 'should create an instance of Paynote' do
      expect(@instance).to be_instance_of(RebillySdk::Paynote)
    end
  end
