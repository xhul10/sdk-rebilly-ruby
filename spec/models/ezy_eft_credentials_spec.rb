...
# Unit tests for RebillySdk::EzyEFTCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EzyEFTCredentials' do
  before do
    # run before each test
    @instance = RebillySdk::EzyEFTCredentials.new
  end
  ...
  describe 'test an instance of EzyEFTCredentials' do
    it 'should create an instance of EzyEFTCredentials' do
      expect(@instance).to be_instance_of(RebillySdk::EzyEFTCredentials)
    end
  end
