...
# Unit tests for RebillySdk::OnRamp
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnRamp' do
  before do
    # run before each test
    @instance = RebillySdk::OnRamp.new
  end
  ...
  describe 'test an instance of OnRamp' do
    it 'should create an instance of OnRamp' do
      expect(@instance).to be_instance_of(RebillySdk::OnRamp)
    end
  end
