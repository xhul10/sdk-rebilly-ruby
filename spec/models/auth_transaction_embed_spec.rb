...
# Unit tests for RebillySdk::AuthTransactionEmbed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthTransactionEmbed' do
  before do
    # run before each test
    @instance = RebillySdk::AuthTransactionEmbed.new
  end
  ...
  describe 'test an instance of AuthTransactionEmbed' do
    it 'should create an instance of AuthTransactionEmbed' do
      expect(@instance).to be_instance_of(RebillySdk::AuthTransactionEmbed)
    end
  end
