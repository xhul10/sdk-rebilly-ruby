...
# Unit tests for RebillySdk::FinraxSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinraxSettings' do
  before do
    # run before each test
    @instance = RebillySdk::FinraxSettings.new
  end
  ...
  describe 'test an instance of FinraxSettings' do
    it 'should create an instance of FinraxSettings' do
      expect(@instance).to be_instance_of(RebillySdk::FinraxSettings)
    end
  end
