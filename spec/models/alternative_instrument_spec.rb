...
# Unit tests for RebillySdk::AlternativeInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlternativeInstrument' do
  before do
    # run before each test
    @instance = RebillySdk::AlternativeInstrument.new
  end
  ...
  describe 'test an instance of AlternativeInstrument' do
    it 'should create an instance of AlternativeInstrument' do
      expect(@instance).to be_instance_of(RebillySdk::AlternativeInstrument)
    end
  end
