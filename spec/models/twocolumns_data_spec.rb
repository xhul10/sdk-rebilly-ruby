...
# Unit tests for RebillySdk::TwocolumnsData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TwocolumnsData' do
  before do
    # run before each test
    @instance = RebillySdk::TwocolumnsData.new
  end
  ...
  describe 'test an instance of TwocolumnsData' do
    it 'should create an instance of TwocolumnsData' do
      expect(@instance).to be_instance_of(RebillySdk::TwocolumnsData)
    end
  end
