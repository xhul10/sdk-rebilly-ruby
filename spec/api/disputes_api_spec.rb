...
# Unit tests for RebillySdk::DisputesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisputesApi' do
  before do
    # run before each test
    @instance = RebillySdk::DisputesApi.new
  end
  ...
  describe 'test an instance of DisputesApi' do
    it 'should create an instance of DisputesApi' do
      expect(@instance).to be_instance_of(RebillySdk::DisputesApi)
    end
  end
  ...
  # unit tests for get_dispute_collection
  ...
  describe 'get_dispute_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_dispute
  # Create a dispute
  # Create a dispute. 
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [Dispute]
  describe 'post_dispute test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_dispute
