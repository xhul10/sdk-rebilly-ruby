...
# Unit tests for RebillySdk::CustomersTimelineApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomersTimelineApi' do
  before do
    # run before each test
    @instance = RebillySdk::CustomersTimelineApi.new
  end
  ...
  describe 'test an instance of CustomersTimelineApi' do
    it 'should create an instance of CustomersTimelineApi' do
      expect(@instance).to be_instance_of(RebillySdk::CustomersTimelineApi)
    end
  end

  # unit tests for delete_customer_timeline
  ...
  # @return [nil]
  describe 'delete_customer_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_customer_timeline
  ...
  describe 'get_customer_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_customer_timeline_collection
  ...
  describe 'get_customer_timeline_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_customer_timeline_custom_event_type
  ...
  describe 'get_customer_timeline_custom_event_type test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_customer_timeline_custom_event_type_collection
  ...
  describe 'get_customer_timeline_custom_event_type_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_customer_timeline_event_collection
  ...
  # @option opts [String] :filter The collection items filter requires a special format. Use \&quot;,\&quot; for multiple allowed values.  Use \&quot;;\&quot; for multiple fields. See the [filter guide](https://api-reference.rebilly.com/#section/Using-filter-with-collections) for more options and examples about this format. 
  # @return [Array<CustomerTimeline>]
  describe 'get_customer_timeline_event_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_customer_timeline
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [CustomerTimeline]
  describe 'post_customer_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_customer_timeline_custom_event_type
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [CustomerTimelineCustomEvent]
  describe 'post_customer_timeline_custom_event_type test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
