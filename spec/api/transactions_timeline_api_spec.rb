...
# Unit tests for RebillySdk::TransactionsTimelineApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsTimelineApi' do
  before do
    # run before each test
    @instance = RebillySdk::TransactionsTimelineApi.new
  end
  ...
  describe 'test an instance of TransactionsTimelineApi' do
    it 'should create an instance of TransactionsTimelineApi' do
      expect(@instance).to be_instance_of(RebillySdk::TransactionsTimelineApi)
    end
  end

  # unit tests for delete_transaction_timeline
  ...
  # @return [nil]
  describe 'delete_transaction_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_transaction_timeline
  ...
  describe 'get_transaction_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_transaction_timeline_collection
  ...
  describe 'get_transaction_timeline_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_transaction_timeline
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [TransactionTimeline]
  describe 'post_transaction_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
