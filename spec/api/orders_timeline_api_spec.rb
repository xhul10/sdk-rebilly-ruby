...
# Unit tests for RebillySdk::OrdersTimelineApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersTimelineApi' do
  before do
    # run before each test
    @instance = RebillySdk::OrdersTimelineApi.new
  end
  ...
  describe 'test an instance of OrdersTimelineApi' do
    it 'should create an instance of OrdersTimelineApi' do
      expect(@instance).to be_instance_of(RebillySdk::OrdersTimelineApi)
    end
  end

  # unit tests for delete_subscription_timeline
  ...
  # @return [nil]
  describe 'delete_subscription_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_subscription_timeline
  ...
  describe 'get_subscription_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_subscription_timeline_collection
  ...
  describe 'get_subscription_timeline_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_subscription_timeline
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [OrderTimeline]
  describe 'post_subscription_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
