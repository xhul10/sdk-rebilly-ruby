...
# Unit tests for RebillySdk::InvoicesTimelineApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicesTimelineApi' do
  before do
    # run before each test
    @instance = RebillySdk::InvoicesTimelineApi.new
  end
  ...
  describe 'test an instance of InvoicesTimelineApi' do
    it 'should create an instance of InvoicesTimelineApi' do
      expect(@instance).to be_instance_of(RebillySdk::InvoicesTimelineApi)
    end
  end

  # unit tests for delete_invoice_timeline
  ...
  # @return [nil]
  describe 'delete_invoice_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_invoice_timeline
  ...
  describe 'get_invoice_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_invoice_timeline_collection
  ...
  describe 'get_invoice_timeline_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_invoice_timeline
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [InvoiceTimeline]
  describe 'post_invoice_timeline test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
