...
# Unit tests for RebillySdk::AMLApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AMLApi' do
  before do
    # run before each test
    @instance = RebillySdk::AMLApi.new
  end
  ...
  describe 'test an instance of AMLApi' do
    it 'should create an instance of AMLApi' do
      expect(@instance).to be_instance_of(RebillySdk::AMLApi)
    end
  end

  # unit tests for get_aml_entry
  ...
  # @return [Array<AML>]
  describe 'get_aml_entry test' do
    it 'should work' do
