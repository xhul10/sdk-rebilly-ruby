...
# Unit tests for RebillySdk::CustomFieldsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomFieldsApi' do
  before do
    # run before each test
    @instance = RebillySdk::CustomFieldsApi.new
  end
  ...
  describe 'test an instance of CustomFieldsApi' do
    it 'should create an instance of CustomFieldsApi' do
      expect(@instance).to be_instance_of(RebillySdk::CustomFieldsApi)
    end
  end
  ...
  # unit tests for get_custom_field_collection
  ...
  describe 'get_custom_field_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_custom_field
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [CustomField]
  describe 'put_custom_field test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
