...
# Unit tests for RebillySdk::PaymentTokensApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentTokensApi' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentTokensApi.new
  end
  ...
  describe 'test an instance of PaymentTokensApi' do
    it 'should create an instance of PaymentTokensApi' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentTokensApi)
    end
  end
  ...
  # unit tests for get_token_collection
  ...
  describe 'get_token_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_digital_wallet_validation
  ...
  describe 'post_digital_wallet_validation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
