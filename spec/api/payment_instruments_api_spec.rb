...
# Unit tests for RebillySdk::PaymentInstrumentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInstrumentsApi' do
  before do
    # run before each test
    @instance = RebillySdk::PaymentInstrumentsApi.new
  end
  ...
  describe 'test an instance of PaymentInstrumentsApi' do
    it 'should create an instance of PaymentInstrumentsApi' do
      expect(@instance).to be_instance_of(RebillySdk::PaymentInstrumentsApi)
    end
  end
  ...
  # unit tests for get_payment_instrument_collection
  ...
  describe 'get_payment_instrument_collection test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for post_payment_instrument_deactivation
  ...
  # @option opts [ResourceId] :organization_id Organization identifier in scope of which need to perform request (if not specified, the default organization will be used).  It is deprecated. Use servers with &#x60;/organizations/{organizationId}&#x60; base path instead.
  # @return [PaymentInstrument2]
  describe 'post_payment_instrument_deactivation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
